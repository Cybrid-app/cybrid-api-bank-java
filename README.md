...
- Build date: 2025-05-07T13:01:00.623701Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.458"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.458.jar`
- `target/lib/*.jar`
