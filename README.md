...
- Build date: 2024-08-12T17:36:10.825363Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.11.jar`
- `target/lib/*.jar`
