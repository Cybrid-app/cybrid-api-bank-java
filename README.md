...
- Build date: 2023-08-14T15:32:09.370796Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.2.jar`
- `target/lib/*.jar`
