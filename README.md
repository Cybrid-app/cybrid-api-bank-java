...
- Build date: 2023-07-13T15:19:03.580946Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.7.jar`
- `target/lib/*.jar`
