...
- Build date: 2022-05-24T21:20:59.929155Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.14.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.14.8.jar`
- `target/lib/*.jar`
