...
- Build date: 2024-03-21T15:53:45.073552Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.24.jar`
- `target/lib/*.jar`
