...
- Build date: 2023-09-20T13:36:41.749597Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.21.jar`
- `target/lib/*.jar`
