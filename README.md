...
- Build date: 2024-02-09T13:34:02.191419Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.128"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.128.jar`
- `target/lib/*.jar`
