...
- Build date: 2023-05-11T15:03:41.970747Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.15.jar`
- `target/lib/*.jar`
