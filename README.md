...
- Build date: 2025-02-18T23:07:16.348250Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.240"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.240.jar`
- `target/lib/*.jar`
