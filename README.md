...
- Build date: 2023-06-20T18:29:38.708296Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.34.jar`
- `target/lib/*.jar`
