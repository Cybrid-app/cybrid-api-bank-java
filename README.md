...
- Build date: 2023-09-19T12:30:44.275917Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.19.jar`
- `target/lib/*.jar`
