...
- Build date: 2024-04-10T11:34:58.362015Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.73"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.73.jar`
- `target/lib/*.jar`
