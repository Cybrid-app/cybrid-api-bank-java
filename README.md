...
- Build date: 2023-04-13T12:17:54.183139Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.41.jar`
- `target/lib/*.jar`
