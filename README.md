...
- Build date: 2024-11-04T14:40:04.720997Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.23"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.23.jar`
- `target/lib/*.jar`
