...
- Build date: 2023-08-03T19:20:12.837591Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.82.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.82.1.jar`
- `target/lib/*.jar`
