...
- Build date: 2024-09-10T20:52:38.745568Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.83"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.83.jar`
- `target/lib/*.jar`
