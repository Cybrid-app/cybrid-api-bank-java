...
- Build date: 2025-03-13T17:37:32.042454Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.293"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.293.jar`
- `target/lib/*.jar`
