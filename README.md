...
- Build date: 2025-06-09T18:34:56.929711Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.567"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.567.jar`
- `target/lib/*.jar`
