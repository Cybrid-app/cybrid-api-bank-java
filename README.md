...
- Build date: 2023-12-15T22:25:01.726734Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.11.jar`
- `target/lib/*.jar`
