...
- Build date: 2023-05-23T12:04:31.393969Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.31"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.31.jar`
- `target/lib/*.jar`
