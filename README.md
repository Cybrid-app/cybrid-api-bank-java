...
- Build date: 2024-10-29T23:13:34.176202Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.55"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.55.jar`
- `target/lib/*.jar`
