...
- Build date: 2024-09-19T15:26:29.307075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.117"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.117.jar`
- `target/lib/*.jar`
