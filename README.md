...
- Build date: 2025-05-09T17:29:08.477434Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.470"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.470.jar`
- `target/lib/*.jar`
