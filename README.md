...
- Build date: 2023-08-22T19:59:09.842774Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.86.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.86.1.jar`
- `target/lib/*.jar`
