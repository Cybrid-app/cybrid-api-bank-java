...
- Build date: 2024-09-17T20:02:17.754245Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.106"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.106.jar`
- `target/lib/*.jar`
