...
- Build date: 2025-02-04T21:06:37.426876Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.203"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.203.jar`
- `target/lib/*.jar`
