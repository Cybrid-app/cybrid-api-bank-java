...
- Build date: 2024-12-30T23:02:39.696851Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.114"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.114.jar`
- `target/lib/*.jar`
