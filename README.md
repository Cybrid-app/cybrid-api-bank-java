...
- Build date: 2025-02-21T16:48:19.031086Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.245"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.245.jar`
- `target/lib/*.jar`
