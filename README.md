...
- Build date: 2024-09-09T17:02:37.075803Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.75"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.75.jar`
- `target/lib/*.jar`
