...
- Build date: 2025-02-12T17:44:35.745854Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.228"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.228.jar`
- `target/lib/*.jar`
