...
- Build date: 2023-05-26T01:11:07.792626Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.47.jar`
- `target/lib/*.jar`
