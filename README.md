...
- Build date: 2024-12-10T20:10:26.617273Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.73"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.73.jar`
- `target/lib/*.jar`
