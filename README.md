...
- Build date: 2024-05-25T15:27:58.774829Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.14"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.14.jar`
- `target/lib/*.jar`
