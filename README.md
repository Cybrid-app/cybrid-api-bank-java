...
- Build date: 2023-06-15T12:01:08.754361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.14"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.14.jar`
- `target/lib/*.jar`
