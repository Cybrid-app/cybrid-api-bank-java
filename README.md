...
- Build date: 2024-02-23T15:30:37.246727Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.13.jar`
- `target/lib/*.jar`
