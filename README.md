...
- Build date: 2025-02-24T19:12:24.399424Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.250"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.250.jar`
- `target/lib/*.jar`
