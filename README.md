...
- Build date: 2023-05-31T11:58:35.394397Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.61"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.61.jar`
- `target/lib/*.jar`
