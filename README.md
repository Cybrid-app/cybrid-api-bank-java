...
- Build date: 2023-05-26T13:26:05.981240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.50"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.50.jar`
- `target/lib/*.jar`
