...
- Build date: 2025-04-01T18:30:12.453283Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.349"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.349.jar`
- `target/lib/*.jar`
