...
- Build date: 2024-05-07T13:06:26.486926Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.141"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.141.jar`
- `target/lib/*.jar`
