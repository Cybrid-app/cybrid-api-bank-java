...
- Build date: 2023-11-21T14:50:39.148240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.13.jar`
- `target/lib/*.jar`
