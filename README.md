...
- Build date: 2023-06-29T20:29:08.229034Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.24.jar`
- `target/lib/*.jar`
