...
- Build date: 2024-08-14T18:40:30.439850Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.21.jar`
- `target/lib/*.jar`
