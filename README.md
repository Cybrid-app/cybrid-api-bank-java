...
- Build date: 2025-01-07T13:59:22.694401Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.126"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.126.jar`
- `target/lib/*.jar`
