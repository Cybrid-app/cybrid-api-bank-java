...
- Build date: 2025-06-09T14:09:02.760476Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.561"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.561.jar`
- `target/lib/*.jar`
