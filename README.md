...
- Build date: 2025-04-10T15:40:26.666833Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.375"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.375.jar`
- `target/lib/*.jar`
