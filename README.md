...
- Build date: 2025-01-09T13:03:08.547029Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.131"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.131.jar`
- `target/lib/*.jar`
