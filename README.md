...
- Build date: 2023-06-27T20:45:06.554834Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.19.jar`
- `target/lib/*.jar`
