...
- Build date: 2022-05-10T11:23:33.198227Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.6.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.6.10.jar`
- `target/lib/*.jar`
