...
- Build date: 2023-06-27T18:33:28.775793Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.17.jar`
- `target/lib/*.jar`
