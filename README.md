...
- Build date: 2023-04-19T17:11:06.256220Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.57"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.57.jar`
- `target/lib/*.jar`
