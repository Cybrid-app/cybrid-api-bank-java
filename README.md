...
- Build date: 2025-03-19T16:57:19.995235Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.310"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.310.jar`
- `target/lib/*.jar`
