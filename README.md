...
- Build date: 2024-10-02T15:03:31.471678Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.161"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.161.jar`
- `target/lib/*.jar`
