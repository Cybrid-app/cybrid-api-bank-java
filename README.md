...
- Build date: 2023-10-11T18:33:05.188605Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.103.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.103.0.jar`
- `target/lib/*.jar`
