...
- Build date: 2025-05-09T20:37:15.658520Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.471"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.471.jar`
- `target/lib/*.jar`
