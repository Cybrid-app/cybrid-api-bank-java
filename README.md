...
- Build date: 2024-09-26T19:05:15.527096Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.145"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.145.jar`
- `target/lib/*.jar`
