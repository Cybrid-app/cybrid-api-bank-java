...
- Build date: 2024-10-30T01:31:57.062146Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.57"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.57.jar`
- `target/lib/*.jar`
