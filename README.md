...
- Build date: 2023-09-07T13:12:57.937087Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.11.jar`
- `target/lib/*.jar`
