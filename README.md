...
- Build date: 2023-10-04T16:05:19.606473Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.95.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.95.1.jar`
- `target/lib/*.jar`
