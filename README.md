...
- Build date: 2025-04-07T13:39:08.990842Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.359"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.359.jar`
- `target/lib/*.jar`
