...
- Build date: 2024-10-19T13:52:49.418456Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.26.jar`
- `target/lib/*.jar`
