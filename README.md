...
- Build date: 2024-11-12T12:59:31.384958Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.58"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.58.jar`
- `target/lib/*.jar`
