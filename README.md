...
- Build date: 2024-09-16T19:04:13.985220Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.100"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.100.jar`
- `target/lib/*.jar`
