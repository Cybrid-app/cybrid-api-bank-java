...
- Build date: 2024-07-25T21:12:29.620421Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.99"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.99.jar`
- `target/lib/*.jar`
