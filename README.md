...
- Build date: 2025-06-02T21:53:01.506031Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.545"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.545.jar`
- `target/lib/*.jar`
