...
- Build date: 2024-10-19T14:25:29.976339Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.27.jar`
- `target/lib/*.jar`
