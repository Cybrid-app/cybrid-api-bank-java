...
- Build date: 2023-12-05T18:13:28.000838Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.8.jar`
- `target/lib/*.jar`
