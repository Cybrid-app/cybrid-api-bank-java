...
- Build date: 2025-06-20T15:37:20.874503Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.616"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.616.jar`
- `target/lib/*.jar`
