...
- Build date: 2024-02-28T13:44:32.038118Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.25.jar`
- `target/lib/*.jar`
