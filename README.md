...
- Build date: 2024-04-16T12:51:24.052385Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.99"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.99.jar`
- `target/lib/*.jar`
