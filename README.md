...
- Build date: 2023-08-18T22:02:29.942243Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.85.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.85.1.jar`
- `target/lib/*.jar`
