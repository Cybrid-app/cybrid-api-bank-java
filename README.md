...
- Build date: 2024-05-01T12:55:40.891992Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.130"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.130.jar`
- `target/lib/*.jar`
