...
- Build date: 2024-11-05T16:45:10.687565Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.31"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.31.jar`
- `target/lib/*.jar`
