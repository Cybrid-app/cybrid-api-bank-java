...
- Build date: 2024-02-27T13:50:25.703051Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.19.jar`
- `target/lib/*.jar`
