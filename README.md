...
- Build date: 2023-11-09T12:25:02.162217Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.43"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.43.jar`
- `target/lib/*.jar`
