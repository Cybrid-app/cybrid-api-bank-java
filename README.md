...
- Build date: 2023-09-08T11:53:19.477156Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.92.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.92.1.jar`
- `target/lib/*.jar`
