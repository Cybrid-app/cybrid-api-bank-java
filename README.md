...
- Build date: 2025-03-14T17:21:17.712173Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.297"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.297.jar`
- `target/lib/*.jar`
