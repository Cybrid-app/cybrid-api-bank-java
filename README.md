...
- Build date: 2024-03-04T20:51:49.741867Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.37"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.37.jar`
- `target/lib/*.jar`
