...
- Build date: 2023-07-27T12:40:22.621855Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.1.jar`
- `target/lib/*.jar`
