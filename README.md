...
- Build date: 2024-11-01T21:45:54.807480Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.20"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.20.jar`
- `target/lib/*.jar`
