...
- Build date: 2025-06-17T20:20:29.739459Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.601"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.601.jar`
- `target/lib/*.jar`
