...
- Build date: 2025-01-13T17:13:44.949515Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.140"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.140.jar`
- `target/lib/*.jar`
