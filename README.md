...
- Build date: 2025-02-05T18:42:28.491107Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.211"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.211.jar`
- `target/lib/*.jar`
