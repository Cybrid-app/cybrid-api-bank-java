...
- Build date: 2024-09-04T19:11:15.712676Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.66"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.66.jar`
- `target/lib/*.jar`
