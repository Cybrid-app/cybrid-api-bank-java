...
- Build date: 2023-07-20T14:06:52.242109Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.7.jar`
- `target/lib/*.jar`
