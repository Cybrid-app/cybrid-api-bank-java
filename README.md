...
- Build date: 2025-06-26T00:13:29.587405Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.642"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.642.jar`
- `target/lib/*.jar`
