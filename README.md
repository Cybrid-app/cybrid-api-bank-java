...
- Build date: 2025-05-21T12:12:31.268995Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.506"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.506.jar`
- `target/lib/*.jar`
