...
- Build date: 2025-04-17T16:45:23.410265Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.404"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.404.jar`
- `target/lib/*.jar`
