...
- Build date: 2023-08-08T05:11:06.933846Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.82.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.82.8.jar`
- `target/lib/*.jar`
