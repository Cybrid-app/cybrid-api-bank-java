...
- Build date: 2024-04-29T14:10:42.726991Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.126"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.126.jar`
- `target/lib/*.jar`
