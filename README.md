...
- Build date: 2025-06-09T16:17:04.541582Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.564"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.564.jar`
- `target/lib/*.jar`
