...
- Build date: 2023-08-10T21:04:19.909994Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.10.jar`
- `target/lib/*.jar`
