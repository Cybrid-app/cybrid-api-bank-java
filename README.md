...
- Build date: 2024-05-31T14:02:14.021868Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.23"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.23.jar`
- `target/lib/*.jar`
