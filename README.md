...
- Build date: 2025-01-20T13:19:48.142015Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.151"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.151.jar`
- `target/lib/*.jar`
