...
- Build date: 2023-09-29T14:59:26.011242Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.47.jar`
- `target/lib/*.jar`
