...
- Build date: 2025-05-22T13:22:21.817540Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.514"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.514.jar`
- `target/lib/*.jar`
