...
- Build date: 2023-05-23T13:37:36.970704Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.32.jar`
- `target/lib/*.jar`
