...
- Build date: 2024-01-24T20:56:47.236459Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.93"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.93.jar`
- `target/lib/*.jar`
