...
- Build date: 2024-10-16T18:44:16.037820Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.13.jar`
- `target/lib/*.jar`
