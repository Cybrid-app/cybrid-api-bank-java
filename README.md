...
- Build date: 2024-12-12T18:18:28.980670Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.80"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.80.jar`
- `target/lib/*.jar`
