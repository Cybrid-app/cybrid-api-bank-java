...
- Build date: 2023-09-08T20:22:50.795166Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.92.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.92.3.jar`
- `target/lib/*.jar`
