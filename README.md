...
- Build date: 2023-10-10T12:07:53.712381Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.98.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.98.1.jar`
- `target/lib/*.jar`
