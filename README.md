...
- Build date: 2024-02-20T16:47:40.055745Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.2.jar`
- `target/lib/*.jar`
