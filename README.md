...
- Build date: 2023-11-23T14:47:31.985323Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.22.jar`
- `target/lib/*.jar`
