...
- Build date: 2024-12-06T16:07:13.226026Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.62"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.62.jar`
- `target/lib/*.jar`
