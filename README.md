...
- Build date: 2024-08-13T21:32:46.478769Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.17.jar`
- `target/lib/*.jar`
