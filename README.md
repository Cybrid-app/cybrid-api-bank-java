...
- Build date: 2025-04-01T14:32:30.819505Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.347"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.347.jar`
- `target/lib/*.jar`
