...
- Build date: 2023-11-20T17:15:21.564244Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.10.jar`
- `target/lib/*.jar`
