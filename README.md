...
- Build date: 2024-05-02T15:24:17.569466Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.133"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.133.jar`
- `target/lib/*.jar`
