...
- Build date: 2024-06-12T13:49:10.147271Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.17.jar`
- `target/lib/*.jar`
