...
- Build date: 2024-03-06T02:01:34.824584Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.41.jar`
- `target/lib/*.jar`
