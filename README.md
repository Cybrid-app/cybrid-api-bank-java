...
- Build date: 2023-05-10T13:02:50.528194Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.11.jar`
- `target/lib/*.jar`
