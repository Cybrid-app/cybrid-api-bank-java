...
- Build date: 2023-04-11T12:14:32.442307Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.31"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.31.jar`
- `target/lib/*.jar`
