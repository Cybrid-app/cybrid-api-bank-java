...
- Build date: 2024-10-23T11:55:44.977072Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.34.jar`
- `target/lib/*.jar`
