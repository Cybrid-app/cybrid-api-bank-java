...
- Build date: 2024-12-05T20:03:04.691972Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.60"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.60.jar`
- `target/lib/*.jar`
