...
- Build date: 2023-07-31T21:33:25.068860Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.10.jar`
- `target/lib/*.jar`
