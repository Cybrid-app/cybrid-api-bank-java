...
- Build date: 2023-05-09T22:16:49.487045Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.9.jar`
- `target/lib/*.jar`
