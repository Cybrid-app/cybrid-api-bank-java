...
- Build date: 2024-07-05T13:56:11.938943Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.67"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.67.jar`
- `target/lib/*.jar`
