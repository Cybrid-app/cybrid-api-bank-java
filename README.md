...
- Build date: 2022-06-08T03:43:10.688292Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.21.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.21.5.jar`
- `target/lib/*.jar`
