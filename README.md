...
- Build date: 2023-08-15T23:15:02.126936Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.10.jar`
- `target/lib/*.jar`
