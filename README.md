...
- Build date: 2024-07-09T18:53:35.125545Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.73"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.73.jar`
- `target/lib/*.jar`
