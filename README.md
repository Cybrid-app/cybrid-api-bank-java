...
- Build date: 2025-05-20T19:23:49.047528Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.502"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.502.jar`
- `target/lib/*.jar`
