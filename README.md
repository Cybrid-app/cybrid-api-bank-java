...
- Build date: 2023-11-22T21:59:24.464917Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.19.jar`
- `target/lib/*.jar`
