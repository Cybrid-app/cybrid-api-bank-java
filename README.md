...
- Build date: 2023-09-22T05:17:36.823806Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.27.jar`
- `target/lib/*.jar`
