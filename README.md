...
- Build date: 2023-05-15T14:41:49.378244Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.22.jar`
- `target/lib/*.jar`
