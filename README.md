...
- Build date: 2023-06-19T14:58:21.357323Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.27.jar`
- `target/lib/*.jar`
