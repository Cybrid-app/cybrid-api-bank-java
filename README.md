...
- Build date: 2023-10-05T16:05:51.531857Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.95.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.95.7.jar`
- `target/lib/*.jar`
