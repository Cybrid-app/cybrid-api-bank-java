...
- Build date: 2024-07-08T12:58:34.132770Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.69"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.69.jar`
- `target/lib/*.jar`
