...
- Build date: 2023-06-26T14:47:24.099212Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.8.jar`
- `target/lib/*.jar`
