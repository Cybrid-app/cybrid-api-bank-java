...
- Build date: 2025-03-27T20:56:12.010083Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.334"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.334.jar`
- `target/lib/*.jar`
