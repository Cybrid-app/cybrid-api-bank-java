...
- Build date: 2025-03-05T12:28:05.598654Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.271"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.271.jar`
- `target/lib/*.jar`
