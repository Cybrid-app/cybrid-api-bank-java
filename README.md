...
- Build date: 2025-06-26T14:51:53.562328Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.643"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.643.jar`
- `target/lib/*.jar`
