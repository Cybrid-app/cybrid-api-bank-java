...
- Build date: 2023-10-13T12:33:58.283347Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.106.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.106.2.jar`
- `target/lib/*.jar`
