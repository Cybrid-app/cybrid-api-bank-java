...
- Build date: 2024-09-11T21:09:08.692360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.85"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.85.jar`
- `target/lib/*.jar`
