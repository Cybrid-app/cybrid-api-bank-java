...
- Build date: 2023-10-04T17:40:34.809808Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.95.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.95.3.jar`
- `target/lib/*.jar`
