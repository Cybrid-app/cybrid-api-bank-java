...
- Build date: 2023-06-21T16:41:30.922995Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.38.jar`
- `target/lib/*.jar`
