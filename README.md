...
- Build date: 2024-10-01T14:31:31.020615Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.157"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.157.jar`
- `target/lib/*.jar`
