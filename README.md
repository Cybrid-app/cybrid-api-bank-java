...
- Build date: 2023-09-26T01:28:18.600338Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.34.jar`
- `target/lib/*.jar`
