...
- Build date: 2024-01-08T13:58:54.928367Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.55"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.55.jar`
- `target/lib/*.jar`
