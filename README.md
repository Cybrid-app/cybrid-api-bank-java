...
- Build date: 2025-01-07T17:09:54.885750Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.127"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.127.jar`
- `target/lib/*.jar`
