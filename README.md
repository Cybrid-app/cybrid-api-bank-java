...
- Build date: 2024-02-01T15:20:13.868011Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.114"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.114.jar`
- `target/lib/*.jar`
