...
- Build date: 2025-04-08T20:04:25.855136Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.368"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.368.jar`
- `target/lib/*.jar`
