...
- Build date: 2025-06-11T16:30:14.736446Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.575"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.575.jar`
- `target/lib/*.jar`
