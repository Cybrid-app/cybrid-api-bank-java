...
- Build date: 2024-10-23T14:56:08.615672Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.38.jar`
- `target/lib/*.jar`
