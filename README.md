...
- Build date: 2024-12-23T23:35:09.250005Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.106"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.106.jar`
- `target/lib/*.jar`
