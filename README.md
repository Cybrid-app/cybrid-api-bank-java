...
- Build date: 2024-05-24T22:46:21.837852Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.13.jar`
- `target/lib/*.jar`
