...
- Build date: 2025-06-27T13:41:18.474684Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.648"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.648.jar`
- `target/lib/*.jar`
