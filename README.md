...
- Build date: 2025-06-11T19:29:04.245138Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.577"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.577.jar`
- `target/lib/*.jar`
