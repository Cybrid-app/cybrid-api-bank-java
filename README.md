...
- Build date: 2023-04-28T12:47:39.482788Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.70"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.70.jar`
- `target/lib/*.jar`
