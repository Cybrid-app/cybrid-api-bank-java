...
- Build date: 2024-10-29T04:52:50.260431Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.51"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.51.jar`
- `target/lib/*.jar`
