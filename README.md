...
- Build date: 2025-04-04T14:01:02.460577Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.357"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.357.jar`
- `target/lib/*.jar`
