...
- Build date: 2024-04-26T15:13:51.077962Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.125"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.125.jar`
- `target/lib/*.jar`
