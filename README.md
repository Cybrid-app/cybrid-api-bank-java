...
- Build date: 2023-06-16T16:29:16.030864Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.21.jar`
- `target/lib/*.jar`
