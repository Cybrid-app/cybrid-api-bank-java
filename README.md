...
- Build date: 2024-11-11T21:16:51.036387Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.57"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.57.jar`
- `target/lib/*.jar`
