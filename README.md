...
- Build date: 2023-06-16T18:59:06.624433Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.22.jar`
- `target/lib/*.jar`
