...
- Build date: 2025-03-18T11:50:06.233514Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.302"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.302.jar`
- `target/lib/*.jar`
