...
- Build date: 2024-10-09T21:20:46.393761Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.16.jar`
- `target/lib/*.jar`
