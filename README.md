...
- Build date: 2023-12-07T22:30:24.135174Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.14"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.14.jar`
- `target/lib/*.jar`
