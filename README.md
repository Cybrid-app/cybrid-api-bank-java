...
- Build date: 2025-05-21T21:07:10.064039Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.512"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.512.jar`
- `target/lib/*.jar`
