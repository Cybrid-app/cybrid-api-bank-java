...
- Build date: 2023-06-21T12:00:00.967624Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.35"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.35.jar`
- `target/lib/*.jar`
