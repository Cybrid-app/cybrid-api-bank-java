...
- Build date: 2023-07-27T14:44:36.841324Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.2.jar`
- `target/lib/*.jar`
