...
- Build date: 2023-07-12T14:36:47.248191Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.4.jar`
- `target/lib/*.jar`
