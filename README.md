...
- Build date: 2024-02-09T16:17:48.389176Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.131"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.131.jar`
- `target/lib/*.jar`
