...
- Build date: 2024-10-04T18:03:45.579543Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.1.jar`
- `target/lib/*.jar`
