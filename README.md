...
- Build date: 2023-12-13T18:59:51.200327Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.40"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.40.jar`
- `target/lib/*.jar`
