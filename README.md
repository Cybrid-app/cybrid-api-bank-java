...
- Build date: 2023-05-25T15:32:53.779962Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.42"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.42.jar`
- `target/lib/*.jar`
