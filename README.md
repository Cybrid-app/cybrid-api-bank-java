...
- Build date: 2023-04-11T14:24:44.888068Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.33"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.33.jar`
- `target/lib/*.jar`
