...
- Build date: 2022-05-16T13:25:48.372228Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.9.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.9.5.jar`
- `target/lib/*.jar`
