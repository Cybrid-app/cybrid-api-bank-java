...
- Build date: 2022-06-08T13:53:50.652361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.21.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.21.8.jar`
- `target/lib/*.jar`
