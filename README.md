...
- Build date: 2024-09-13T23:40:55.979364Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.96"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.96.jar`
- `target/lib/*.jar`
