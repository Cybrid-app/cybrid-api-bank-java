...
- Build date: 2025-05-20T18:43:44.344206Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.501"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.501.jar`
- `target/lib/*.jar`
