...
- Build date: 2023-06-19T19:18:59.790381Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.29.jar`
- `target/lib/*.jar`
