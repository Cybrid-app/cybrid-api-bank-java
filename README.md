...
- Build date: 2025-05-22T12:43:40.038395Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.513"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.513.jar`
- `target/lib/*.jar`
