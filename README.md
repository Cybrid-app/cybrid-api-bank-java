...
- Build date: 2024-10-15T14:21:27.121360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.5.jar`
- `target/lib/*.jar`
