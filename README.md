...
- Build date: 2022-06-01T23:32:43.806424Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.2.jar`
- `target/lib/*.jar`
