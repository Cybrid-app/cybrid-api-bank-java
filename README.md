...
- Build date: 2024-03-21T12:50:54.704939Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.21.jar`
- `target/lib/*.jar`
