...
- Build date: 2024-11-05T14:06:14.689765Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.29.jar`
- `target/lib/*.jar`
