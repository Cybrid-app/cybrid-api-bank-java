...
- Build date: 2024-05-07T23:41:50.546700Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.142"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.142.jar`
- `target/lib/*.jar`
