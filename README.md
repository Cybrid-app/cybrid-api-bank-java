...
- Build date: 2024-09-23T23:30:16.369493Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.134"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.134.jar`
- `target/lib/*.jar`
