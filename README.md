...
- Build date: 2025-04-21T16:48:15.113994Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.407"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.407.jar`
- `target/lib/*.jar`
