...
- Build date: 2025-05-15T19:57:36.009881Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.488"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.488.jar`
- `target/lib/*.jar`
