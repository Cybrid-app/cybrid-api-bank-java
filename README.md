...
- Build date: 2024-04-01T19:45:31.800778Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.53"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.53.jar`
- `target/lib/*.jar`
