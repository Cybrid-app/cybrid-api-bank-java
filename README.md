...
- Build date: 2024-08-05T12:21:12.214484Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.1.jar`
- `target/lib/*.jar`
