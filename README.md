...
- Build date: 2023-06-19T14:35:19.282410Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.26.jar`
- `target/lib/*.jar`
