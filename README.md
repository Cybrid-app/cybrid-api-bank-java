...
- Build date: 2023-06-21T14:24:05.235813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.36"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.36.jar`
- `target/lib/*.jar`
