...
- Build date: 2024-10-15T13:40:08.121422Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.4.jar`
- `target/lib/*.jar`
