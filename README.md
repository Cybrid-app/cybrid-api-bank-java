...
- Build date: 2023-05-25T20:08:22.307996Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.45"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.45.jar`
- `target/lib/*.jar`
