...
- Build date: 2024-12-30T19:33:56.256017Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.113"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.113.jar`
- `target/lib/*.jar`
