...
- Build date: 2024-12-30T17:09:04.794741Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.111"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.111.jar`
- `target/lib/*.jar`
