...
- Build date: 2025-06-10T14:17:58.317539Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.569"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.569.jar`
- `target/lib/*.jar`
