...
- Build date: 2024-01-30T13:55:50.840727Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.108"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.108.jar`
- `target/lib/*.jar`
