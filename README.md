...
- Build date: 2023-11-01T12:50:42.412002Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.31"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.31.jar`
- `target/lib/*.jar`
