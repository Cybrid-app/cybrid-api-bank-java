...
- Build date: 2024-04-10T18:13:58.479601Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.81"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.81.jar`
- `target/lib/*.jar`
