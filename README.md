...
- Build date: 2025-05-05T20:44:28.980444Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.451"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.451.jar`
- `target/lib/*.jar`
