...
- Build date: 2025-05-20T16:27:29.030026Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.499"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.499.jar`
- `target/lib/*.jar`
