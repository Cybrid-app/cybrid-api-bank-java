...
- Build date: 2025-01-17T14:34:27.335841Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.149"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.149.jar`
- `target/lib/*.jar`
