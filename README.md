...
- Build date: 2025-06-16T16:40:19.207298Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.591"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.591.jar`
- `target/lib/*.jar`
