...
- Build date: 2023-08-16T11:54:37.259075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.12.jar`
- `target/lib/*.jar`
