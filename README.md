...
- Build date: 2023-09-28T15:23:27.701160Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.44"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.44.jar`
- `target/lib/*.jar`
