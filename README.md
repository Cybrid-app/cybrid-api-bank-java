...
- Build date: 2023-11-28T23:30:43.940037Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.4.jar`
- `target/lib/*.jar`
