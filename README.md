...
- Build date: 2024-09-17T21:22:18.757044Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.108"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.108.jar`
- `target/lib/*.jar`
