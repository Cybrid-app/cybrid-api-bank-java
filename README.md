...
- Build date: 2024-09-20T16:47:05.262705Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.126"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.126.jar`
- `target/lib/*.jar`
