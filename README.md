...
- Build date: 2025-05-20T22:18:39.590071Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.505"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.505.jar`
- `target/lib/*.jar`
