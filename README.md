...
- Build date: 2024-04-15T17:03:06.837681Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.97"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.97.jar`
- `target/lib/*.jar`
