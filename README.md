...
- Build date: 2025-04-21T20:59:42.758781Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.409"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.409.jar`
- `target/lib/*.jar`
