...
- Build date: 2023-08-19T21:41:27.364478Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.85.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.85.4.jar`
- `target/lib/*.jar`
