...
- Build date: 2023-12-20T21:08:28.419833Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.27.jar`
- `target/lib/*.jar`
