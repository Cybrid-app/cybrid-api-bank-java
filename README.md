...
- Build date: 2023-12-04T22:51:37.737029Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.4.jar`
- `target/lib/*.jar`
