...
- Build date: 2023-07-17T22:16:43.810284Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.15.jar`
- `target/lib/*.jar`
