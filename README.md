...
- Build date: 2025-05-08T20:16:00.088916Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.466"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.466.jar`
- `target/lib/*.jar`
