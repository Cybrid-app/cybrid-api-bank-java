...
- Build date: 2025-03-21T21:00:09.538922Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.316"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.316.jar`
- `target/lib/*.jar`
