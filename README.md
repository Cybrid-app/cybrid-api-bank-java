...
- Build date: 2024-10-07T12:50:12.298286Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.7.jar`
- `target/lib/*.jar`
