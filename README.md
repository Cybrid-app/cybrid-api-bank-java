...
- Build date: 2023-11-13T16:34:00.035065Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.54"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.54.jar`
- `target/lib/*.jar`
