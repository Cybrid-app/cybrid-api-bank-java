...
- Build date: 2023-06-22T23:37:38.091110Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.2.jar`
- `target/lib/*.jar`
