...
- Build date: 2024-11-18T16:38:08.730462Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.3.jar`
- `target/lib/*.jar`
