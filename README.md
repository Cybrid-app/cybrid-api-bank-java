...
- Build date: 2023-10-31T15:01:41.882949Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.28.jar`
- `target/lib/*.jar`
