...
- Build date: 2025-04-15T16:05:01.590399Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.389"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.389.jar`
- `target/lib/*.jar`
