...
- Build date: 2024-02-16T13:31:01.635237Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.153"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.153.jar`
- `target/lib/*.jar`
