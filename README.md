...
- Build date: 2024-04-25T10:22:52.797416Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.120"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.120.jar`
- `target/lib/*.jar`
