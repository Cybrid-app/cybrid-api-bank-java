...
- Build date: 2024-12-03T15:35:16.947875Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.48"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.48.jar`
- `target/lib/*.jar`
