...
- Build date: 2025-06-19T21:55:37.050694Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.613"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.613.jar`
- `target/lib/*.jar`
