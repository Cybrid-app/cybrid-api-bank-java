...
- Build date: 2024-01-26T19:26:32.702025Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.103"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.103.jar`
- `target/lib/*.jar`
