...
- Build date: 2023-06-28T13:40:26.898602Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.21.jar`
- `target/lib/*.jar`
