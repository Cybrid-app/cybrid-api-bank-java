...
- Build date: 2024-02-06T14:01:46.575381Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.120"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.120.jar`
- `target/lib/*.jar`
