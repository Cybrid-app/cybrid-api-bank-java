...
- Build date: 2025-05-09T12:32:56.192014Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.469"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.469.jar`
- `target/lib/*.jar`
