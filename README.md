...
- Build date: 2024-07-23T20:22:40.838063Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.90"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.90.jar`
- `target/lib/*.jar`
