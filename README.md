...
- Build date: 2025-06-16T13:19:21.207728Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.589"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.589.jar`
- `target/lib/*.jar`
