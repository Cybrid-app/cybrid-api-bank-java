...
- Build date: 2025-04-15T18:59:03.053627Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.391"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.391.jar`
- `target/lib/*.jar`
