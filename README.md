...
- Build date: 2025-03-31T19:38:16.503495Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.344"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.344.jar`
- `target/lib/*.jar`
