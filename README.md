...
- Build date: 2023-11-27T16:33:32.242196Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.2.jar`
- `target/lib/*.jar`
