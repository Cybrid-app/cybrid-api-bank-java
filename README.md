...
- Build date: 2025-05-15T13:23:13.367296Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.483"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.483.jar`
- `target/lib/*.jar`
