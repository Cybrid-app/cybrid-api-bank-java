...
- Build date: 2024-04-25T00:22:39.631758Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.117"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.117.jar`
- `target/lib/*.jar`
