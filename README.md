...
- Build date: 2023-05-19T18:58:07.420021Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.29.jar`
- `target/lib/*.jar`
