...
- Build date: 2024-06-03T18:03:28.750126Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.0.jar`
- `target/lib/*.jar`
