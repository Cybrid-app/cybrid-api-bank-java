...
- Build date: 2024-08-22T13:09:50.067838Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.39.jar`
- `target/lib/*.jar`
