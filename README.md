...
- Build date: 2024-01-05T21:58:37.417142Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.54"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.54.jar`
- `target/lib/*.jar`
