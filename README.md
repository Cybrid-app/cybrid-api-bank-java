...
- Build date: 2024-01-02T16:14:36.254612Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.43"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.43.jar`
- `target/lib/*.jar`
