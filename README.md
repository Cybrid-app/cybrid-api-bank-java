...
- Build date: 2025-05-26T20:50:44.536863Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.527"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.527.jar`
- `target/lib/*.jar`
