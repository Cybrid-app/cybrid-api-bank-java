...
- Build date: 2024-09-21T13:52:23.414228Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.129"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.129.jar`
- `target/lib/*.jar`
