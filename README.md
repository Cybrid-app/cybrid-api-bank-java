...
- Build date: 2024-06-26T15:35:18.206228Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.45"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.45.jar`
- `target/lib/*.jar`
