...
- Build date: 2024-03-22T16:30:30.318537Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.28.jar`
- `target/lib/*.jar`
