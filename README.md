...
- Build date: 2024-08-14T14:33:10.718930Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.19.jar`
- `target/lib/*.jar`
