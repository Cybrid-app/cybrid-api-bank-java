...
- Build date: 2025-03-17T20:50:10.594931Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.299"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.299.jar`
- `target/lib/*.jar`
