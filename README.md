...
- Build date: 2024-07-30T17:52:43.337108Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.112"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.112.jar`
- `target/lib/*.jar`
