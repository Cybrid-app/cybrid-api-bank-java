...
- Build date: 2023-11-23T20:56:24.972850Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.25.jar`
- `target/lib/*.jar`
