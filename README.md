...
- Build date: 2025-03-26T10:56:11.347109Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.326"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.326.jar`
- `target/lib/*.jar`
