...
- Build date: 2023-06-27T20:21:30.489722Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.18.jar`
- `target/lib/*.jar`
