...
- Build date: 2024-12-12T15:43:14.858779Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.78"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.78.jar`
- `target/lib/*.jar`
