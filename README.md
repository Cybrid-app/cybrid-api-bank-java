...
- Build date: 2024-07-23T14:15:50.003334Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.88"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.88.jar`
- `target/lib/*.jar`
