...
- Build date: 2023-08-10T16:29:11.033150Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.6.jar`
- `target/lib/*.jar`
