...
- Build date: 2023-07-18T14:00:40.268955Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.18.jar`
- `target/lib/*.jar`
