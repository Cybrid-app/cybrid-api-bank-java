...
- Build date: 2023-10-17T20:40:15.084498Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.107.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.107.2.jar`
- `target/lib/*.jar`
