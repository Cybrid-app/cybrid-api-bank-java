...
- Build date: 2023-06-23T18:53:25.283006Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.5.jar`
- `target/lib/*.jar`
