...
- Build date: 2023-12-14T03:48:02.250339Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.3.jar`
- `target/lib/*.jar`
