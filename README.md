...
- Build date: 2022-05-27T20:18:04.795266Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.15.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.15.8.jar`
- `target/lib/*.jar`
