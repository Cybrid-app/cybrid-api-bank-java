...
- Build date: 2024-02-15T12:36:01.605830Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.149"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.149.jar`
- `target/lib/*.jar`
