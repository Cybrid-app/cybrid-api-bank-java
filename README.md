...
- Build date: 2024-01-22T14:06:25.461717Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.83"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.83.jar`
- `target/lib/*.jar`
