...
- Build date: 2023-07-05T21:38:33.478783Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.76.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.76.4.jar`
- `target/lib/*.jar`
