...
- Build date: 2024-09-25T18:45:03.830704Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.139"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.139.jar`
- `target/lib/*.jar`
