...
- Build date: 2024-12-03T15:01:05.181300Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.47.jar`
- `target/lib/*.jar`
