...
- Build date: 2025-03-26T14:02:39.370128Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.328"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.328.jar`
- `target/lib/*.jar`
