...
- Build date: 2023-10-31T13:58:47.598827Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.27.jar`
- `target/lib/*.jar`
