...
- Build date: 2024-03-27T16:10:12.073228Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.43"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.43.jar`
- `target/lib/*.jar`
