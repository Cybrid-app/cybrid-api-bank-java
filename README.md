...
- Build date: 2023-12-06T18:16:12.152320Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.12.jar`
- `target/lib/*.jar`
