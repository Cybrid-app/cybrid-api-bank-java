...
- Build date: 2025-06-20T13:41:08.952047Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.614"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.614.jar`
- `target/lib/*.jar`
