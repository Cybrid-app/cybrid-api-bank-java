...
- Build date: 2024-12-19T13:12:26.389184Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.98"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.98.jar`
- `target/lib/*.jar`
