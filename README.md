...
- Build date: 2025-06-11T15:50:07.477642Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.574"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.574.jar`
- `target/lib/*.jar`
