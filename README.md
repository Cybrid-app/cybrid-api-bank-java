...
- Build date: 2024-04-01T16:36:21.030005Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.52"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.52.jar`
- `target/lib/*.jar`
