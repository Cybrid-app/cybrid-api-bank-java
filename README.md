...
- Build date: 2025-01-13T16:20:56.097669Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.139"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.139.jar`
- `target/lib/*.jar`
