...
- Build date: 2024-06-12T15:51:34.301487Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.19.jar`
- `target/lib/*.jar`
