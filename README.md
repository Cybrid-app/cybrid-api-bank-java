...
- Build date: 2024-12-03T13:55:24.843437Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.46"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.46.jar`
- `target/lib/*.jar`
