...
- Build date: 2024-04-23T20:14:41.970370Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.116"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.116.jar`
- `target/lib/*.jar`
