...
- Build date: 2024-06-07T15:16:37.923694Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.6.jar`
- `target/lib/*.jar`
