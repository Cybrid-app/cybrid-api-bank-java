...
- Build date: 2024-12-04T16:26:39.049149Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.53"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.53.jar`
- `target/lib/*.jar`
