...
- Build date: 2024-11-08T16:55:11.493333Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.45"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.45.jar`
- `target/lib/*.jar`
