...
- Build date: 2023-11-03T12:59:07.582394Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.34.jar`
- `target/lib/*.jar`
