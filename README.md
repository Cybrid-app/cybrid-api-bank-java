...
- Build date: 2022-05-05T10:59:21.458691Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.30.jar`
- `target/lib/*.jar`
