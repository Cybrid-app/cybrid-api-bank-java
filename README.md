...
- Build date: 2023-10-24T12:55:55.715935Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.15.jar`
- `target/lib/*.jar`
