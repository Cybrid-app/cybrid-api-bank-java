...
- Build date: 2025-03-07T15:41:14.134343Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.283"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.283.jar`
- `target/lib/*.jar`
