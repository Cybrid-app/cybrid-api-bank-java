...
- Build date: 2025-03-07T01:07:54.230828Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.280"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.280.jar`
- `target/lib/*.jar`
