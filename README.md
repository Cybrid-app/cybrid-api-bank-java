...
- Build date: 2023-10-18T17:35:54.813017Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.1.jar`
- `target/lib/*.jar`
