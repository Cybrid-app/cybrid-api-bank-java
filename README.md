...
- Build date: 2025-03-02T12:40:25.466056Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.266"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.266.jar`
- `target/lib/*.jar`
