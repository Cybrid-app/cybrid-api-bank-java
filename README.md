...
- Build date: 2024-09-09T14:19:34.998681Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.72"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.72.jar`
- `target/lib/*.jar`
