...
- Build date: 2024-09-09T21:29:20.502449Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.78"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.78.jar`
- `target/lib/*.jar`
