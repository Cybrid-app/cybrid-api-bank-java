...
- Build date: 2024-09-20T22:31:08.897548Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.128"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.128.jar`
- `target/lib/*.jar`
