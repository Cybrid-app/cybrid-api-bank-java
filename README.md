...
- Build date: 2025-02-05T12:17:36.020365Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.206"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.206.jar`
- `target/lib/*.jar`
