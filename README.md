...
- Build date: 2023-09-22T14:40:51.473557Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.29.jar`
- `target/lib/*.jar`
