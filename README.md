...
- Build date: 2023-08-18T19:38:06.789100Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.16.jar`
- `target/lib/*.jar`
