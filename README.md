...
- Build date: 2023-10-12T18:35:45.347243Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.106.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.106.0.jar`
- `target/lib/*.jar`
