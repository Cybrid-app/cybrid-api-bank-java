...
- Build date: 2025-06-11T15:09:03.319515Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.573"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.573.jar`
- `target/lib/*.jar`
