...
- Build date: 2024-03-05T20:06:54.072885Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.40"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.40.jar`
- `target/lib/*.jar`
