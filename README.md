...
- Build date: 2023-08-23T17:49:04.868415Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.86.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.86.5.jar`
- `target/lib/*.jar`
