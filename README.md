...
- Build date: 2025-05-21T19:52:52.508001Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.510"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.510.jar`
- `target/lib/*.jar`
