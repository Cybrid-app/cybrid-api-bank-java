...
- Build date: 2023-08-23T12:28:17.092194Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.86.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.86.4.jar`
- `target/lib/*.jar`
