...
- Build date: 2024-05-15T21:45:54.604083Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.116.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.116.4.jar`
- `target/lib/*.jar`
