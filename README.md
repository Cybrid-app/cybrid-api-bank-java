...
- Build date: 2023-06-19T21:39:29.402662Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.30.jar`
- `target/lib/*.jar`
