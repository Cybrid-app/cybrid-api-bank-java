...
- Build date: 2024-03-04T16:49:06.945108Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.36"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.36.jar`
- `target/lib/*.jar`
