...
- Build date: 2023-11-30T15:15:23.046866Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.16.jar`
- `target/lib/*.jar`
