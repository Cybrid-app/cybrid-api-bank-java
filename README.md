...
- Build date: 2024-11-13T19:19:36.434007Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.65"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.65.jar`
- `target/lib/*.jar`
