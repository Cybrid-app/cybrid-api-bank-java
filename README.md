...
- Build date: 2024-11-15T14:59:00.009455Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.70"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.70.jar`
- `target/lib/*.jar`
