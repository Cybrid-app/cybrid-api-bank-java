...
- Build date: 2025-06-05T16:38:24.431782Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.555"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.555.jar`
- `target/lib/*.jar`
