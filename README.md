...
- Build date: 2024-09-30T19:18:18.822133Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.154"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.154.jar`
- `target/lib/*.jar`
