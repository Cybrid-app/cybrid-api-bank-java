...
- Build date: 2024-09-30T13:55:23.869766Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.152"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.152.jar`
- `target/lib/*.jar`
