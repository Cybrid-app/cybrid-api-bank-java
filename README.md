...
- Build date: 2024-10-04T16:52:57.156310Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.0.jar`
- `target/lib/*.jar`
