...
- Build date: 2024-04-09T12:58:42.262961Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.70"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.70.jar`
- `target/lib/*.jar`
