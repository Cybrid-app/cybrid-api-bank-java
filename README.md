...
- Build date: 2023-05-11T18:54:03.873003Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.17.jar`
- `target/lib/*.jar`
