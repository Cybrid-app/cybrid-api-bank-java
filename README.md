...
- Build date: 2024-11-15T16:37:52.482761Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.71"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.71.jar`
- `target/lib/*.jar`
