...
- Build date: 2023-11-29T01:36:45.540377Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.5.jar`
- `target/lib/*.jar`
