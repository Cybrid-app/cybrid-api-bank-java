...
- Build date: 2023-12-19T16:26:17.093515Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.22.jar`
- `target/lib/*.jar`
