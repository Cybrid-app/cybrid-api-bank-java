...
- Build date: 2023-06-01T18:15:32.609448Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.64"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.64.jar`
- `target/lib/*.jar`
