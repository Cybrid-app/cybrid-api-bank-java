...
- Build date: 2025-03-24T15:12:05.771753Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.319"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.319.jar`
- `target/lib/*.jar`
