...
- Build date: 2023-12-17T23:27:44.299165Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.12.jar`
- `target/lib/*.jar`
