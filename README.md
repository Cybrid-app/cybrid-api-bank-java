...
- Build date: 2024-10-07T16:47:28.578365Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.10.jar`
- `target/lib/*.jar`
