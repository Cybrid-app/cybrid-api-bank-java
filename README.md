...
- Build date: 2023-12-13T12:14:37.872596Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.38.jar`
- `target/lib/*.jar`
