...
- Build date: 2023-09-26T13:19:20.230846Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.37"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.37.jar`
- `target/lib/*.jar`
