...
- Build date: 2023-05-02T20:40:24.300951Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.81"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.81.jar`
- `target/lib/*.jar`
