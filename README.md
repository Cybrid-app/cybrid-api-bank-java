...
- Build date: 2023-05-30T18:55:21.998378Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.59"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.59.jar`
- `target/lib/*.jar`
