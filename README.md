...
- Build date: 2023-12-15T16:07:23.783623Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.9.jar`
- `target/lib/*.jar`
