...
- Build date: 2023-08-10T18:12:59.441820Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.7.jar`
- `target/lib/*.jar`
