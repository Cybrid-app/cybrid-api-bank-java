...
- Build date: 2024-10-30T17:15:56.781025Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.4.jar`
- `target/lib/*.jar`
