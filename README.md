...
- Build date: 2023-06-01T12:44:38.710698Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.62"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.62.jar`
- `target/lib/*.jar`
