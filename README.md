...
- Build date: 2023-08-01T19:13:12.033029Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.20"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.20.jar`
- `target/lib/*.jar`
