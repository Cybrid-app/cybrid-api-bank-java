...
- Build date: 2024-11-08T21:27:29.345545Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.49"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.49.jar`
- `target/lib/*.jar`
