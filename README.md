...
- Build date: 2024-02-26T17:51:17.530679Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.18.jar`
- `target/lib/*.jar`
