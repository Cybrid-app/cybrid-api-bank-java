...
- Build date: 2025-05-28T13:26:20.957812Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.531"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.531.jar`
- `target/lib/*.jar`
