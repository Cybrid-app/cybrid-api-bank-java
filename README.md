...
- Build date: 2022-05-13T18:10:18.672016Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.8.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.8.8.jar`
- `target/lib/*.jar`
