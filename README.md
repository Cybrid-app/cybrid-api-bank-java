...
- Build date: 2024-12-13T15:07:42.459472Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.85"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.85.jar`
- `target/lib/*.jar`
