...
- Build date: 2023-12-21T14:20:55.186278Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.28.jar`
- `target/lib/*.jar`
