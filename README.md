...
- Build date: 2024-10-08T15:17:00.683575Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.12.jar`
- `target/lib/*.jar`
