...
- Build date: 2025-02-19T17:29:48.141760Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.243"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.243.jar`
- `target/lib/*.jar`
