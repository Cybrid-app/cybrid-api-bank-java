...
- Build date: 2024-12-03T17:27:15.446301Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.50"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.50.jar`
- `target/lib/*.jar`
