...
- Build date: 2024-11-20T15:43:55.057924Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.10.jar`
- `target/lib/*.jar`
