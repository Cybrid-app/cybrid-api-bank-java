...
- Build date: 2022-05-30T13:03:17.258415Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.15.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.15.9.jar`
- `target/lib/*.jar`
