...
- Build date: 2025-06-19T14:01:51.284304Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.605"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.605.jar`
- `target/lib/*.jar`
