...
- Build date: 2024-01-24T13:57:05.538417Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.91"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.91.jar`
- `target/lib/*.jar`
