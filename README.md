...
- Build date: 2024-09-17T15:31:18.695003Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.104"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.104.jar`
- `target/lib/*.jar`
