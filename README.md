...
- Build date: 2024-11-06T13:39:49.954318Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.33"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.33.jar`
- `target/lib/*.jar`
