...
- Build date: 2024-04-18T23:11:35.893396Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.108"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.108.jar`
- `target/lib/*.jar`
