...
- Build date: 2025-06-11T14:32:43.650855Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.572"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.572.jar`
- `target/lib/*.jar`
