...
- Build date: 2024-07-02T19:31:10.564706Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.57"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.57.jar`
- `target/lib/*.jar`
