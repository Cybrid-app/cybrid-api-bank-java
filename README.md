...
- Build date: 2023-08-18T19:05:58.199305Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.15.jar`
- `target/lib/*.jar`
