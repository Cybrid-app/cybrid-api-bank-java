...
- Build date: 2023-12-21T18:10:43.745283Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.30.jar`
- `target/lib/*.jar`
