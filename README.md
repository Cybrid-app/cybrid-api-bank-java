...
- Build date: 2025-01-20T15:35:58.804114Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.153"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.153.jar`
- `target/lib/*.jar`
