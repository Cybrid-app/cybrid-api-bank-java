...
- Build date: 2024-09-30T16:34:16.298080Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.153"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.153.jar`
- `target/lib/*.jar`
