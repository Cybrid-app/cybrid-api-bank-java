...
- Build date: 2025-06-20T14:25:06.320852Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.615"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.615.jar`
- `target/lib/*.jar`
