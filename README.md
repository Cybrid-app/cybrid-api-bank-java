...
- Build date: 2022-05-25T10:10:16.560068Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.14.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.14.9.jar`
- `target/lib/*.jar`
