...
- Build date: 2023-08-15T19:52:03.689753Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.8.jar`
- `target/lib/*.jar`
