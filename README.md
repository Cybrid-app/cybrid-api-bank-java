...
- Build date: 2025-04-22T18:42:52.445786Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.410"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.410.jar`
- `target/lib/*.jar`
