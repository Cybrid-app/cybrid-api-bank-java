...
- Build date: 2024-01-08T16:07:38.978950Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.56"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.56.jar`
- `target/lib/*.jar`
