...
- Build date: 2024-08-19T21:39:32.922549Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.34.jar`
- `target/lib/*.jar`
