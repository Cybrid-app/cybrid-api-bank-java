...
- Build date: 2024-09-18T18:31:42.159535Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.113"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.113.jar`
- `target/lib/*.jar`
