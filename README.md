...
- Build date: 2023-04-12T15:18:14.104151Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.38.jar`
- `target/lib/*.jar`
