...
- Build date: 2023-09-26T17:41:53.544291Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.39.jar`
- `target/lib/*.jar`
