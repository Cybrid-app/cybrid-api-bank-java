...
- Build date: 2023-04-18T15:29:17.605107Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.53"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.53.jar`
- `target/lib/*.jar`
