...
- Build date: 2025-06-13T11:43:17.425432Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.581"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.581.jar`
- `target/lib/*.jar`
