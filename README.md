...
- Build date: 2024-11-08T17:34:29.887952Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.46"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.46.jar`
- `target/lib/*.jar`
