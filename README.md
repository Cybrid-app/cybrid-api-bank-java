...
- Build date: 2023-08-24T13:02:32.723209Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.87.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.87.0.jar`
- `target/lib/*.jar`
