...
- Build date: 2025-06-30T14:29:32.552742Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.651"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.651.jar`
- `target/lib/*.jar`
