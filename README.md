...
- Build date: 2023-04-18T16:26:34.959383Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.54"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.54.jar`
- `target/lib/*.jar`
