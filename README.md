...
- Build date: 2023-12-11T18:56:56.306793Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.28.jar`
- `target/lib/*.jar`
