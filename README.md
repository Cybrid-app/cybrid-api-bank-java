...
- Build date: 2025-02-06T22:14:36.222346Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.217"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.217.jar`
- `target/lib/*.jar`
