...
- Build date: 2023-12-18T21:42:07.216808Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.17.jar`
- `target/lib/*.jar`
