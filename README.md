...
- Build date: 2024-06-28T19:28:10.249231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.54"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.54.jar`
- `target/lib/*.jar`
