...
- Build date: 2025-05-21T13:50:50.064263Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.507"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.507.jar`
- `target/lib/*.jar`
