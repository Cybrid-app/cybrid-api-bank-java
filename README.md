...
- Build date: 2023-11-09T21:32:48.940878Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.46"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.46.jar`
- `target/lib/*.jar`
