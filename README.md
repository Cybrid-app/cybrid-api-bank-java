...
- Build date: 2024-10-24T14:02:21.976520Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.41.jar`
- `target/lib/*.jar`
