...
- Build date: 2023-12-09T21:30:13.005937Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.23"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.23.jar`
- `target/lib/*.jar`
