...
- Build date: 2025-01-17T13:51:16.206392Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.148"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.148.jar`
- `target/lib/*.jar`
