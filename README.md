...
- Build date: 2025-04-30T15:48:17.676557Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.439"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.439.jar`
- `target/lib/*.jar`
