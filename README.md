...
- Build date: 2023-06-27T12:01:48.463812Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.13.jar`
- `target/lib/*.jar`
