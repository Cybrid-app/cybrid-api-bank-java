...
- Build date: 2024-12-09T15:24:10.267206Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.67"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.67.jar`
- `target/lib/*.jar`
