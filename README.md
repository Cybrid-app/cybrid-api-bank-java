...
- Build date: 2023-11-21T17:44:46.881988Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.16.jar`
- `target/lib/*.jar`
