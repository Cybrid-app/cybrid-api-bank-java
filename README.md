...
- Build date: 2023-12-13T22:21:23.274970Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.2.jar`
- `target/lib/*.jar`
