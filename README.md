...
- Build date: 2023-09-18T17:07:21.552211Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.16.jar`
- `target/lib/*.jar`
