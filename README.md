...
- Build date: 2024-11-14T17:51:01.349148Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.68"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.68.jar`
- `target/lib/*.jar`
