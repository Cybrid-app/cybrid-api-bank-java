...
- Build date: 2024-09-16T16:27:18.982940Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.98"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.98.jar`
- `target/lib/*.jar`
