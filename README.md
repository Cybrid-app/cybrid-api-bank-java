...
- Build date: 2023-12-12T18:15:35.266876Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.37"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.37.jar`
- `target/lib/*.jar`
