...
- Build date: 2023-11-06T13:16:52.249371Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.37"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.37.jar`
- `target/lib/*.jar`
