...
- Build date: 2022-06-10T23:37:34.711542Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.24.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.24.4.jar`
- `target/lib/*.jar`
