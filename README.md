...
- Build date: 2025-05-01T17:51:16.734775Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.443"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.443.jar`
- `target/lib/*.jar`
