...
- Build date: 2022-06-06T12:57:54.226616Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.13.jar`
- `target/lib/*.jar`
