...
- Build date: 2024-08-19T18:33:45.292105Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.31"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.31.jar`
- `target/lib/*.jar`
