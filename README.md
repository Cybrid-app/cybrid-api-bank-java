...
- Build date: 2024-07-04T15:22:16.195036Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.63"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.63.jar`
- `target/lib/*.jar`
