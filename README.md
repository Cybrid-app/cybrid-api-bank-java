...
- Build date: 2025-06-14T12:21:45.251359Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.587"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.587.jar`
- `target/lib/*.jar`
