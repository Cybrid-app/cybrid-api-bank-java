...
- Build date: 2025-01-02T14:25:59.116900Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.116"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.116.jar`
- `target/lib/*.jar`
