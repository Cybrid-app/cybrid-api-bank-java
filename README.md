...
- Build date: 2023-05-04T11:41:45.348939Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.86"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.86.jar`
- `target/lib/*.jar`
