...
- Build date: 2025-03-06T16:59:00.811619Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.276"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.276.jar`
- `target/lib/*.jar`
