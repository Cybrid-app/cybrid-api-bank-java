...
- Build date: 2023-12-15T15:05:30.173334Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.8.jar`
- `target/lib/*.jar`
