...
- Build date: 2025-04-10T21:40:51.491009Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.378"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.378.jar`
- `target/lib/*.jar`
