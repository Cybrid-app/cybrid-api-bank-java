...
- Build date: 2023-04-28T13:23:09.934080Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.71"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.71.jar`
- `target/lib/*.jar`
