...
- Build date: 2025-02-26T14:32:27.795176Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.259"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.259.jar`
- `target/lib/*.jar`
