...
- Build date: 2023-07-11T19:09:53.048720Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.1.jar`
- `target/lib/*.jar`
