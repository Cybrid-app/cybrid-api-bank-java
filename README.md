...
- Build date: 2025-04-29T13:45:50.755523Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.433"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.433.jar`
- `target/lib/*.jar`
