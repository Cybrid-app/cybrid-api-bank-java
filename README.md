...
- Build date: 2024-06-03T15:10:59.549992Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.29.jar`
- `target/lib/*.jar`
