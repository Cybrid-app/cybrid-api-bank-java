...
- Build date: 2024-10-02T13:36:49.952409Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.160"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.160.jar`
- `target/lib/*.jar`
