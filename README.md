...
- Build date: 2023-09-22T21:18:30.745763Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.31"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.31.jar`
- `target/lib/*.jar`
