...
- Build date: 2024-03-26T12:45:49.373022Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.38.jar`
- `target/lib/*.jar`
