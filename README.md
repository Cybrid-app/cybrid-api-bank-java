...
- Build date: 2025-03-31T22:49:22.819484Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.345"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.345.jar`
- `target/lib/*.jar`
