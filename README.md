...
- Build date: 2024-12-04T22:58:16.912195Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.57"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.57.jar`
- `target/lib/*.jar`
