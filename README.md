...
- Build date: 2024-07-12T15:31:03.637994Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.77"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.77.jar`
- `target/lib/*.jar`
