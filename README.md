...
- Build date: 2024-03-28T18:24:10.868442Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.47.jar`
- `target/lib/*.jar`
