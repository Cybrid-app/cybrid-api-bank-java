...
- Build date: 2024-08-28T13:43:13.653203Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.50"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.50.jar`
- `target/lib/*.jar`
