...
- Build date: 2024-03-28T19:20:28.549627Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.48"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.48.jar`
- `target/lib/*.jar`
