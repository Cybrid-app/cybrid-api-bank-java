...
- Build date: 2023-05-25T15:02:43.195457Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.41.jar`
- `target/lib/*.jar`
