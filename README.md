...
- Build date: 2023-05-15T12:26:40.271144Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.21.jar`
- `target/lib/*.jar`
