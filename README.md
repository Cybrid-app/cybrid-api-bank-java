...
- Build date: 2024-10-30T13:48:59.369196Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.3.jar`
- `target/lib/*.jar`
