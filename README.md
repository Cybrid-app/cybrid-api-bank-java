...
- Build date: 2025-06-05T12:26:39.969381Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.553"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.553.jar`
- `target/lib/*.jar`
