...
- Build date: 2025-05-06T17:00:10.264651Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.456"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.456.jar`
- `target/lib/*.jar`
