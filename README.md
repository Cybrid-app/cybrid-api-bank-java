...
- Build date: 2023-07-31T22:39:20.336048Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.12.jar`
- `target/lib/*.jar`
