...
- Build date: 2025-05-13T14:24:50.757170Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.477"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.477.jar`
- `target/lib/*.jar`
