...
- Build date: 2024-03-25T14:01:14.962533Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.34.jar`
- `target/lib/*.jar`
