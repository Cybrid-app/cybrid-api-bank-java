...
- Build date: 2023-08-15T21:25:57.204963Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.9.jar`
- `target/lib/*.jar`
