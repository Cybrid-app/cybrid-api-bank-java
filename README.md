...
- Build date: 2025-02-07T17:48:10.021404Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.220"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.220.jar`
- `target/lib/*.jar`
