...
- Build date: 2022-06-06T14:03:21.931805Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.14"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.14.jar`
- `target/lib/*.jar`
