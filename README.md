...
- Build date: 2025-02-25T23:54:23.292485Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.257"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.257.jar`
- `target/lib/*.jar`
