...
- Build date: 2025-01-10T22:57:18.209891Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.137"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.137.jar`
- `target/lib/*.jar`
