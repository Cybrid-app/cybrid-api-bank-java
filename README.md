...
- Build date: 2022-06-14T02:56:32.374670Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.25.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.25.0.jar`
- `target/lib/*.jar`
