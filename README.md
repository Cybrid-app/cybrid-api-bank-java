...
- Build date: 2023-08-30T16:42:58.571521Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.89.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.89.7.jar`
- `target/lib/*.jar`
