...
- Build date: 2023-08-10T00:32:50.872344Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.1.jar`
- `target/lib/*.jar`
