...
- Build date: 2024-11-07T16:07:00.920193Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.36"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.36.jar`
- `target/lib/*.jar`
