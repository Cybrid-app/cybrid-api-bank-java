...
- Build date: 2024-02-10T18:50:21.034761Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.135"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.135.jar`
- `target/lib/*.jar`
