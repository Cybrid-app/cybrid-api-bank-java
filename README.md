...
- Build date: 2024-08-15T16:54:01.238458Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.24.jar`
- `target/lib/*.jar`
