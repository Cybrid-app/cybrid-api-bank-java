...
- Build date: 2025-02-14T13:34:49.284409Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.233"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.233.jar`
- `target/lib/*.jar`
