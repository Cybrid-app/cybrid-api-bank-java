...
- Build date: 2025-01-20T14:41:48.012820Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.152"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.152.jar`
- `target/lib/*.jar`
