...
- Build date: 2024-07-25T17:49:59.989414Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.96"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.96.jar`
- `target/lib/*.jar`
