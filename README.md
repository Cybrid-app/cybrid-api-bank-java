...
- Build date: 2025-03-09T18:22:23.367722Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.286"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.286.jar`
- `target/lib/*.jar`
