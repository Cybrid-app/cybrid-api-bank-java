...
- Build date: 2025-02-05T14:45:07.813979Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.208"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.208.jar`
- `target/lib/*.jar`
