...
- Build date: 2022-06-08T05:31:51.225362Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.21.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.21.6.jar`
- `target/lib/*.jar`
