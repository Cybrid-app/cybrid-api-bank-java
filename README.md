...
- Build date: 2023-07-19T17:32:46.389824Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.4.jar`
- `target/lib/*.jar`
