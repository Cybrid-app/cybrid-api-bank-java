...
- Build date: 2023-08-28T16:53:19.629235Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.88.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.88.11.jar`
- `target/lib/*.jar`
