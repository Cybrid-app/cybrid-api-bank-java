...
- Build date: 2025-04-16T19:05:33.232128Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.400"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.400.jar`
- `target/lib/*.jar`
