...
- Build date: 2024-07-26T15:13:30.152251Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.101"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.101.jar`
- `target/lib/*.jar`
