...
- Build date: 2024-04-11T09:58:18.706728Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.82"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.82.jar`
- `target/lib/*.jar`
