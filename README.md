...
- Build date: 2025-02-06T17:49:27.687318Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.216"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.216.jar`
- `target/lib/*.jar`
