...
- Build date: 2025-03-17T21:37:58.883461Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.300"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.300.jar`
- `target/lib/*.jar`
