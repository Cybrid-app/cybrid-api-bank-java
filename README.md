...
- Build date: 2022-06-06T16:05:33.073136Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.16.jar`
- `target/lib/*.jar`
