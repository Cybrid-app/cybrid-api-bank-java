...
- Build date: 2022-06-06T12:08:22.263947Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.12.jar`
- `target/lib/*.jar`
