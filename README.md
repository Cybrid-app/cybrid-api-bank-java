...
- Build date: 2025-04-22T22:03:59.409143Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.412"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.412.jar`
- `target/lib/*.jar`
