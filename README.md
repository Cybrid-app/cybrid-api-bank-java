...
- Build date: 2023-08-01T18:47:48.515674Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.19.jar`
- `target/lib/*.jar`
