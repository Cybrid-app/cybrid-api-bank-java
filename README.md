...
- Build date: 2025-04-17T13:09:12.403528Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.402"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.402.jar`
- `target/lib/*.jar`
