...
- Build date: 2025-03-21T16:37:49.820831Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.315"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.315.jar`
- `target/lib/*.jar`
