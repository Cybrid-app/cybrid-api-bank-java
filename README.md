...
- Build date: 2024-03-21T13:49:56.330344Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.22.jar`
- `target/lib/*.jar`
