...
- Build date: 2024-10-15T18:17:06.443020Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.8.jar`
- `target/lib/*.jar`
