...
- Build date: 2023-04-13T21:17:13.697122Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.47.jar`
- `target/lib/*.jar`
