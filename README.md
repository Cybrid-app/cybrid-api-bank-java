...
- Build date: 2023-04-25T12:06:42.098424Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.62"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.62.jar`
- `target/lib/*.jar`
