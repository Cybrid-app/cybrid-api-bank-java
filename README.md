...
- Build date: 2024-12-11T14:00:00.683090Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.75"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.75.jar`
- `target/lib/*.jar`
