...
- Build date: 2023-10-05T12:46:32.640266Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.95.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.95.5.jar`
- `target/lib/*.jar`
