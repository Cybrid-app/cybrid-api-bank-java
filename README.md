...
- Build date: 2024-03-08T20:51:39.660758Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.0.jar`
- `target/lib/*.jar`
