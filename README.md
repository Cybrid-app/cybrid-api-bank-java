...
- Build date: 2024-03-27T12:56:42.295702Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.41.jar`
- `target/lib/*.jar`
