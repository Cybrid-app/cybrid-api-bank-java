...
- Build date: 2023-06-26T13:23:41.165553Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.7.jar`
- `target/lib/*.jar`
