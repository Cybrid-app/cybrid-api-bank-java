...
- Build date: 2023-11-06T15:15:53.989651Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.38.jar`
- `target/lib/*.jar`
