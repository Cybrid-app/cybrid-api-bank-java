...
- Build date: 2024-11-04T15:39:23.435833Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.24.jar`
- `target/lib/*.jar`
