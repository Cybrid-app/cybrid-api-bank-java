...
- Build date: 2023-08-10T19:02:57.548137Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.8.jar`
- `target/lib/*.jar`
