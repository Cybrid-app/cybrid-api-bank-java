...
- Build date: 2023-05-09T15:18:18.298329Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.4.jar`
- `target/lib/*.jar`
