...
- Build date: 2024-01-18T21:48:15.970219Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.72"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.72.jar`
- `target/lib/*.jar`
