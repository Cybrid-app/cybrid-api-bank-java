...
- Build date: 2023-04-27T12:41:02.165559Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.68"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.68.jar`
- `target/lib/*.jar`
