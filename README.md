...
- Build date: 2024-03-09T01:33:10.892508Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.3.jar`
- `target/lib/*.jar`
