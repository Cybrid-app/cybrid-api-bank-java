...
- Build date: 2025-05-15T18:57:18.462538Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.487"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.487.jar`
- `target/lib/*.jar`
