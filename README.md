...
- Build date: 2023-07-06T19:00:17.861530Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.76.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.76.5.jar`
- `target/lib/*.jar`
