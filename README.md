...
- Build date: 2025-06-17T15:09:27.283676Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.598"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.598.jar`
- `target/lib/*.jar`
