...
- Build date: 2023-11-10T22:53:49.871768Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.50"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.50.jar`
- `target/lib/*.jar`
