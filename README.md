...
- Build date: 2023-07-19T02:53:36.812556Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.2.jar`
- `target/lib/*.jar`
