...
- Build date: 2024-10-05T18:07:56.728795Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.5.jar`
- `target/lib/*.jar`
