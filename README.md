...
- Build date: 2023-08-22T19:17:09.017370Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.86.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.86.0.jar`
- `target/lib/*.jar`
