...
- Build date: 2024-09-04T20:35:58.848240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.67"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.67.jar`
- `target/lib/*.jar`
