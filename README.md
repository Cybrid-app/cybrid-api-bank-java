...
- Build date: 2024-10-07T15:30:41.471524Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.9.jar`
- `target/lib/*.jar`
