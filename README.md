...
- Build date: 2024-01-25T13:11:27.064090Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.94"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.94.jar`
- `target/lib/*.jar`
