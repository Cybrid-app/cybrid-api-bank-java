...
- Build date: 2022-06-04T16:44:04.544312Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.9.jar`
- `target/lib/*.jar`
