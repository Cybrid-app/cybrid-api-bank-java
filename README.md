...
- Build date: 2024-12-06T21:52:51.833391Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.64"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.64.jar`
- `target/lib/*.jar`
