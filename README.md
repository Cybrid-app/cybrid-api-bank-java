...
- Build date: 2024-03-11T16:19:03.521042Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.7.jar`
- `target/lib/*.jar`
