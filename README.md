...
- Build date: 2024-09-24T15:52:59.151405Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.135"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.135.jar`
- `target/lib/*.jar`
