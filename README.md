...
- Build date: 2023-11-08T19:41:11.827083Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.42"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.42.jar`
- `target/lib/*.jar`
