...
- Build date: 2024-08-01T14:29:21.131724Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.116"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.116.jar`
- `target/lib/*.jar`
