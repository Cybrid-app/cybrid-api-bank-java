...
- Build date: 2023-08-01T20:30:53.905911Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.21.jar`
- `target/lib/*.jar`
