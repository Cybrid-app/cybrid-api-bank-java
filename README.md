...
- Build date: 2023-11-09T21:03:36.246672Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.45"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.45.jar`
- `target/lib/*.jar`
