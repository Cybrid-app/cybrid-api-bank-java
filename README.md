...
- Build date: 2022-06-08T13:00:35.152780Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.21.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.21.7.jar`
- `target/lib/*.jar`
