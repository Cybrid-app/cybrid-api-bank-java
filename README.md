...
- Build date: 2024-03-23T15:45:40.913203Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.33"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.33.jar`
- `target/lib/*.jar`
