...
- Build date: 2025-06-09T15:00:54.074732Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.562"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.562.jar`
- `target/lib/*.jar`
