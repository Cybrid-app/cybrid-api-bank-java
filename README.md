...
- Build date: 2023-11-13T15:36:54.850726Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.53"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.53.jar`
- `target/lib/*.jar`
