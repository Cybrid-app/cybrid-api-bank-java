...
- Build date: 2022-05-05T13:18:40.987612Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.32.jar`
- `target/lib/*.jar`
