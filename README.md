...
- Build date: 2023-10-05T22:37:29.631146Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.96.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.96.1.jar`
- `target/lib/*.jar`
