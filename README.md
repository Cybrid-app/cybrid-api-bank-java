...
- Build date: 2025-02-07T17:13:25.884974Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.219"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.219.jar`
- `target/lib/*.jar`
