...
- Build date: 2023-11-02T12:13:06.795298Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.32.jar`
- `target/lib/*.jar`
