...
- Build date: 2025-04-23T17:59:21.901996Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.418"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.418.jar`
- `target/lib/*.jar`
