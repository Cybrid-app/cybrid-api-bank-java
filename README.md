...
- Build date: 2025-03-03T14:49:40.360705Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.267"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.267.jar`
- `target/lib/*.jar`
