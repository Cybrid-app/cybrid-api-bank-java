...
- Build date: 2024-01-26T16:03:52.573677Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.101"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.101.jar`
- `target/lib/*.jar`
