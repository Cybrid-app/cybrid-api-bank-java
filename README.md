...
- Build date: 2024-04-10T14:59:38.019051Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.77"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.77.jar`
- `target/lib/*.jar`
