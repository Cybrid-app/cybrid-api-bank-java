...
- Build date: 2024-11-04T21:55:25.943158Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.27.jar`
- `target/lib/*.jar`
