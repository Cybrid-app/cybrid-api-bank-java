...
- Build date: 2024-01-23T16:13:44.728378Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.89"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.89.jar`
- `target/lib/*.jar`
