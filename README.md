...
- Build date: 2024-08-21T16:10:17.930066Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.38.jar`
- `target/lib/*.jar`
