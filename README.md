...
- Build date: 2025-04-24T21:51:50.826518Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.423"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.423.jar`
- `target/lib/*.jar`
