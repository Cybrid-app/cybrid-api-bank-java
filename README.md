...
- Build date: 2024-11-20T19:36:33.852474Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.12.jar`
- `target/lib/*.jar`
