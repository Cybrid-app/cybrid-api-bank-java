...
- Build date: 2024-12-20T13:52:23.924626Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.100"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.100.jar`
- `target/lib/*.jar`
