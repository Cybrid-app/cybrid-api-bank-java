...
- Build date: 2024-12-03T16:21:27.897505Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.49"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.49.jar`
- `target/lib/*.jar`
