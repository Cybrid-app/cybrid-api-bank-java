...
- Build date: 2024-11-01T01:06:23.536487Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.17.jar`
- `target/lib/*.jar`
