...
- Build date: 2023-08-24T16:59:07.606189Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.88.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.88.0.jar`
- `target/lib/*.jar`
