...
- Build date: 2023-10-25T13:02:10.793209Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.16.jar`
- `target/lib/*.jar`
