...
- Build date: 2024-09-20T15:07:24.703527Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.124"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.124.jar`
- `target/lib/*.jar`
