...
- Build date: 2025-04-29T17:23:01.790350Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.436"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.436.jar`
- `target/lib/*.jar`
