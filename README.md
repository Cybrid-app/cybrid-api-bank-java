...
- Build date: 2024-09-12T15:07:55.367687Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.87"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.87.jar`
- `target/lib/*.jar`
