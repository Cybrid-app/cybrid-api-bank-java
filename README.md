...
- Build date: 2024-05-21T18:49:10.128981Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.1.jar`
- `target/lib/*.jar`
