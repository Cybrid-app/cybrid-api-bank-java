...
- Build date: 2023-04-13T15:25:51.751725Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.42"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.42.jar`
- `target/lib/*.jar`
