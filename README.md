...
- Build date: 2024-10-04T19:02:56.395105Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.2.jar`
- `target/lib/*.jar`
