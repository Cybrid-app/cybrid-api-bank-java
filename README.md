...
- Build date: 2025-03-14T12:56:03.948426Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.296"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.296.jar`
- `target/lib/*.jar`
