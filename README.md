...
- Build date: 2024-01-29T13:48:26.445235Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.105"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.105.jar`
- `target/lib/*.jar`
