...
- Build date: 2022-05-31T10:30:44.149514Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.16.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.16.2.jar`
- `target/lib/*.jar`
