...
- Build date: 2024-01-11T03:06:50.178825Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.60"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.60.jar`
- `target/lib/*.jar`
