...
- Build date: 2023-05-17T15:01:17.397041Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.25.jar`
- `target/lib/*.jar`
