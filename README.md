...
- Build date: 2024-07-30T13:36:58.579151Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.109"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.109.jar`
- `target/lib/*.jar`
