...
- Build date: 2025-04-03T12:26:46.425845Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.354"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.354.jar`
- `target/lib/*.jar`
