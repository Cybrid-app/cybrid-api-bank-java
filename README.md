...
- Build date: 2024-02-02T17:28:28.382124Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.118"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.118.jar`
- `target/lib/*.jar`
