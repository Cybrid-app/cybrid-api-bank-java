...
- Build date: 2022-06-06T17:13:06.189855Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.17.jar`
- `target/lib/*.jar`
