...
- Build date: 2024-10-11T14:12:06.537118Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.19.jar`
- `target/lib/*.jar`
