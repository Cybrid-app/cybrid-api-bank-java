...
- Build date: 2025-04-10T20:45:15.651956Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.377"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.377.jar`
- `target/lib/*.jar`
