...
- Build date: 2025-05-08T18:42:20.292688Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.465"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.465.jar`
- `target/lib/*.jar`
