...
- Build date: 2025-05-26T14:23:56.992381Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.523"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.523.jar`
- `target/lib/*.jar`
