...
- Build date: 2024-12-12T18:53:26.334228Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.81"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.81.jar`
- `target/lib/*.jar`
