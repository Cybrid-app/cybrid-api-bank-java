...
- Build date: 2025-06-13T19:09:34.042424Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.584"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.584.jar`
- `target/lib/*.jar`
