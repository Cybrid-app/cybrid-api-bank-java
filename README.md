...
- Build date: 2023-10-26T14:52:18.550551Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.20"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.20.jar`
- `target/lib/*.jar`
