...
- Build date: 2025-06-13T18:15:05.976733Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.583"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.583.jar`
- `target/lib/*.jar`
