...
- Build date: 2023-06-27T15:14:00.081113Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.15.jar`
- `target/lib/*.jar`
