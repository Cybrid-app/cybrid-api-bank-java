...
- Build date: 2024-08-02T17:18:56.369144Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.119"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.119.jar`
- `target/lib/*.jar`
