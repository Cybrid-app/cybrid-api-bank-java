...
- Build date: 2023-06-30T11:53:14.350211Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.25.jar`
- `target/lib/*.jar`
