...
- Build date: 2023-09-05T18:08:28.186417Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.2.jar`
- `target/lib/*.jar`
