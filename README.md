...
- Build date: 2025-02-05T13:21:16.049349Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.207"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.207.jar`
- `target/lib/*.jar`
