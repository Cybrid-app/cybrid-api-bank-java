...
- Build date: 2023-09-13T11:21:07.902006Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.4.jar`
- `target/lib/*.jar`
