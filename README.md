...
- Build date: 2023-11-16T19:32:46.320324Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.5.jar`
- `target/lib/*.jar`
