...
- Build date: 2025-06-10T13:37:49.530530Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.568"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.568.jar`
- `target/lib/*.jar`
