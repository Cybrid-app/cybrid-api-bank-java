...
- Build date: 2023-05-24T12:10:34.914721Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.37"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.37.jar`
- `target/lib/*.jar`
