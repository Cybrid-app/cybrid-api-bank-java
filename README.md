...
- Build date: 2025-05-16T01:29:31.758818Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.490"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.490.jar`
- `target/lib/*.jar`
