...
- Build date: 2024-11-18T16:03:59.580910Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.2.jar`
- `target/lib/*.jar`
