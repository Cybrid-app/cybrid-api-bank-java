...
- Build date: 2024-05-13T21:32:04.049131Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.152"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.152.jar`
- `target/lib/*.jar`
