...
- Build date: 2023-08-04T15:51:45.726470Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.82.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.82.3.jar`
- `target/lib/*.jar`
