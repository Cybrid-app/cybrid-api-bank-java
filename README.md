...
- Build date: 2023-09-07T11:59:35.253943Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.10.jar`
- `target/lib/*.jar`
