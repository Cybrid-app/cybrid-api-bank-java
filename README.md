...
- Build date: 2025-06-19T16:14:18.906116Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.607"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.607.jar`
- `target/lib/*.jar`
