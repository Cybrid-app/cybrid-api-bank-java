...
- Build date: 2024-10-16T16:45:25.513229Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.11.jar`
- `target/lib/*.jar`
