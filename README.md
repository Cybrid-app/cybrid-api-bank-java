...
- Build date: 2024-09-20T02:31:34.505541Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.121"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.121.jar`
- `target/lib/*.jar`
