...
- Build date: 2024-05-09T20:02:13.967347Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.145"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.145.jar`
- `target/lib/*.jar`
