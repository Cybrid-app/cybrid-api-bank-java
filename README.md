...
- Build date: 2024-01-05T15:34:52.656076Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.51"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.51.jar`
- `target/lib/*.jar`
