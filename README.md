...
- Build date: 2022-05-26T14:18:54.377670Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.14.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.14.19.jar`
- `target/lib/*.jar`
