...
- Build date: 2024-03-23T04:01:48.464899Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.32.jar`
- `target/lib/*.jar`
