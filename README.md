...
- Build date: 2022-06-03T19:20:11.771860Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.6.jar`
- `target/lib/*.jar`
