...
- Build date: 2025-05-14T21:34:06.167465Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.481"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.481.jar`
- `target/lib/*.jar`
