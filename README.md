...
- Build date: 2024-10-01T22:03:10.914978Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.159"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.159.jar`
- `target/lib/*.jar`
