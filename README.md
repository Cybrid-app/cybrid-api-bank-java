...
- Build date: 2023-05-30T13:12:54.518911Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.58"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.58.jar`
- `target/lib/*.jar`
