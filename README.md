...
- Build date: 2023-11-24T13:17:39.830149Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.26.jar`
- `target/lib/*.jar`
