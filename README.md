...
- Build date: 2024-05-02T14:33:19.499120Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.132"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.132.jar`
- `target/lib/*.jar`
