...
- Build date: 2025-03-18T14:21:50.953040Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.305"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.305.jar`
- `target/lib/*.jar`
