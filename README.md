...
- Build date: 2024-11-05T19:08:31.667226Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.32.jar`
- `target/lib/*.jar`
