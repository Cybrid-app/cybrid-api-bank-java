...
- Build date: 2023-10-23T14:44:07.243938Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.9.jar`
- `target/lib/*.jar`
