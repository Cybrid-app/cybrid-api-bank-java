...
- Build date: 2024-11-06T18:09:34.634307Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.34.jar`
- `target/lib/*.jar`
