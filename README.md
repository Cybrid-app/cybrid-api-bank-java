...
- Build date: 2024-07-08T21:10:49.601322Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.71"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.71.jar`
- `target/lib/*.jar`
