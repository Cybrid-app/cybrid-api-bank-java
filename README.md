...
- Build date: 2023-12-11T19:45:21.425339Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.30.jar`
- `target/lib/*.jar`
