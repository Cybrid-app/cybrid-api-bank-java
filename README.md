...
- Build date: 2022-06-06T22:14:41.863586Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.19.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.19.1.jar`
- `target/lib/*.jar`
