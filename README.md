...
- Build date: 2022-05-30T13:58:05.118729Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.15.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.15.10.jar`
- `target/lib/*.jar`
