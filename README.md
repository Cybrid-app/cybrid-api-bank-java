...
- Build date: 2024-09-19T20:21:06.040745Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.119"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.119.jar`
- `target/lib/*.jar`
