...
- Build date: 2023-08-19T13:32:23.779597Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.85.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.85.3.jar`
- `target/lib/*.jar`
