...
- Build date: 2024-08-05T15:40:38.453988Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.2.jar`
- `target/lib/*.jar`
