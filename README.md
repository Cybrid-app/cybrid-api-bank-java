...
- Build date: 2023-04-24T19:02:42.992839Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.61"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.61.jar`
- `target/lib/*.jar`
