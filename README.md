...
- Build date: 2023-09-12T18:40:26.780865Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.1.jar`
- `target/lib/*.jar`
