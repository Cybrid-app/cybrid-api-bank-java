...
- Build date: 2023-05-22T15:59:43.364714Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.30.jar`
- `target/lib/*.jar`
