...
- Build date: 2024-03-22T12:32:25.065130Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.25.jar`
- `target/lib/*.jar`
