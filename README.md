...
- Build date: 2025-02-28T15:04:18.135071Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.265"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.265.jar`
- `target/lib/*.jar`
