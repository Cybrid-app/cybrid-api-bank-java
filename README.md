...
- Build date: 2024-02-29T17:35:57.249771Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.26.jar`
- `target/lib/*.jar`
