...
- Build date: 2024-08-14T13:11:28.030302Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.18.jar`
- `target/lib/*.jar`
