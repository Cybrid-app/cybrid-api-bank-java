...
- Build date: 2024-03-27T17:53:15.389289Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.44"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.44.jar`
- `target/lib/*.jar`
