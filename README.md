...
- Build date: 2023-12-14T16:47:35.530480Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.5.jar`
- `target/lib/*.jar`
