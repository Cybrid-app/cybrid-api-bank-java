...
- Build date: 2024-01-18T15:11:57.629884Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.70"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.70.jar`
- `target/lib/*.jar`
