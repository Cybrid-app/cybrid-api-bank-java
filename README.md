...
- Build date: 2025-04-16T10:50:05.256203Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.395"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.395.jar`
- `target/lib/*.jar`
