...
- Build date: 2023-12-22T14:56:26.674171Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.38.jar`
- `target/lib/*.jar`
