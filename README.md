...
- Build date: 2024-03-20T00:35:23.334474Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.20"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.20.jar`
- `target/lib/*.jar`
