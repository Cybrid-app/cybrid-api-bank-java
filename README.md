...
- Build date: 2025-04-30T21:23:22.876854Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.441"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.441.jar`
- `target/lib/*.jar`
