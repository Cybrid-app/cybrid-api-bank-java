...
- Build date: 2023-11-03T14:41:56.324085Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.35"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.35.jar`
- `target/lib/*.jar`
