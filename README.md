...
- Build date: 2024-10-24T21:40:38.997025Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.43"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.43.jar`
- `target/lib/*.jar`
