...
- Build date: 2023-11-23T17:57:46.797082Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.24.jar`
- `target/lib/*.jar`
