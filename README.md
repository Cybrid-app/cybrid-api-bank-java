...
- Build date: 2023-11-16T16:45:03.297749Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.4.jar`
- `target/lib/*.jar`
