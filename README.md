...
- Build date: 2023-07-24T12:16:40.525437Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.15.jar`
- `target/lib/*.jar`
