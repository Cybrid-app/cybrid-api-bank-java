...
- Build date: 2022-05-09T13:01:15.849896Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.6.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.6.6.jar`
- `target/lib/*.jar`
