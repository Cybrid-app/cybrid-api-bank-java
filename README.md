...
- Build date: 2023-10-05T21:55:56.825171Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.96.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.96.0.jar`
- `target/lib/*.jar`
