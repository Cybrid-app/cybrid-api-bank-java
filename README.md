...
- Build date: 2025-01-16T13:39:06.580076Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.147"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.147.jar`
- `target/lib/*.jar`
