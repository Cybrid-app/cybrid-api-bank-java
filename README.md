...
- Build date: 2025-05-29T13:11:30.860459Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.534"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.534.jar`
- `target/lib/*.jar`
