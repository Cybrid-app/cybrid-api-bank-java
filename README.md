...
- Build date: 2025-04-17T18:34:32.326251Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.405"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.405.jar`
- `target/lib/*.jar`
