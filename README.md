...
- Build date: 2023-08-15T15:43:23.645879Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.5.jar`
- `target/lib/*.jar`
