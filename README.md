...
- Build date: 2024-08-16T00:46:13.488262Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.27.jar`
- `target/lib/*.jar`
