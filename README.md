...
- Build date: 2024-09-18T14:57:27.849830Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.111"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.111.jar`
- `target/lib/*.jar`
