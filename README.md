...
- Build date: 2025-06-09T13:17:35.084795Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.560"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.560.jar`
- `target/lib/*.jar`
