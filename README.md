...
- Build date: 2024-04-29T14:53:24.048416Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.127"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.127.jar`
- `target/lib/*.jar`
