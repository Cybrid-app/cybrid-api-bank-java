...
- Build date: 2023-06-05T15:12:28.154511Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.68"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.68.jar`
- `target/lib/*.jar`
