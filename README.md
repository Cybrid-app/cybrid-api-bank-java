...
- Build date: 2025-06-16T20:44:39.740297Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.596"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.596.jar`
- `target/lib/*.jar`
