...
- Build date: 2024-09-09T19:04:41.008856Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.77"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.77.jar`
- `target/lib/*.jar`
