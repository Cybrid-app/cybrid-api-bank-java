...
- Build date: 2025-04-29T14:34:37.512796Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.434"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.434.jar`
- `target/lib/*.jar`
