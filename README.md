...
- Build date: 2024-10-02T20:45:45.499522Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.164"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.164.jar`
- `target/lib/*.jar`
