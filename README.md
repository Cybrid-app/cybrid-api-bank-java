...
- Build date: 2025-05-15T00:10:14.076679Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.482"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.482.jar`
- `target/lib/*.jar`
