...
- Build date: 2025-04-15T14:29:01.586514Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.388"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.388.jar`
- `target/lib/*.jar`
