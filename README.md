...
- Build date: 2025-03-23T13:37:37.288858Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.318"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.318.jar`
- `target/lib/*.jar`
