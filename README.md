...
- Build date: 2024-09-17T20:41:36.300800Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.107"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.107.jar`
- `target/lib/*.jar`
