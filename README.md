...
- Build date: 2025-02-12T14:05:15.095609Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.227"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.227.jar`
- `target/lib/*.jar`
