...
- Build date: 2023-07-04T17:20:26.541401Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.75.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.75.2.jar`
- `target/lib/*.jar`
