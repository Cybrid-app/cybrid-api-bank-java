...
- Build date: 2024-11-14T18:30:50.560759Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.69"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.69.jar`
- `target/lib/*.jar`
