...
- Build date: 2024-10-25T16:20:31.138462Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.46"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.46.jar`
- `target/lib/*.jar`
