...
- Build date: 2024-12-27T21:46:38.635497Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.110"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.110.jar`
- `target/lib/*.jar`
