...
- Build date: 2023-05-02T19:00:39.649775Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.80"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.80.jar`
- `target/lib/*.jar`
