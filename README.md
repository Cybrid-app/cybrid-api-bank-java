...
- Build date: 2022-06-06T10:25:01.061503Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.11.jar`
- `target/lib/*.jar`
