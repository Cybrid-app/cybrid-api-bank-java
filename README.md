...
- Build date: 2022-05-24T13:26:11.536711Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.14.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.14.5.jar`
- `target/lib/*.jar`
