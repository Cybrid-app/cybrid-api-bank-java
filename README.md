...
- Build date: 2024-04-12T13:31:53.455418Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.88"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.88.jar`
- `target/lib/*.jar`
