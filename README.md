...
- Build date: 2023-10-16T12:33:56.555132Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.106.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.106.4.jar`
- `target/lib/*.jar`
