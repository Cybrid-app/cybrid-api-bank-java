...
- Build date: 2023-07-18T20:05:10.419548Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.21.jar`
- `target/lib/*.jar`
