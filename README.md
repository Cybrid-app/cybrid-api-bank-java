...
- Build date: 2025-04-25T20:45:27.983207Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.430"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.430.jar`
- `target/lib/*.jar`
