...
- Build date: 2025-02-24T21:20:13.778565Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.251"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.251.jar`
- `target/lib/*.jar`
