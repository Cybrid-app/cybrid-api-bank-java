...
- Build date: 2023-11-29T12:48:24.108931Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.7.jar`
- `target/lib/*.jar`
