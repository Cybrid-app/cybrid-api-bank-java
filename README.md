...
- Build date: 2023-08-03T15:06:00.373761Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.28.jar`
- `target/lib/*.jar`
