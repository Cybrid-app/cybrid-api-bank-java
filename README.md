...
- Build date: 2025-02-26T18:05:39.911774Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.261"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.261.jar`
- `target/lib/*.jar`
