...
- Build date: 2023-11-15T20:29:47.606277Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.1.jar`
- `target/lib/*.jar`
