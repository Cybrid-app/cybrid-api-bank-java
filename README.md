...
- Build date: 2023-06-01T16:15:09.860598Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.63"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.63.jar`
- `target/lib/*.jar`
