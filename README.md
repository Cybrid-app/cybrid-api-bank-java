...
- Build date: 2024-07-25T18:51:54.450238Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.97"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.97.jar`
- `target/lib/*.jar`
