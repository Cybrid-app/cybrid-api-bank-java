...
- Build date: 2023-11-29T14:46:37.261660Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.9.jar`
- `target/lib/*.jar`
