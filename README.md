...
- Build date: 2025-04-23T15:46:33.085759Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.416"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.416.jar`
- `target/lib/*.jar`
