...
- Build date: 2024-10-01T18:35:01.991369Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.158"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.158.jar`
- `target/lib/*.jar`
