...
- Build date: 2025-04-15T17:04:07.764343Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.390"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.390.jar`
- `target/lib/*.jar`
