...
- Build date: 2023-08-01T00:54:47.463300Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.14"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.14.jar`
- `target/lib/*.jar`
