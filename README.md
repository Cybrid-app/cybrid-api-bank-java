...
- Build date: 2025-02-10T15:27:10.160639Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.222"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.222.jar`
- `target/lib/*.jar`
