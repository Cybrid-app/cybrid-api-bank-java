...
- Build date: 2024-08-14T20:34:34.472495Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.22.jar`
- `target/lib/*.jar`
