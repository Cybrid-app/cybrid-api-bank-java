...
- Build date: 2024-09-21T22:21:18.165464Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.130"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.130.jar`
- `target/lib/*.jar`
