...
- Build date: 2023-09-14T16:59:34.615571Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.7.jar`
- `target/lib/*.jar`
