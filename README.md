...
- Build date: 2024-02-23T17:16:39.405519Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.15.jar`
- `target/lib/*.jar`
