...
- Build date: 2023-05-12T14:37:35.794231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.19.jar`
- `target/lib/*.jar`
