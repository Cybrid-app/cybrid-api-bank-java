...
- Build date: 2023-04-28T19:21:23.896927Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.72"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.72.jar`
- `target/lib/*.jar`
