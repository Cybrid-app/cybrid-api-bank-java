...
- Build date: 2023-08-29T12:59:32.057444Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.89.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.89.4.jar`
- `target/lib/*.jar`
