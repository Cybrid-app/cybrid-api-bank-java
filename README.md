...
- Build date: 2024-01-30T21:21:10.965167Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.109"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.109.jar`
- `target/lib/*.jar`
