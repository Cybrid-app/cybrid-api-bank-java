...
- Build date: 2025-06-19T12:34:24.991856Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.603"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.603.jar`
- `target/lib/*.jar`
