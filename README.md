...
- Build date: 2024-12-19T12:19:36.875743Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.97"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.97.jar`
- `target/lib/*.jar`
