...
- Build date: 2025-05-20T17:50:53.780544Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.500"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.500.jar`
- `target/lib/*.jar`
