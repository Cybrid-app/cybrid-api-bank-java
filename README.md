...
- Build date: 2025-06-16T18:56:28.720393Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.594"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.594.jar`
- `target/lib/*.jar`
