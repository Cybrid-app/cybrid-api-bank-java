...
- Build date: 2023-08-01T16:51:47.418674Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.17.jar`
- `target/lib/*.jar`
