...
- Build date: 2024-11-14T16:52:50.409097Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.67"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.67.jar`
- `target/lib/*.jar`
