...
- Build date: 2023-10-17T21:46:34.378825Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.108.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.108.0.jar`
- `target/lib/*.jar`
