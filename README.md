...
- Build date: 2024-07-03T15:39:45.131205Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.61"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.61.jar`
- `target/lib/*.jar`
