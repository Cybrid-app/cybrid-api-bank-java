...
- Build date: 2023-08-31T16:20:41.334399Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.90.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.90.2.jar`
- `target/lib/*.jar`
