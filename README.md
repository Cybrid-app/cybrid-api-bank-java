...
- Build date: 2023-05-02T15:45:33.737694Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.77"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.77.jar`
- `target/lib/*.jar`
