...
- Build date: 2025-06-20T16:33:02.228520Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.617"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.617.jar`
- `target/lib/*.jar`
