...
- Build date: 2023-07-04T20:16:23.793628Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.75.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.75.4.jar`
- `target/lib/*.jar`
