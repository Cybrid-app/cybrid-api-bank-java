...
- Build date: 2024-04-12T19:47:44.916654Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.91"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.91.jar`
- `target/lib/*.jar`
