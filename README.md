...
- Build date: 2024-05-10T22:58:43.808307Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.149"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.149.jar`
- `target/lib/*.jar`
