...
- Build date: 2025-04-08T15:57:02.564855Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.367"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.367.jar`
- `target/lib/*.jar`
