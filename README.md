...
- Build date: 2022-06-03T19:47:01.571819Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.7.jar`
- `target/lib/*.jar`
