...
- Build date: 2024-10-18T14:41:08.495664Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.21.jar`
- `target/lib/*.jar`
