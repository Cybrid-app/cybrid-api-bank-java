...
- Build date: 2024-08-04T14:27:49.589519Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.125"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.125.jar`
- `target/lib/*.jar`
