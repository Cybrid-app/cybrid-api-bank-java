...
- Build date: 2025-02-24T15:07:11.449485Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.248"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.248.jar`
- `target/lib/*.jar`
