...
- Build date: 2025-04-08T12:05:21.962415Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.364"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.364.jar`
- `target/lib/*.jar`
