...
- Build date: 2023-10-11T14:45:26.164636Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.100.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.100.0.jar`
- `target/lib/*.jar`
