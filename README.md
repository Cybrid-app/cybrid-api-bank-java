...
- Build date: 2022-05-26T10:46:50.475781Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.14.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.14.16.jar`
- `target/lib/*.jar`
