...
- Build date: 2024-10-17T14:01:42.944445Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.16.jar`
- `target/lib/*.jar`
