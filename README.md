...
- Build date: 2024-10-03T20:21:57.817264Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.168"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.168.jar`
- `target/lib/*.jar`
