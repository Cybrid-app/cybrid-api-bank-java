...
- Build date: 2025-06-02T19:27:37.150522Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.544"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.544.jar`
- `target/lib/*.jar`
