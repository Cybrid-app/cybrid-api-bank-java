...
- Build date: 2024-09-16T19:58:13.680774Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.101"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.101.jar`
- `target/lib/*.jar`
