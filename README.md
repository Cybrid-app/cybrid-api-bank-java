...
- Build date: 2025-06-16T18:03:31.183708Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.593"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.593.jar`
- `target/lib/*.jar`
