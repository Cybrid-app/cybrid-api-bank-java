...
- Build date: 2025-05-20T21:36:41.439233Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.504"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.504.jar`
- `target/lib/*.jar`
