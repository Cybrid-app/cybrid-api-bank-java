...
- Build date: 2023-12-04T18:04:55.330208Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.2.jar`
- `target/lib/*.jar`
