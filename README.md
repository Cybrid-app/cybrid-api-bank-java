...
- Build date: 2025-01-14T23:24:51.745424Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.143"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.143.jar`
- `target/lib/*.jar`
