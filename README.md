...
- Build date: 2023-10-26T18:18:31.025421Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.22.jar`
- `target/lib/*.jar`
