...
- Build date: 2023-07-21T14:00:25.944009Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.13.jar`
- `target/lib/*.jar`
