...
- Build date: 2025-06-02T10:31:43.746176Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.539"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.539.jar`
- `target/lib/*.jar`
