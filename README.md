...
- Build date: 2023-10-03T16:01:19.002276Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.55"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.55.jar`
- `target/lib/*.jar`
