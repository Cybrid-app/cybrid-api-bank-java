...
- Build date: 2024-07-04T15:59:42.263742Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.64"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.64.jar`
- `target/lib/*.jar`
