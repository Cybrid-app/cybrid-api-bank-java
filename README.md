...
- Build date: 2023-05-08T16:56:34.184184Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.70.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.70.0.jar`
- `target/lib/*.jar`
