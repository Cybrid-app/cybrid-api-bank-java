...
- Build date: 2023-09-12T00:49:50.110321Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.93.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.93.2.jar`
- `target/lib/*.jar`
