...
- Build date: 2024-05-22T15:22:17.492692Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.5.jar`
- `target/lib/*.jar`
