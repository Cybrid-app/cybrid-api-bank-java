...
- Build date: 2024-05-22T21:36:15.365392Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.7.jar`
- `target/lib/*.jar`
