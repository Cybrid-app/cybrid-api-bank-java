...
- Build date: 2023-08-11T00:31:49.193691Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.11.jar`
- `target/lib/*.jar`
