...
- Build date: 2025-06-03T13:35:44.564421Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.546"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.546.jar`
- `target/lib/*.jar`
