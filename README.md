...
- Build date: 2024-10-04T10:30:22.904253Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.169"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.169.jar`
- `target/lib/*.jar`
