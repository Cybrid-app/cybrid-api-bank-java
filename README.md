...
- Build date: 2024-02-09T20:37:23.661681Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.134"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.134.jar`
- `target/lib/*.jar`
