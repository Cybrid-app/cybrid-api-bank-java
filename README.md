...
- Build date: 2025-05-21T20:28:31.050474Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.511"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.511.jar`
- `target/lib/*.jar`
