...
- Build date: 2024-12-30T18:27:49.643706Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.112"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.112.jar`
- `target/lib/*.jar`
