...
- Build date: 2023-08-22T21:38:27.643805Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.86.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.86.2.jar`
- `target/lib/*.jar`
