...
- Build date: 2025-06-19T17:08:47.374025Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.608"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.608.jar`
- `target/lib/*.jar`
