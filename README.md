...
- Build date: 2025-05-06T19:21:11.343332Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.457"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.457.jar`
- `target/lib/*.jar`
