...
- Build date: 2024-04-11T20:52:40.127624Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.87"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.87.jar`
- `target/lib/*.jar`
