...
- Build date: 2023-09-07T00:15:20.388863Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.8.jar`
- `target/lib/*.jar`
