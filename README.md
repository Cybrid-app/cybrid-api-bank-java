...
- Build date: 2023-09-04T11:15:02.913756Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.90.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.90.8.jar`
- `target/lib/*.jar`
