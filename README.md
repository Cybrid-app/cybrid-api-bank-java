...
- Build date: 2025-02-18T15:37:50.566385Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.235"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.235.jar`
- `target/lib/*.jar`
