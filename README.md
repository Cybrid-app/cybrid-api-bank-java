...
- Build date: 2023-11-07T13:06:34.424611Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.39.jar`
- `target/lib/*.jar`
