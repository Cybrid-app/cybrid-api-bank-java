...
- Build date: 2024-04-19T14:23:53.013933Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.109"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.109.jar`
- `target/lib/*.jar`
