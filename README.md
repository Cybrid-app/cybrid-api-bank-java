...
- Build date: 2023-11-02T23:50:19.705949Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.33"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.33.jar`
- `target/lib/*.jar`
