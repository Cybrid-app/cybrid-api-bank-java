...
- Build date: 2024-12-09T21:45:29.243630Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.68"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.68.jar`
- `target/lib/*.jar`
