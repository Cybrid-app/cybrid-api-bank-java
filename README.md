...
- Build date: 2023-12-12T14:00:25.877730Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.34.jar`
- `target/lib/*.jar`
