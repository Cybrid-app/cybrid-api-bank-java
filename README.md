...
- Build date: 2024-02-09T18:04:59.282022Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.133"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.133.jar`
- `target/lib/*.jar`
