...
- Build date: 2023-09-15T15:53:08.491507Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.10.jar`
- `target/lib/*.jar`
