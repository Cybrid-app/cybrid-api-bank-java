...
- Build date: 2024-08-27T14:41:05.206080Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.46"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.46.jar`
- `target/lib/*.jar`
