...
- Build date: 2024-08-07T00:15:21.037434Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.6.jar`
- `target/lib/*.jar`
