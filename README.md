...
- Build date: 2025-04-10T12:13:16.453444Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.374"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.374.jar`
- `target/lib/*.jar`
