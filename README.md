...
- Build date: 2023-12-01T03:11:27.652735Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.18.jar`
- `target/lib/*.jar`
