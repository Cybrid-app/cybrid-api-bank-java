...
- Build date: 2024-01-29T22:48:45.954049Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.106"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.106.jar`
- `target/lib/*.jar`
