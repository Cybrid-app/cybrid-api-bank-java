...
- Build date: 2024-01-10T02:19:57.903303Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.58"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.58.jar`
- `target/lib/*.jar`
