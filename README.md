...
- Build date: 2023-08-09T15:55:11.880031Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.0.jar`
- `target/lib/*.jar`
