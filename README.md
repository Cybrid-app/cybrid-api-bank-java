...
- Build date: 2025-06-30T15:22:52.716328Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.652"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.652.jar`
- `target/lib/*.jar`
