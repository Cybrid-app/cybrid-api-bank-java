...
- Build date: 2025-05-28T14:57:17.791914Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.532"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.532.jar`
- `target/lib/*.jar`
