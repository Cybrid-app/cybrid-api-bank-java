...
- Build date: 2024-08-29T00:38:36.106973Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.53"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.53.jar`
- `target/lib/*.jar`
