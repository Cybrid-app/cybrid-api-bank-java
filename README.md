...
- Build date: 2022-05-10T11:43:30.431653Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.6.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.6.11.jar`
- `target/lib/*.jar`
