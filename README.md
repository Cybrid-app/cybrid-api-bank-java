...
- Build date: 2023-12-11T14:05:38.327557Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.26.jar`
- `target/lib/*.jar`
