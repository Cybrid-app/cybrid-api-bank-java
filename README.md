...
- Build date: 2023-09-18T12:33:22.220030Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.15.jar`
- `target/lib/*.jar`
