...
- Build date: 2023-11-14T20:28:06.548170Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.59"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.59.jar`
- `target/lib/*.jar`
