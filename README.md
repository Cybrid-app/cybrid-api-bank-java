...
- Build date: 2023-07-05T11:57:49.732883Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.75.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.75.5.jar`
- `target/lib/*.jar`
