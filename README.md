...
- Build date: 2024-01-05T16:42:38.666229Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.52"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.52.jar`
- `target/lib/*.jar`
