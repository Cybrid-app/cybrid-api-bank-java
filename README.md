...
- Build date: 2025-02-06T16:05:49.524445Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.215"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.215.jar`
- `target/lib/*.jar`
