...
- Build date: 2025-02-18T16:58:19.655546Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.237"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.237.jar`
- `target/lib/*.jar`
