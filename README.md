...
- Build date: 2023-04-18T17:13:53.538590Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.55"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.55.jar`
- `target/lib/*.jar`
