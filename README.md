...
- Build date: 2024-10-23T18:14:37.948622Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.39.jar`
- `target/lib/*.jar`
