...
- Build date: 2024-07-31T17:09:06.193631Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.114"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.114.jar`
- `target/lib/*.jar`
