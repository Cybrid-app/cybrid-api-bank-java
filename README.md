...
- Build date: 2024-12-23T15:59:17.613465Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.103"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.103.jar`
- `target/lib/*.jar`
