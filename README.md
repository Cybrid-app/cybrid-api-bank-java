...
- Build date: 2025-05-22T17:59:10.574414Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.516"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.516.jar`
- `target/lib/*.jar`
