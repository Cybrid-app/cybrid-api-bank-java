...
- Build date: 2024-10-16T14:26:22.211402Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.9.jar`
- `target/lib/*.jar`
