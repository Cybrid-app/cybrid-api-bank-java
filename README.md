...
- Build date: 2024-01-26T15:35:54.075728Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.100"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.100.jar`
- `target/lib/*.jar`
