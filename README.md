...
- Build date: 2025-05-06T13:11:05.385422Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.452"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.452.jar`
- `target/lib/*.jar`
