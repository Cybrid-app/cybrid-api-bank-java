...
- Build date: 2024-12-05T14:39:44.333785Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.59"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.59.jar`
- `target/lib/*.jar`
