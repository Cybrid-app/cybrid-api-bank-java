...
- Build date: 2023-06-06T19:24:03.499904Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.69"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.69.jar`
- `target/lib/*.jar`
