...
- Build date: 2024-07-03T14:28:36.164646Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.60"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.60.jar`
- `target/lib/*.jar`
