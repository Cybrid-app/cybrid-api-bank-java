...
- Build date: 2023-08-11T17:57:09.611318Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.12.jar`
- `target/lib/*.jar`
