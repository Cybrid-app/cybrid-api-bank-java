...
- Build date: 2023-05-01T12:38:29.479037Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.73"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.73.jar`
- `target/lib/*.jar`
