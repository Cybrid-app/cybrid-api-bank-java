...
- Build date: 2023-09-21T13:23:47.965633Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.25.jar`
- `target/lib/*.jar`
