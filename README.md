...
- Build date: 2024-10-02T15:48:18.391630Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.162"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.162.jar`
- `target/lib/*.jar`
