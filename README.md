...
- Build date: 2024-05-06T16:49:12.402724Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.139"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.139.jar`
- `target/lib/*.jar`
