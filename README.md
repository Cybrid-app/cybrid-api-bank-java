...
- Build date: 2023-12-12T16:23:42.614948Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.36"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.36.jar`
- `target/lib/*.jar`
