...
- Build date: 2025-01-15T22:15:49.906042Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.144"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.144.jar`
- `target/lib/*.jar`
