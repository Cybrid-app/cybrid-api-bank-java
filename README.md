...
- Build date: 2024-05-22T13:58:10.171532Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.4.jar`
- `target/lib/*.jar`
