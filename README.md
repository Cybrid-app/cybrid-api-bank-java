...
- Build date: 2024-03-26T14:38:33.905785Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.39.jar`
- `target/lib/*.jar`
