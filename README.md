...
- Build date: 2023-10-03T22:38:31.336720Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.56"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.56.jar`
- `target/lib/*.jar`
