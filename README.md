...
- Build date: 2024-10-04T21:16:14.789060Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.4.jar`
- `target/lib/*.jar`
