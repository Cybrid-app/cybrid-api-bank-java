...
- Build date: 2023-09-26T22:27:24.065931Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.40"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.40.jar`
- `target/lib/*.jar`
