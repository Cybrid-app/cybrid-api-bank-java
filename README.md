...
- Build date: 2025-03-06T19:15:53.681727Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.278"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.278.jar`
- `target/lib/*.jar`
