...
- Build date: 2025-03-07T14:41:12.090177Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.282"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.282.jar`
- `target/lib/*.jar`
