...
- Build date: 2024-07-25T14:14:58.433945Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.93"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.93.jar`
- `target/lib/*.jar`
