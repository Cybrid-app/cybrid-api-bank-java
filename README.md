...
- Build date: 2024-08-15T21:39:21.594698Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.26.jar`
- `target/lib/*.jar`
