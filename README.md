...
- Build date: 2023-10-31T19:23:14.946856Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.30.jar`
- `target/lib/*.jar`
