...
- Build date: 2025-03-28T16:03:20.334349Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.338"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.338.jar`
- `target/lib/*.jar`
