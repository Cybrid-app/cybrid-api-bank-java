...
- Build date: 2024-04-30T12:57:50.934388Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.129"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.129.jar`
- `target/lib/*.jar`
