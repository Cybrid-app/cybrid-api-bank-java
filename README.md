...
- Build date: 2024-10-17T21:32:38.978710Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.18.jar`
- `target/lib/*.jar`
