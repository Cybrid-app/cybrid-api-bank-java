...
- Build date: 2025-03-17T22:16:20.513811Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.301"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.301.jar`
- `target/lib/*.jar`
