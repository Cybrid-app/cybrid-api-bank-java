...
- Build date: 2024-07-24T14:10:06.438453Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.91"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.91.jar`
- `target/lib/*.jar`
