...
- Build date: 2025-06-27T17:44:26.099529Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.649"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.649.jar`
- `target/lib/*.jar`
