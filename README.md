...
- Build date: 2024-11-16T20:06:41.633014Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.72"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.72.jar`
- `target/lib/*.jar`
