...
- Build date: 2025-04-02T18:22:45.419721Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.350"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.350.jar`
- `target/lib/*.jar`
