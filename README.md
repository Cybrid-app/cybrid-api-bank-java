...
- Build date: 2022-05-14T19:12:23.123051Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.8.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.8.12.jar`
- `target/lib/*.jar`
