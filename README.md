...
- Build date: 2023-12-19T18:01:08.113965Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.23"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.23.jar`
- `target/lib/*.jar`
