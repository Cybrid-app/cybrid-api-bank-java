...
- Build date: 2023-09-14T20:35:08.301407Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.8.jar`
- `target/lib/*.jar`
