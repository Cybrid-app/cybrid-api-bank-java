...
- Build date: 2025-05-16T13:51:07.887600Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.493"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.493.jar`
- `target/lib/*.jar`
