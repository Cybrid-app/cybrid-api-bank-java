...
- Build date: 2023-12-14T17:31:07.042437Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.6.jar`
- `target/lib/*.jar`
