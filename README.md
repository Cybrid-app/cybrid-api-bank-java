...
- Build date: 2024-08-13T20:52:06.610460Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.16.jar`
- `target/lib/*.jar`
