...
- Build date: 2023-12-09T17:57:32.653587Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.22.jar`
- `target/lib/*.jar`
