...
- Build date: 2023-05-24T17:46:22.440298Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.38.jar`
- `target/lib/*.jar`
