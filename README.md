...
- Build date: 2023-04-24T12:38:56.867212Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.60"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.60.jar`
- `target/lib/*.jar`
