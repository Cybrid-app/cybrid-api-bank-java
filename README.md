...
- Build date: 2023-08-18T20:00:17.296219Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.85.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.85.0.jar`
- `target/lib/*.jar`
