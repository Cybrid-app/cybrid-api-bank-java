...
- Build date: 2024-09-28T00:15:36.543548Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.149"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.149.jar`
- `target/lib/*.jar`
