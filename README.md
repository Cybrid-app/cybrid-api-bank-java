...
- Build date: 2023-08-30T12:40:39.830084Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.89.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.89.5.jar`
- `target/lib/*.jar`
