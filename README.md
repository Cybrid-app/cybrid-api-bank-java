...
- Build date: 2025-04-25T14:29:22.688832Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.426"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.426.jar`
- `target/lib/*.jar`
