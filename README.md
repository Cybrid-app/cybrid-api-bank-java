...
- Build date: 2024-04-08T00:39:31.418317Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.64"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.64.jar`
- `target/lib/*.jar`
