...
- Build date: 2023-06-06T19:59:11.830668Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.70"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.70.jar`
- `target/lib/*.jar`
