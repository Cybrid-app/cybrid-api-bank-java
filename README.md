...
- Build date: 2025-04-29T20:51:27.044018Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.438"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.438.jar`
- `target/lib/*.jar`
