...
- Build date: 2023-08-08T03:03:06.448264Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.82.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.82.5.jar`
- `target/lib/*.jar`
