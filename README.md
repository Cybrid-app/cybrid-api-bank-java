...
- Build date: 2023-12-08T15:45:51.057658Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.18.jar`
- `target/lib/*.jar`
