...
- Build date: 2024-09-25T13:49:44.555870Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.138"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.138.jar`
- `target/lib/*.jar`
