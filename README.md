...
- Build date: 2023-05-29T13:48:45.369316Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.56"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.56.jar`
- `target/lib/*.jar`
