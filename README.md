...
- Build date: 2025-04-14T10:44:31.827586Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.382"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.382.jar`
- `target/lib/*.jar`
