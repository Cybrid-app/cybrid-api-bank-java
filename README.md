...
- Build date: 2024-07-25T15:37:16.937670Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.94"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.94.jar`
- `target/lib/*.jar`
