...
- Build date: 2025-05-06T14:30:50.653594Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.453"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.453.jar`
- `target/lib/*.jar`
