...
- Build date: 2024-09-12T20:54:06.696788Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.93"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.93.jar`
- `target/lib/*.jar`
