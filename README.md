...
- Build date: 2023-05-18T13:21:51.199581Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.27.jar`
- `target/lib/*.jar`
