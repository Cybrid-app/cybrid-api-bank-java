...
- Build date: 2024-10-10T13:53:17.935373Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.17.jar`
- `target/lib/*.jar`
