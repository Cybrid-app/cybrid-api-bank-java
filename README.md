...
- Build date: 2025-05-29T15:31:38.888674Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.535"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.535.jar`
- `target/lib/*.jar`
