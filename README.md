...
- Build date: 2024-03-09T02:07:38.356797Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.4.jar`
- `target/lib/*.jar`
