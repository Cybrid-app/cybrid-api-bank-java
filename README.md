...
- Build date: 2025-03-13T18:14:54.991508Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.294"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.294.jar`
- `target/lib/*.jar`
