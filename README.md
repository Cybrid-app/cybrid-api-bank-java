...
- Build date: 2024-03-05T16:44:45.047480Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.39.jar`
- `target/lib/*.jar`
