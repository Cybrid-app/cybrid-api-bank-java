...
- Build date: 2025-05-27T15:39:31.672504Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.529"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.529.jar`
- `target/lib/*.jar`
