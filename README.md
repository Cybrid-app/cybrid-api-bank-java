...
- Build date: 2022-05-31T10:51:11.782678Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.16.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.16.3.jar`
- `target/lib/*.jar`
