...
- Build date: 2024-11-04T17:26:14.639862Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.25.jar`
- `target/lib/*.jar`
