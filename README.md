...
- Build date: 2025-04-03T18:09:28.961754Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.355"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.355.jar`
- `target/lib/*.jar`
