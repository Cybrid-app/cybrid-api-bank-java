...
- Build date: 2025-04-03T18:23:36.895640Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.356"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.356.jar`
- `target/lib/*.jar`
