...
- Build date: 2024-11-08T00:56:13.213309Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.41.jar`
- `target/lib/*.jar`
