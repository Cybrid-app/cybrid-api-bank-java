...
- Build date: 2024-03-25T17:45:57.763432Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.36"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.36.jar`
- `target/lib/*.jar`
