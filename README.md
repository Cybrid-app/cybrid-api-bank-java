...
- Build date: 2023-10-16T13:10:13.991047Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.106.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.106.5.jar`
- `target/lib/*.jar`
