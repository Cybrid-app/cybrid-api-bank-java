...
- Build date: 2023-10-19T13:27:34.572880Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.5.jar`
- `target/lib/*.jar`
