...
- Build date: 2023-12-08T13:45:00.479856Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.15.jar`
- `target/lib/*.jar`
