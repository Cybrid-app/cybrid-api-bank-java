...
- Build date: 2024-02-20T19:42:59.143390Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.3.jar`
- `target/lib/*.jar`
