...
- Build date: 2025-03-10T16:29:30.280278Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.288"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.288.jar`
- `target/lib/*.jar`
