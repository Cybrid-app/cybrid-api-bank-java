...
- Build date: 2023-11-20T15:51:27.087262Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.9.jar`
- `target/lib/*.jar`
