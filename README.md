...
- Build date: 2025-03-26T18:09:04.175210Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.329"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.329.jar`
- `target/lib/*.jar`
