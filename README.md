...
- Build date: 2025-06-26T17:59:10.973747Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.646"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.646.jar`
- `target/lib/*.jar`
