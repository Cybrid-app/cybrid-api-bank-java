...
- Build date: 2023-07-05T14:06:24.510729Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.76.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.76.1.jar`
- `target/lib/*.jar`
