...
- Build date: 2025-06-19T19:49:07.765376Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.611"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.611.jar`
- `target/lib/*.jar`
