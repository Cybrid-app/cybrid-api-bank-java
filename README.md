...
- Build date: 2023-10-11T16:30:51.770031Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.102.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.102.0.jar`
- `target/lib/*.jar`
