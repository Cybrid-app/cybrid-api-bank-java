...
- Build date: 2023-12-10T21:31:34.306165Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.24.jar`
- `target/lib/*.jar`
