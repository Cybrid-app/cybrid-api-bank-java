...
- Build date: 2024-11-08T19:53:35.407318Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.48"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.48.jar`
- `target/lib/*.jar`
