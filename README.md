...
- Build date: 2024-07-02T14:50:29.332814Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.55"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.55.jar`
- `target/lib/*.jar`
