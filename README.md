...
- Build date: 2024-08-13T15:25:17.705028Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.12.jar`
- `target/lib/*.jar`
