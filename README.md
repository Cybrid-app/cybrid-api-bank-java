...
- Build date: 2024-12-04T15:30:57.093251Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.52"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.52.jar`
- `target/lib/*.jar`
