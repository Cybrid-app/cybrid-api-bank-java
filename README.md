...
- Build date: 2025-03-31T16:57:08.089958Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.343"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.343.jar`
- `target/lib/*.jar`
