...
- Build date: 2023-09-18T10:52:35.661334Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.13.jar`
- `target/lib/*.jar`
