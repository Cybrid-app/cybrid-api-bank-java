...
- Build date: 2023-08-24T14:28:47.424367Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.87.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.87.1.jar`
- `target/lib/*.jar`
