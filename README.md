...
- Build date: 2022-06-07T16:12:45.563450Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.20.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.20.4.jar`
- `target/lib/*.jar`
