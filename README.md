...
- Build date: 2025-05-07T18:31:58.001878Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.460"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.460.jar`
- `target/lib/*.jar`
