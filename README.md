...
- Build date: 2022-05-04T10:32:02.013917Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.25.jar`
- `target/lib/*.jar`
