...
- Build date: 2024-08-01T18:17:40.810825Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.118"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.118.jar`
- `target/lib/*.jar`
