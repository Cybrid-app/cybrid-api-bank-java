...
- Build date: 2025-06-14T12:57:34.048717Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.588"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.588.jar`
- `target/lib/*.jar`
