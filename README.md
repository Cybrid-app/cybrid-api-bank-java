...
- Build date: 2025-04-23T22:53:47.031334Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.420"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.420.jar`
- `target/lib/*.jar`
