...
- Build date: 2025-03-24T16:20:24.804873Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.320"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.320.jar`
- `target/lib/*.jar`
