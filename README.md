...
- Build date: 2025-03-25T14:21:57.665600Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.324"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.324.jar`
- `target/lib/*.jar`
