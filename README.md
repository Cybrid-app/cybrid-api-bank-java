...
- Build date: 2024-10-25T13:47:34.701985Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.44"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.44.jar`
- `target/lib/*.jar`
