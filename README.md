...
- Build date: 2024-09-30T19:28:53.196825Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.155"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.155.jar`
- `target/lib/*.jar`
