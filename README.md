...
- Build date: 2024-03-01T19:05:40.221081Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.32.jar`
- `target/lib/*.jar`
