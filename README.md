...
- Build date: 2025-01-08T22:54:58.698274Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.129"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.129.jar`
- `target/lib/*.jar`
