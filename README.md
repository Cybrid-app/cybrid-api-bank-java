...
- Build date: 2024-07-31T13:23:44.176143Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.113"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.113.jar`
- `target/lib/*.jar`
