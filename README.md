...
- Build date: 2024-07-29T15:11:14.902005Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.107"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.107.jar`
- `target/lib/*.jar`
