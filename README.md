...
- Build date: 2024-05-31T18:19:21.042800Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.26.jar`
- `target/lib/*.jar`
