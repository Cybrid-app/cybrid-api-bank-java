...
- Build date: 2023-10-11T19:11:09.367354Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.103.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.103.1.jar`
- `target/lib/*.jar`
