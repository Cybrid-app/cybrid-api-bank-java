...
- Build date: 2024-12-12T21:28:37.144380Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.83"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.83.jar`
- `target/lib/*.jar`
