...
- Build date: 2024-12-04T19:06:01.302993Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.55"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.55.jar`
- `target/lib/*.jar`
