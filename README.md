...
- Build date: 2023-11-28T16:15:41.215408Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.3.jar`
- `target/lib/*.jar`
