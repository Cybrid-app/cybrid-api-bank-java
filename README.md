...
- Build date: 2025-05-16T14:31:58.903271Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.494"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.494.jar`
- `target/lib/*.jar`
