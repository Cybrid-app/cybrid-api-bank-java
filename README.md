...
- Build date: 2025-04-23T11:27:23.080552Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.414"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.414.jar`
- `target/lib/*.jar`
