...
- Build date: 2024-12-17T14:45:06.193679Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.93"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.93.jar`
- `target/lib/*.jar`
