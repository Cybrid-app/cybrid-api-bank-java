...
- Build date: 2023-08-01T17:17:38.319605Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.18.jar`
- `target/lib/*.jar`
