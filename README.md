...
- Build date: 2024-03-26T17:13:47.168588Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.40"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.40.jar`
- `target/lib/*.jar`
