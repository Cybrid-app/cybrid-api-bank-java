...
- Build date: 2025-04-09T13:00:49.261774Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.369"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.369.jar`
- `target/lib/*.jar`
