...
- Build date: 2023-10-13T14:51:45.748385Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.106.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.106.3.jar`
- `target/lib/*.jar`
