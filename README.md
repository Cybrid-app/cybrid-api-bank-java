...
- Build date: 2023-08-15T16:07:22.166389Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.6.jar`
- `target/lib/*.jar`
