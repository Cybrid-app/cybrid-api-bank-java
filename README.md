...
- Build date: 2024-07-30T15:37:00.569886Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.110"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.110.jar`
- `target/lib/*.jar`
