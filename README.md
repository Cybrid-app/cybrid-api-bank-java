...
- Build date: 2024-04-02T14:08:57.899058Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.55"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.55.jar`
- `target/lib/*.jar`
