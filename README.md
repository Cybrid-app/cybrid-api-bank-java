...
- Build date: 2023-12-28T13:25:18.928323Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.41.jar`
- `target/lib/*.jar`
