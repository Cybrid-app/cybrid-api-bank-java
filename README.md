...
- Build date: 2024-10-17T21:13:33.373779Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.17.jar`
- `target/lib/*.jar`
