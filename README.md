...
- Build date: 2023-10-31T17:18:33.279062Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.29.jar`
- `target/lib/*.jar`
