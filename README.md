...
- Build date: 2024-06-06T00:39:42.248696Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.5.jar`
- `target/lib/*.jar`
