...
- Build date: 2024-09-12T16:35:11.838834Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.88"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.88.jar`
- `target/lib/*.jar`
