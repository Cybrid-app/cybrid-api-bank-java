...
- Build date: 2024-08-13T17:06:18.238867Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.13.jar`
- `target/lib/*.jar`
