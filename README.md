...
- Build date: 2024-01-04T14:18:03.592690Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.47.jar`
- `target/lib/*.jar`
