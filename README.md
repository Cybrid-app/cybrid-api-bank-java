...
- Build date: 2025-02-25T20:02:01.785828Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.255"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.255.jar`
- `target/lib/*.jar`
