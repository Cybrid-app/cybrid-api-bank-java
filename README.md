...
- Build date: 2024-02-29T18:12:28.908059Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.27.jar`
- `target/lib/*.jar`
