...
- Build date: 2023-09-12T13:16:03.570075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.93.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.93.5.jar`
- `target/lib/*.jar`
