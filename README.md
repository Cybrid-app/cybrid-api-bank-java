...
- Build date: 2024-10-02T21:23:00.145386Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.165"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.165.jar`
- `target/lib/*.jar`
