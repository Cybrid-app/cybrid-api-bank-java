...
- Build date: 2025-06-19T17:58:02.105761Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.609"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.609.jar`
- `target/lib/*.jar`
