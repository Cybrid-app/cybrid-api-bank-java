...
- Build date: 2024-10-12T01:18:42.986580Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.1.jar`
- `target/lib/*.jar`
