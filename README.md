...
- Build date: 2023-10-26T14:25:19.824484Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.19.jar`
- `target/lib/*.jar`
