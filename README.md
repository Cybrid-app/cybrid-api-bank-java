...
- Build date: 2023-06-21T15:29:14.107571Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.37"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.37.jar`
- `target/lib/*.jar`
