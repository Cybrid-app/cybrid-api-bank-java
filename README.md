...
- Build date: 2023-07-04T16:59:20.357296Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.75.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.75.1.jar`
- `target/lib/*.jar`
