...
- Build date: 2024-10-02T17:02:43.265129Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.163"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.163.jar`
- `target/lib/*.jar`
