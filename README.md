...
- Build date: 2025-05-22T19:52:19.466430Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.518"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.518.jar`
- `target/lib/*.jar`
