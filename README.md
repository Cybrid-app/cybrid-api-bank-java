...
- Build date: 2024-10-18T13:33:39.913943Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.20"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.20.jar`
- `target/lib/*.jar`
