...
- Build date: 2023-04-26T21:50:38.621239Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.67"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.67.jar`
- `target/lib/*.jar`
