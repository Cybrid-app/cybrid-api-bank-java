...
- Build date: 2024-09-04T15:23:18.047873Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.64"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.64.jar`
- `target/lib/*.jar`
