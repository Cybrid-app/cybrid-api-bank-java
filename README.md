...
- Build date: 2023-04-13T18:25:13.852458Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.45"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.45.jar`
- `target/lib/*.jar`
