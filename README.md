...
- Build date: 2025-05-29T17:51:40.663202Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.537"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.537.jar`
- `target/lib/*.jar`
