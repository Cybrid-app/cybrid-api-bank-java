...
- Build date: 2025-01-06T16:22:50.524275Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.125"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.125.jar`
- `target/lib/*.jar`
