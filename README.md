...
- Build date: 2024-02-23T16:21:17.636377Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.14"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.14.jar`
- `target/lib/*.jar`
