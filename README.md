...
- Build date: 2024-02-23T20:07:00.870471Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.16.jar`
- `target/lib/*.jar`
