...
- Build date: 2023-06-23T12:29:06.833219Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.3.jar`
- `target/lib/*.jar`
