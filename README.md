...
- Build date: 2025-03-17T14:41:05.963264Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.298"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.298.jar`
- `target/lib/*.jar`
