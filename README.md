...
- Build date: 2024-03-27T14:07:19.316972Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.42"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.42.jar`
- `target/lib/*.jar`
