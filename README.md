...
- Build date: 2023-04-14T13:16:16.334312Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.48"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.48.jar`
- `target/lib/*.jar`
