...
- Build date: 2023-07-20T21:08:16.132167Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.10.jar`
- `target/lib/*.jar`
