...
- Build date: 2025-01-10T12:25:39.131419Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.134"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.134.jar`
- `target/lib/*.jar`
