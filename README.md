...
- Build date: 2024-02-29T18:43:16.923531Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.28.jar`
- `target/lib/*.jar`
