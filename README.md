...
- Build date: 2025-04-15T13:45:40.474761Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.387"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.387.jar`
- `target/lib/*.jar`
