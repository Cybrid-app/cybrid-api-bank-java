...
- Build date: 2025-06-04T21:41:44.433710Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.552"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.552.jar`
- `target/lib/*.jar`
