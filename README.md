...
- Build date: 2024-03-29T12:53:23.556092Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.50"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.50.jar`
- `target/lib/*.jar`
