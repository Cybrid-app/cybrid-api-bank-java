...
- Build date: 2024-04-10T16:09:29.208641Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.79"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.79.jar`
- `target/lib/*.jar`
