...
- Build date: 2024-03-02T00:38:41.793663Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.33"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.33.jar`
- `target/lib/*.jar`
