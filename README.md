...
- Build date: 2025-03-08T15:20:06.620976Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.285"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.285.jar`
- `target/lib/*.jar`
