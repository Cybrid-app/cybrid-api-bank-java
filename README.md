...
- Build date: 2023-08-02T13:10:59.849479Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.24.jar`
- `target/lib/*.jar`
