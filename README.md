...
- Build date: 2023-05-26T15:44:59.016936Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.53"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.53.jar`
- `target/lib/*.jar`
