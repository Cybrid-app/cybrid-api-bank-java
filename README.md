...
- Build date: 2024-10-23T13:40:16.434743Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.36"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.36.jar`
- `target/lib/*.jar`
