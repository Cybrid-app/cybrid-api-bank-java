...
- Build date: 2023-10-18T20:10:33.534725Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.2.jar`
- `target/lib/*.jar`
