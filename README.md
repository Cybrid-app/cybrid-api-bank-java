...
- Build date: 2025-05-06T15:33:44.840158Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.454"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.454.jar`
- `target/lib/*.jar`
