...
- Build date: 2023-08-24T18:48:42.041556Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.88.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.88.2.jar`
- `target/lib/*.jar`
