...
- Build date: 2025-01-15T22:46:46.791271Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.145"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.145.jar`
- `target/lib/*.jar`
