...
- Build date: 2024-12-18T13:34:25.004879Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.95"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.95.jar`
- `target/lib/*.jar`
