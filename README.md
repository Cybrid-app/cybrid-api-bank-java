...
- Build date: 2024-12-24T15:42:04.305927Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.107"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.107.jar`
- `target/lib/*.jar`
