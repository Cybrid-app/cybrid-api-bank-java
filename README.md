...
- Build date: 2023-09-20T14:29:23.752749Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.22.jar`
- `target/lib/*.jar`
