...
- Build date: 2025-04-10T17:51:07.013752Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.376"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.376.jar`
- `target/lib/*.jar`
