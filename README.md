...
- Build date: 2025-03-12T13:24:53.459589Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.290"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.290.jar`
- `target/lib/*.jar`
