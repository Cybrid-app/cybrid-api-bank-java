...
- Build date: 2024-02-12T14:32:49.912591Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.137"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.137.jar`
- `target/lib/*.jar`
