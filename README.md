...
- Build date: 2025-06-13T20:57:56.572581Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.586"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.586.jar`
- `target/lib/*.jar`
