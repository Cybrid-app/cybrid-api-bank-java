...
- Build date: 2023-04-17T12:58:41.492937Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.51"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.51.jar`
- `target/lib/*.jar`
