...
- Build date: 2025-05-14T15:26:35.501421Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.479"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.479.jar`
- `target/lib/*.jar`
