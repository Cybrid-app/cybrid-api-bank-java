...
- Build date: 2025-03-28T18:15:05.010053Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.339"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.339.jar`
- `target/lib/*.jar`
