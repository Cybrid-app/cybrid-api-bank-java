...
- Build date: 2025-06-06T11:10:43.599668Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.556"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.556.jar`
- `target/lib/*.jar`
