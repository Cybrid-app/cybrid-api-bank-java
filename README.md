...
- Build date: 2022-05-14T17:31:51.619878Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.8.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.8.11.jar`
- `target/lib/*.jar`
