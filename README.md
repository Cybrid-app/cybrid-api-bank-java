...
- Build date: 2022-05-04T11:12:46.937085Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.27.jar`
- `target/lib/*.jar`
