...
- Build date: 2025-06-04T19:04:14.139348Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.551"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.551.jar`
- `target/lib/*.jar`
