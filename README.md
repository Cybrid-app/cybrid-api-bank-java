...
- Build date: 2024-03-28T15:39:09.014829Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.46"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.46.jar`
- `target/lib/*.jar`
