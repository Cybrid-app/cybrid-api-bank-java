...
- Build date: 2024-08-15T18:05:42.978095Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.25.jar`
- `target/lib/*.jar`
