...
- Build date: 2025-01-06T12:52:16.585166Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.123"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.123.jar`
- `target/lib/*.jar`
