...
- Build date: 2024-12-10T18:22:53.381586Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.72"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.72.jar`
- `target/lib/*.jar`
