...
- Build date: 2024-12-07T02:41:22.722963Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.65"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.65.jar`
- `target/lib/*.jar`
