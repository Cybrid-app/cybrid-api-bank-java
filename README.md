...
- Build date: 2024-06-05T18:10:29.493503Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.4.jar`
- `target/lib/*.jar`
