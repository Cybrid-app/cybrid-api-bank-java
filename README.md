...
- Build date: 2023-05-25T19:36:21.961369Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.44"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.44.jar`
- `target/lib/*.jar`
