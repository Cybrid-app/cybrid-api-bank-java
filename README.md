...
- Build date: 2024-01-15T21:19:57.296634Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.65"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.65.jar`
- `target/lib/*.jar`
