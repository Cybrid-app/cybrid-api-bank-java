...
- Build date: 2023-06-04T13:22:39.416135Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.67"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.67.jar`
- `target/lib/*.jar`
