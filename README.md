...
- Build date: 2023-09-29T17:32:14.852281Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.49"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.49.jar`
- `target/lib/*.jar`
