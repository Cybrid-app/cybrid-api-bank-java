...
- Build date: 2023-07-17T13:54:25.828060Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.13.jar`
- `target/lib/*.jar`
