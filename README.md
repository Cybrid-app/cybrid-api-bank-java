...
- Build date: 2025-05-23T18:53:04.234878Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.521"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.521.jar`
- `target/lib/*.jar`
