...
- Build date: 2022-05-31T13:11:40.148075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.16.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.16.4.jar`
- `target/lib/*.jar`
