...
- Build date: 2023-09-15T16:37:08.107018Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.11.jar`
- `target/lib/*.jar`
