...
- Build date: 2024-02-21T19:44:55.569047Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.8.jar`
- `target/lib/*.jar`
