...
- Build date: 2025-02-18T22:23:55.307812Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.239"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.239.jar`
- `target/lib/*.jar`
