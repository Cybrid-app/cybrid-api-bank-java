...
- Build date: 2024-09-09T16:01:13.937231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.74"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.74.jar`
- `target/lib/*.jar`
