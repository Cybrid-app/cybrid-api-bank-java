...
- Build date: 2025-05-09T22:35:02.121084Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.473"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.473.jar`
- `target/lib/*.jar`
