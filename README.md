...
- Build date: 2024-07-25T19:29:08.278499Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.98"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.98.jar`
- `target/lib/*.jar`
