...
- Build date: 2024-10-21T14:33:37.047953Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.29.jar`
- `target/lib/*.jar`
