...
- Build date: 2025-01-09T16:13:01.440416Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.132"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.132.jar`
- `target/lib/*.jar`
