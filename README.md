...
- Build date: 2024-12-16T21:08:54.504551Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.91"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.91.jar`
- `target/lib/*.jar`
