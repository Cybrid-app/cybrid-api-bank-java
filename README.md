...
- Build date: 2024-12-19T15:33:33.804153Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.99"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.99.jar`
- `target/lib/*.jar`
