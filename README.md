...
- Build date: 2025-01-04T18:13:14.861197Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.122"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.122.jar`
- `target/lib/*.jar`
