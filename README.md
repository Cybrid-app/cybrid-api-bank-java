...
- Build date: 2023-07-28T13:19:57.145015Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.3.jar`
- `target/lib/*.jar`
