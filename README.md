...
- Build date: 2023-10-23T15:56:03.247494Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.11.jar`
- `target/lib/*.jar`
