...
- Build date: 2023-07-12T18:29:26.488549Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.5.jar`
- `target/lib/*.jar`
