...
- Build date: 2025-03-25T13:39:06.425897Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.323"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.323.jar`
- `target/lib/*.jar`
