...
- Build date: 2023-12-18T02:02:11.592005Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.13.jar`
- `target/lib/*.jar`
