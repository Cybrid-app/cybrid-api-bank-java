...
- Build date: 2024-06-04T19:11:43.917496Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.2.jar`
- `target/lib/*.jar`
