...
- Build date: 2023-08-28T20:29:44.751910Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.89.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.89.2.jar`
- `target/lib/*.jar`
