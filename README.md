...
- Build date: 2024-10-16T17:44:27.738412Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.12.jar`
- `target/lib/*.jar`
