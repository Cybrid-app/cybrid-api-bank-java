...
- Build date: 2023-05-26T12:21:14.833408Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.49"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.49.jar`
- `target/lib/*.jar`
