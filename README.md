...
- Build date: 2024-02-07T21:23:20.619957Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.125"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.125.jar`
- `target/lib/*.jar`
