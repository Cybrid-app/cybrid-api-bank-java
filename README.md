...
- Build date: 2025-05-16T21:15:28.271537Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.497"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.497.jar`
- `target/lib/*.jar`
