...
- Build date: 2025-03-06T13:44:23.901044Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.273"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.273.jar`
- `target/lib/*.jar`
