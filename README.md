...
- Build date: 2024-09-18T17:01:43.732452Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.112"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.112.jar`
- `target/lib/*.jar`
