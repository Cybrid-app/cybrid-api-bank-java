...
- Build date: 2025-01-06T13:48:32.218897Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.124"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.124.jar`
- `target/lib/*.jar`
