...
- Build date: 2023-12-07T14:11:30.483507Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.13.jar`
- `target/lib/*.jar`
