...
- Build date: 2024-10-19T18:05:32.524155Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.28.jar`
- `target/lib/*.jar`
