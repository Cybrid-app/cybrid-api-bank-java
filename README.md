...
- Build date: 2023-09-29T13:22:52.948016Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.46"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.46.jar`
- `target/lib/*.jar`
