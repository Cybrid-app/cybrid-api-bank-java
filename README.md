...
- Build date: 2025-02-19T16:42:25.267692Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.242"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.242.jar`
- `target/lib/*.jar`
