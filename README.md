...
- Build date: 2024-12-13T22:17:45.863967Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.87"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.87.jar`
- `target/lib/*.jar`
