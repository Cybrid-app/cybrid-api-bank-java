...
- Build date: 2023-07-18T03:25:42.333802Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.17.jar`
- `target/lib/*.jar`
