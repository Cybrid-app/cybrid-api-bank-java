...
- Build date: 2024-02-29T20:09:17.451732Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.29.jar`
- `target/lib/*.jar`
