...
- Build date: 2025-04-11T12:53:59.728250Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.379"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.379.jar`
- `target/lib/*.jar`
