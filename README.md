...
- Build date: 2025-05-27T10:41:56.391390Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.528"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.528.jar`
- `target/lib/*.jar`
