...
- Build date: 2023-09-11T20:23:17.458944Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.93.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.93.1.jar`
- `target/lib/*.jar`
