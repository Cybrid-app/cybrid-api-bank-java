...
- Build date: 2022-05-27T19:32:16.190087Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.15.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.15.7.jar`
- `target/lib/*.jar`
