...
- Build date: 2024-04-11T15:15:08.982866Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.84"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.84.jar`
- `target/lib/*.jar`
