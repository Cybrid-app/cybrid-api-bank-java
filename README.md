...
- Build date: 2023-04-14T14:43:19.189315Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.49"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.49.jar`
- `target/lib/*.jar`
