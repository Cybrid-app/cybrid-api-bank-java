...
- Build date: 2023-12-14T15:39:41.151304Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.4.jar`
- `target/lib/*.jar`
