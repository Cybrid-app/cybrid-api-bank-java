...
- Build date: 2025-04-29T20:10:07.652409Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.437"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.437.jar`
- `target/lib/*.jar`
