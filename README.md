...
- Build date: 2024-09-28T01:43:48.081524Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.150"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.150.jar`
- `target/lib/*.jar`
