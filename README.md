...
- Build date: 2023-07-20T12:05:52.629253Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.5.jar`
- `target/lib/*.jar`
