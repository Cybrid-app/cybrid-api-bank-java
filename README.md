...
- Build date: 2022-05-11T14:57:20.245712Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.6.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.6.16.jar`
- `target/lib/*.jar`
