...
- Build date: 2024-12-16T18:57:34.334974Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.90"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.90.jar`
- `target/lib/*.jar`
