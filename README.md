...
- Build date: 2022-06-08T03:18:31.105465Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.21.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.21.4.jar`
- `target/lib/*.jar`
