...
- Build date: 2024-07-30T16:17:15.734759Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.111"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.111.jar`
- `target/lib/*.jar`
