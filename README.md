...
- Build date: 2022-05-05T11:18:40.144942Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.31"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.31.jar`
- `target/lib/*.jar`
