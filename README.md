...
- Build date: 2023-11-29T14:16:54.653486Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.8.jar`
- `target/lib/*.jar`
