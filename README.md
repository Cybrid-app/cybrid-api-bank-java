...
- Build date: 2024-05-24T18:31:39.322488Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.12.jar`
- `target/lib/*.jar`
