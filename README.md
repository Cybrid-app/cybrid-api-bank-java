...
- Build date: 2023-11-08T13:54:01.808820Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.41.jar`
- `target/lib/*.jar`
