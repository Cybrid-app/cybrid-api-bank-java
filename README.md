...
- Build date: 2025-02-14T20:19:18.979257Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.234"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.234.jar`
- `target/lib/*.jar`
