...
- Build date: 2024-01-22T16:33:01.710002Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.84"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.84.jar`
- `target/lib/*.jar`
