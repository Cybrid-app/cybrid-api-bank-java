...
- Build date: 2023-05-01T20:11:45.173705Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.74"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.74.jar`
- `target/lib/*.jar`
