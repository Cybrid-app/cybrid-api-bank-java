...
- Build date: 2024-08-22T13:59:00.606832Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.40"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.40.jar`
- `target/lib/*.jar`
