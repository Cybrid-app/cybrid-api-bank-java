...
- Build date: 2024-08-05T18:52:55.162231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.4.jar`
- `target/lib/*.jar`
