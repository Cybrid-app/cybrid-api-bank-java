...
- Build date: 2024-07-29T17:47:23.472313Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.108"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.108.jar`
- `target/lib/*.jar`
