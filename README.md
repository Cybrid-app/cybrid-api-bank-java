...
- Build date: 2022-05-05T10:25:22.792137Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.29.jar`
- `target/lib/*.jar`
