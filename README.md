...
- Build date: 2024-02-22T19:12:52.917704Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.12.jar`
- `target/lib/*.jar`
