...
- Build date: 2022-05-13T18:57:11.782984Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.8.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.8.9.jar`
- `target/lib/*.jar`
