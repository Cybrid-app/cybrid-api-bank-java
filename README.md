...
- Build date: 2023-05-08T18:17:46.045903Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.0.jar`
- `target/lib/*.jar`
