...
- Build date: 2025-03-26T20:42:13.382238Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.331"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.331.jar`
- `target/lib/*.jar`
