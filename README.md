...
- Build date: 2024-03-10T17:03:18.145880Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.6.jar`
- `target/lib/*.jar`
