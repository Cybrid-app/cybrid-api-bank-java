...
- Build date: 2024-02-12T18:14:48.336990Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.140"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.140.jar`
- `target/lib/*.jar`
