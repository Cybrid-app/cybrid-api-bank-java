...
- Build date: 2023-11-23T14:18:15.300962Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.21.jar`
- `target/lib/*.jar`
