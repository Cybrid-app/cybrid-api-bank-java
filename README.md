...
- Build date: 2024-02-06T17:36:07.381906Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.122"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.122.jar`
- `target/lib/*.jar`
