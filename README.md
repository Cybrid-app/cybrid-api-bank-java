...
- Build date: 2023-05-30T12:09:20.503517Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.57"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.57.jar`
- `target/lib/*.jar`
