...
- Build date: 2023-07-04T15:10:35.843027Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.27.jar`
- `target/lib/*.jar`
