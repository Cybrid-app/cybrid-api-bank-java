...
- Build date: 2024-08-08T17:50:12.456795Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.10.jar`
- `target/lib/*.jar`
