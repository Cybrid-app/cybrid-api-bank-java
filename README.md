...
- Build date: 2024-06-03T12:09:38.482009Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.28.jar`
- `target/lib/*.jar`
