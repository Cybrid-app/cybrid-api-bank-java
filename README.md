...
- Build date: 2023-10-19T12:34:50.125344Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.4.jar`
- `target/lib/*.jar`
