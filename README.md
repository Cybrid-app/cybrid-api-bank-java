...
- Build date: 2023-11-30T22:01:29.040033Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.17.jar`
- `target/lib/*.jar`
