...
- Build date: 2025-06-02T17:04:02.269521Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.541"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.541.jar`
- `target/lib/*.jar`
