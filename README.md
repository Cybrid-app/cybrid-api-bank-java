...
- Build date: 2025-05-22T15:32:11.703679Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.515"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.515.jar`
- `target/lib/*.jar`
