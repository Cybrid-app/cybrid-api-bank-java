...
- Build date: 2024-01-25T14:23:40.780505Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.95"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.95.jar`
- `target/lib/*.jar`
