...
- Build date: 2024-08-19T12:57:15.388900Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.29.jar`
- `target/lib/*.jar`
