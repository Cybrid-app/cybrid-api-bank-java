...
- Build date: 2023-11-09T22:40:23.996554Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.47.jar`
- `target/lib/*.jar`
