...
- Build date: 2024-09-23T20:25:08.772160Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.133"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.133.jar`
- `target/lib/*.jar`
