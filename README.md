...
- Build date: 2024-05-01T16:36:52.630570Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.131"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.131.jar`
- `target/lib/*.jar`
