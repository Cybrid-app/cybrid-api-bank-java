...
- Build date: 2024-09-19T19:24:29.929998Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.118"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.118.jar`
- `target/lib/*.jar`
