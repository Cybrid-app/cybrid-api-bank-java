...
- Build date: 2024-06-26T14:38:41.891561Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.44"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.44.jar`
- `target/lib/*.jar`
