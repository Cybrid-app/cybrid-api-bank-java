...
- Build date: 2023-11-22T13:21:52.902685Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.17.jar`
- `target/lib/*.jar`
