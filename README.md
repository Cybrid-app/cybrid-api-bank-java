...
- Build date: 2023-05-30T20:55:04.324120Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.60"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.60.jar`
- `target/lib/*.jar`
