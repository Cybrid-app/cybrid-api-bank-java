...
- Build date: 2023-06-15T15:21:27.341209Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.17.jar`
- `target/lib/*.jar`
