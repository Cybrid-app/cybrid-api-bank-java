...
- Build date: 2023-06-12T13:39:48.289064Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.7.jar`
- `target/lib/*.jar`
