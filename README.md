...
- Build date: 2023-06-29T17:37:34.357456Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.23"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.23.jar`
- `target/lib/*.jar`
