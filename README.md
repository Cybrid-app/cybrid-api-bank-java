...
- Build date: 2023-12-01T12:29:40.973321Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.19"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.19.jar`
- `target/lib/*.jar`
