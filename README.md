...
- Build date: 2025-04-09T13:51:40.795364Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.370"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.370.jar`
- `target/lib/*.jar`
