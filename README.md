...
- Build date: 2023-06-19T13:42:37.730911Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.24.jar`
- `target/lib/*.jar`
