...
- Build date: 2024-08-28T16:52:32.039511Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.52"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.52.jar`
- `target/lib/*.jar`
