...
- Build date: 2024-02-02T15:21:36.540800Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.116"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.116.jar`
- `target/lib/*.jar`
