...
- Build date: 2024-05-31T16:07:46.033152Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.25.jar`
- `target/lib/*.jar`
