...
- Build date: 2024-08-29T16:42:12.100927Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.55"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.55.jar`
- `target/lib/*.jar`
