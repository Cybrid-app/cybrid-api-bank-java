...
- Build date: 2024-05-10T17:01:14.491698Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.148"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.148.jar`
- `target/lib/*.jar`
