...
- Build date: 2024-01-27T18:52:34.705461Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.104"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.104.jar`
- `target/lib/*.jar`
