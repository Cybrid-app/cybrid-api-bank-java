...
- Build date: 2022-05-04T10:11:48.444246Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.24.jar`
- `target/lib/*.jar`
