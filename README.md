...
- Build date: 2023-12-10T22:45:32.012842Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.25.jar`
- `target/lib/*.jar`
