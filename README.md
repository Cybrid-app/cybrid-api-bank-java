...
- Build date: 2023-08-04T14:19:30.659171Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.82.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.82.2.jar`
- `target/lib/*.jar`
