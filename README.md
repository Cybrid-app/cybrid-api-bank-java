...
- Build date: 2024-09-26T12:16:09.731143Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.140"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.140.jar`
- `target/lib/*.jar`
