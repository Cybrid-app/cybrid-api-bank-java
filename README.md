...
- Build date: 2022-05-26T11:10:25.686560Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.14.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.14.17.jar`
- `target/lib/*.jar`
