...
- Build date: 2024-06-03T15:38:03.348674Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.30.jar`
- `target/lib/*.jar`
