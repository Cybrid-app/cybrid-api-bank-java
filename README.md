...
- Build date: 2023-12-13T13:54:08.361721Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.39.jar`
- `target/lib/*.jar`
