...
- Build date: 2024-12-05T22:06:18.817813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.61"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.61.jar`
- `target/lib/*.jar`
