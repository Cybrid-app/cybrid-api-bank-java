...
- Build date: 2025-06-16T14:41:23.228932Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.590"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.590.jar`
- `target/lib/*.jar`
