...
- Build date: 2022-06-03T18:23:35.663428Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.18.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.18.5.jar`
- `target/lib/*.jar`
