...
- Build date: 2025-03-18T12:51:34.673350Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.303"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.303.jar`
- `target/lib/*.jar`
