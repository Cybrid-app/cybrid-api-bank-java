...
- Build date: 2024-03-28T12:44:48.509696Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.45"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.45.jar`
- `target/lib/*.jar`
