...
- Build date: 2023-04-20T14:34:32.615215Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.59"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.59.jar`
- `target/lib/*.jar`
