...
- Build date: 2024-05-17T17:37:17.711577Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.116.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.116.6.jar`
- `target/lib/*.jar`
