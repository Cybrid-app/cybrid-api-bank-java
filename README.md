...
- Build date: 2025-03-27T15:21:04.772249Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.332"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.332.jar`
- `target/lib/*.jar`
