...
- Build date: 2023-12-21T22:55:37.931537Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.35"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.35.jar`
- `target/lib/*.jar`
