...
- Build date: 2025-04-21T19:12:42.021188Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.408"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.408.jar`
- `target/lib/*.jar`
