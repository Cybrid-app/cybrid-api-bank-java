...
- Build date: 2023-06-19T14:09:50.251038Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.25"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.25.jar`
- `target/lib/*.jar`
