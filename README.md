...
- Build date: 2024-04-25T15:28:39.375779Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.122"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.122.jar`
- `target/lib/*.jar`
