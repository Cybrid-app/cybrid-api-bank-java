...
- Build date: 2023-11-24T14:35:05.657927Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.27.jar`
- `target/lib/*.jar`
