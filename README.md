...
- Build date: 2024-02-21T13:50:33.601026Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.4.jar`
- `target/lib/*.jar`
