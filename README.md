...
- Build date: 2024-09-03T23:21:43.214670Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.62"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.62.jar`
- `target/lib/*.jar`
