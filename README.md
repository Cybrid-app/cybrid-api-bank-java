...
- Build date: 2024-01-23T19:08:29.414696Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.90"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.90.jar`
- `target/lib/*.jar`
