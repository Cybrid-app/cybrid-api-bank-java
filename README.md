...
- Build date: 2023-09-04T21:44:05.103157Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.90.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.90.9.jar`
- `target/lib/*.jar`
