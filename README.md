...
- Build date: 2024-09-10T14:05:47.541425Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.79"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.79.jar`
- `target/lib/*.jar`
