...
- Build date: 2025-04-17T13:59:47.808452Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.403"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.403.jar`
- `target/lib/*.jar`
