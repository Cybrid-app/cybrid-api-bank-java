...
- Build date: 2023-05-12T13:44:56.524031Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.18.jar`
- `target/lib/*.jar`
