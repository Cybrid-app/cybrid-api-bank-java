...
- Build date: 2025-02-04T23:53:47.157053Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.205"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.205.jar`
- `target/lib/*.jar`
