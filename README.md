...
- Build date: 2024-08-20T17:10:09.413099Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.36"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.36.jar`
- `target/lib/*.jar`
