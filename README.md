...
- Build date: 2023-05-13T15:07:36.283957Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.20"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.20.jar`
- `target/lib/*.jar`
