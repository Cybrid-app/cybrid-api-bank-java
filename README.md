...
- Build date: 2023-10-25T20:51:05.434472Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.17.jar`
- `target/lib/*.jar`
