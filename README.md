...
- Build date: 2023-05-08T13:31:25.690012Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.90"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.90.jar`
- `target/lib/*.jar`
