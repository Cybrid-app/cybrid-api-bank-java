...
- Build date: 2023-08-30T13:56:01.981058Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.89.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.89.6.jar`
- `target/lib/*.jar`
