...
- Build date: 2025-03-18T23:34:58.837008Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.309"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.309.jar`
- `target/lib/*.jar`
