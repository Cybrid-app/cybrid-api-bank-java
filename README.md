...
- Build date: 2025-05-09T21:20:46.078526Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.472"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.472.jar`
- `target/lib/*.jar`
