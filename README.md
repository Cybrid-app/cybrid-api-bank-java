...
- Build date: 2023-12-19T15:37:00.928119Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.21.jar`
- `target/lib/*.jar`
