...
- Build date: 2024-08-07T15:13:31.786608Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.8.jar`
- `target/lib/*.jar`
