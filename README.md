...
- Build date: 2024-02-09T15:35:43.411772Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.130"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.130.jar`
- `target/lib/*.jar`
