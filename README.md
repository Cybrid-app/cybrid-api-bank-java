...
- Build date: 2023-06-27T23:01:26.531929Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.20"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.20.jar`
- `target/lib/*.jar`
