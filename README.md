...
- Build date: 2023-09-29T15:42:29.304936Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.48"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.48.jar`
- `target/lib/*.jar`
