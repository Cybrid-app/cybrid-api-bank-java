...
- Build date: 2023-12-04T16:06:55.960926Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.1.jar`
- `target/lib/*.jar`
