...
- Build date: 2025-03-10T15:04:57.645268Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.287"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.287.jar`
- `target/lib/*.jar`
