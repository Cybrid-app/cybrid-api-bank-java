...
- Build date: 2024-05-24T17:07:46.078931Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.11.jar`
- `target/lib/*.jar`
