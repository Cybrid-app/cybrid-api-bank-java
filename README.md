...
- Build date: 2025-01-02T18:39:49.311487Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.117"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.117.jar`
- `target/lib/*.jar`
