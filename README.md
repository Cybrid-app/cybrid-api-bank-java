...
- Build date: 2025-03-06T15:30:54.506974Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.274"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.274.jar`
- `target/lib/*.jar`
