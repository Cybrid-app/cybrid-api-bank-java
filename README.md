...
- Build date: 2024-05-14T15:51:24.988783Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.116.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.116.1.jar`
- `target/lib/*.jar`
