...
- Build date: 2023-12-20T18:13:51.535344Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.26.jar`
- `target/lib/*.jar`
