...
- Build date: 2025-02-25T22:55:56.020456Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.256"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.256.jar`
- `target/lib/*.jar`
