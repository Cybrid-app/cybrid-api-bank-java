...
- Build date: 2024-07-16T13:52:26.481457Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.80"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.80.jar`
- `target/lib/*.jar`
