...
- Build date: 2024-11-01T12:39:47.294295Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.18.jar`
- `target/lib/*.jar`
