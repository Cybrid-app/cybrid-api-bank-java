...
- Build date: 2024-05-27T19:22:38.046554Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.17.jar`
- `target/lib/*.jar`
