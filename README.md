...
- Build date: 2023-07-10T17:41:40.135164Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.76.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.76.9.jar`
- `target/lib/*.jar`
