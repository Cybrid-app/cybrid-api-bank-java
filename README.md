...
- Build date: 2022-05-04T10:50:05.069044Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.26.jar`
- `target/lib/*.jar`
