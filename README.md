...
- Build date: 2025-03-24T19:07:42.138953Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.322"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.322.jar`
- `target/lib/*.jar`
