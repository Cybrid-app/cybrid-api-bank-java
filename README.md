...
- Build date: 2023-08-22T12:02:07.561340Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.85.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.85.7.jar`
- `target/lib/*.jar`
