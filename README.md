...
- Build date: 2024-12-06T19:32:01.954240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.63"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.63.jar`
- `target/lib/*.jar`
