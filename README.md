...
- Build date: 2024-09-20T16:04:39.865685Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.125"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.125.jar`
- `target/lib/*.jar`
