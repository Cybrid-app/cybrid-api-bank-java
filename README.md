...
- Build date: 2024-05-30T15:41:33.832991Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.21.jar`
- `target/lib/*.jar`
