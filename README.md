...
- Build date: 2023-04-12T20:45:23.681117Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.39.jar`
- `target/lib/*.jar`
