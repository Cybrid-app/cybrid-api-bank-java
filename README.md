...
- Build date: 2024-02-07T20:21:46.639807Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.124"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.124.jar`
- `target/lib/*.jar`
