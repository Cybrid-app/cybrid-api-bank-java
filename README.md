...
- Build date: 2025-03-12T17:13:51.489916Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.291"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.291.jar`
- `target/lib/*.jar`
