...
- Build date: 2025-03-14T11:33:50.695987Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.295"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.295.jar`
- `target/lib/*.jar`
