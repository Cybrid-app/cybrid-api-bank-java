...
- Build date: 2024-03-18T14:53:56.822903Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.17.jar`
- `target/lib/*.jar`
