...
- Build date: 2024-12-16T16:57:55.854675Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.89"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.89.jar`
- `target/lib/*.jar`
