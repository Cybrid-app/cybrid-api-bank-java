...
- Build date: 2023-11-17T23:05:06.159272Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.8.jar`
- `target/lib/*.jar`
