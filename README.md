...
- Build date: 2023-12-21T15:06:07.793494Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.29"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.29.jar`
- `target/lib/*.jar`
