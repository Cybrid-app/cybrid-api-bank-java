...
- Build date: 2024-04-19T14:59:09.675243Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.110"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.110.jar`
- `target/lib/*.jar`
