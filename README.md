...
- Build date: 2024-10-05T19:06:02.274114Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.6.jar`
- `target/lib/*.jar`
