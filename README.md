...
- Build date: 2023-05-25T16:15:32.342511Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.43"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.43.jar`
- `target/lib/*.jar`
