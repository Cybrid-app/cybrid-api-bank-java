...
- Build date: 2024-03-22T20:28:24.534838Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.30.jar`
- `target/lib/*.jar`
