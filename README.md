...
- Build date: 2023-04-14T18:52:40.392395Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.50"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.50.jar`
- `target/lib/*.jar`
