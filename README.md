...
- Build date: 2023-09-29T10:15:20.168410Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.45"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.45.jar`
- `target/lib/*.jar`
