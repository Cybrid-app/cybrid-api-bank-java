...
- Build date: 2024-02-14T21:05:07.928937Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.147"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.147.jar`
- `target/lib/*.jar`
