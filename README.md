...
- Build date: 2023-09-07T15:08:36.190726Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.12.jar`
- `target/lib/*.jar`
