...
- Build date: 2023-06-20T13:24:36.226195Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.32.jar`
- `target/lib/*.jar`
