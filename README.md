...
- Build date: 2022-06-09T20:26:03.804462Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.24.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.24.2.jar`
- `target/lib/*.jar`
