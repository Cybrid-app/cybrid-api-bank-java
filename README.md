...
- Build date: 2025-05-16T00:16:26.350751Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.489"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.489.jar`
- `target/lib/*.jar`
