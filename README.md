...
- Build date: 2023-07-20T16:43:44.944461Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.8.jar`
- `target/lib/*.jar`
