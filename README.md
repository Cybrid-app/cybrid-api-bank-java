...
- Build date: 2023-10-04T19:06:59.069864Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.95.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.95.4.jar`
- `target/lib/*.jar`
