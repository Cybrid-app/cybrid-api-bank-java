...
- Build date: 2023-10-20T11:47:20.255823Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.8.jar`
- `target/lib/*.jar`
