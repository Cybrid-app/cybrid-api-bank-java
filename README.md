...
- Build date: 2023-11-24T15:40:44.861938Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.0.jar`
- `target/lib/*.jar`
