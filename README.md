...
- Build date: 2024-09-26T14:18:55.166709Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.141"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.141.jar`
- `target/lib/*.jar`
