...
- Build date: 2023-09-01T09:47:43.139172Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.90.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.90.3.jar`
- `target/lib/*.jar`
