...
- Build date: 2025-05-20T11:46:25.399810Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.498"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.498.jar`
- `target/lib/*.jar`
