...
- Build date: 2025-02-11T13:45:11.659596Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.225"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.225.jar`
- `target/lib/*.jar`
