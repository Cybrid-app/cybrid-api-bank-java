...
- Build date: 2024-08-29T14:28:14.513849Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.54"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.54.jar`
- `target/lib/*.jar`
