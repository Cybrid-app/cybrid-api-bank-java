...
- Build date: 2025-06-17T16:52:52.925305Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.600"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.600.jar`
- `target/lib/*.jar`
