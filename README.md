...
- Build date: 2024-12-04T14:12:49.032994Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.51"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.51.jar`
- `target/lib/*.jar`
