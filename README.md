...
- Build date: 2024-09-23T12:22:15.897022Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.131"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.131.jar`
- `target/lib/*.jar`
