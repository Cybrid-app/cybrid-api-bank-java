...
- Build date: 2023-05-17T15:53:47.767129Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.26.jar`
- `target/lib/*.jar`
