...
- Build date: 2024-09-04T17:56:41.223404Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.65"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.65.jar`
- `target/lib/*.jar`
