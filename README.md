...
- Build date: 2023-07-04T19:22:34.764721Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.75.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.75.3.jar`
- `target/lib/*.jar`
