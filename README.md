...
- Build date: 2024-12-04T22:21:37.442490Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.56"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.56.jar`
- `target/lib/*.jar`
