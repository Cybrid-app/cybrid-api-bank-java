...
- Build date: 2024-03-08T22:06:44.637950Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.2.jar`
- `target/lib/*.jar`
