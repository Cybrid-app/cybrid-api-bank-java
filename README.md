...
- Build date: 2023-09-04T22:35:29.741489Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.0.jar`
- `target/lib/*.jar`
