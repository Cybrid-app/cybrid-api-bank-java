...
- Build date: 2023-05-02T14:28:13.927428Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.76"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.76.jar`
- `target/lib/*.jar`
