...
- Build date: 2025-06-10T17:32:32.128150Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.570"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.570.jar`
- `target/lib/*.jar`
