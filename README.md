...
- Build date: 2025-06-09T11:28:58.455178Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.559"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.559.jar`
- `target/lib/*.jar`
