...
- Build date: 2023-09-05T16:51:10.564939Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.1.jar`
- `target/lib/*.jar`
