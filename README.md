...
- Build date: 2024-10-10T15:34:46.063821Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.18.jar`
- `target/lib/*.jar`
