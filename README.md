...
- Build date: 2025-03-05T19:55:59.719621Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.272"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.272.jar`
- `target/lib/*.jar`
