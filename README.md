...
- Build date: 2024-10-31T22:30:24.747528Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.16.jar`
- `target/lib/*.jar`
