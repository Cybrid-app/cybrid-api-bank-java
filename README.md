...
- Build date: 2024-09-19T02:16:43.770582Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.116"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.116.jar`
- `target/lib/*.jar`
