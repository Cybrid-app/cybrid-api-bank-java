...
- Build date: 2024-12-17T13:36:17.289725Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.92"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.92.jar`
- `target/lib/*.jar`
