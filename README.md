...
- Build date: 2025-04-09T20:49:25.815402Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.372"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.372.jar`
- `target/lib/*.jar`
