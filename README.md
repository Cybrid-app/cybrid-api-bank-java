...
- Build date: 2022-05-27T18:24:07.738581Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.15.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.15.5.jar`
- `target/lib/*.jar`
