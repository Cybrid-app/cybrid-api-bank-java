...
- Build date: 2024-09-20T13:21:21.980412Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.122"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.122.jar`
- `target/lib/*.jar`
