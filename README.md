...
- Build date: 2023-05-09T19:06:23.665810Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.8.jar`
- `target/lib/*.jar`
