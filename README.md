...
- Build date: 2025-05-16T20:02:35.777904Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.496"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.496.jar`
- `target/lib/*.jar`
