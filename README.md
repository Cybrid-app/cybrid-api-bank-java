...
- Build date: 2025-02-04T21:46:11.014699Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.204"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.204.jar`
- `target/lib/*.jar`
