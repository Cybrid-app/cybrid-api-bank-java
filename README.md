...
- Build date: 2023-12-19T18:31:05.966730Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.24.jar`
- `target/lib/*.jar`
