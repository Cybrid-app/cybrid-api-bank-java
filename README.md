...
- Build date: 2023-05-23T15:11:31.267843Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.34.jar`
- `target/lib/*.jar`
