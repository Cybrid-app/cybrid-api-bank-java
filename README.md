...
- Build date: 2023-06-15T18:24:59.056625Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.18.jar`
- `target/lib/*.jar`
