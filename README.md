...
- Build date: 2023-07-07T11:35:03.505230Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.76.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.76.6.jar`
- `target/lib/*.jar`
