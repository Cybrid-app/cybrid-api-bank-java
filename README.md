...
- Build date: 2023-06-08T20:24:33.920445Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.4"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.4.jar`
- `target/lib/*.jar`
