...
- Build date: 2023-05-09T13:37:44.547736Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.2.jar`
- `target/lib/*.jar`
