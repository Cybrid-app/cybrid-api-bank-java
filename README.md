...
- Build date: 2023-07-14T11:51:52.442961Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.8.jar`
- `target/lib/*.jar`
