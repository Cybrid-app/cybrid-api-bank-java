...
- Build date: 2024-02-21T20:45:17.606200Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.9.jar`
- `target/lib/*.jar`
