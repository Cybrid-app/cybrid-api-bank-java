...
- Build date: 2024-03-09T04:39:03.376095Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.5.jar`
- `target/lib/*.jar`
