...
- Build date: 2023-05-16T12:41:56.169795Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.24.jar`
- `target/lib/*.jar`
