...
- Build date: 2024-03-22T15:56:29.760978Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.27.jar`
- `target/lib/*.jar`
