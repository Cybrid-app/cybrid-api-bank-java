...
- Build date: 2025-04-01T16:26:29.869186Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.348"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.348.jar`
- `target/lib/*.jar`
