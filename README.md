...
- Build date: 2025-05-08T20:59:45.582134Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.467"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.467.jar`
- `target/lib/*.jar`
