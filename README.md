...
- Build date: 2023-10-28T14:38:46.552388Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.24.jar`
- `target/lib/*.jar`
