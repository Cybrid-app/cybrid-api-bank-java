...
- Build date: 2024-05-23T15:48:55.745043Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.8.jar`
- `target/lib/*.jar`
