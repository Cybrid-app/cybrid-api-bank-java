...
- Build date: 2025-05-08T13:26:43.685746Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.464"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.464.jar`
- `target/lib/*.jar`
