...
- Build date: 2025-05-14T20:28:49.102946Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.480"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.480.jar`
- `target/lib/*.jar`
