...
- Build date: 2024-08-29T22:41:11.788471Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.57"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.57.jar`
- `target/lib/*.jar`
