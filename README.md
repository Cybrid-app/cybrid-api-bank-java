...
- Build date: 2025-02-13T18:14:13.807796Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.231"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.231.jar`
- `target/lib/*.jar`
