...
- Build date: 2024-12-16T16:06:17.575867Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.88"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.88.jar`
- `target/lib/*.jar`
