...
- Build date: 2023-07-12T12:10:29.752371Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.2.jar`
- `target/lib/*.jar`
