...
- Build date: 2023-11-14T15:38:56.783574Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.57"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.57.jar`
- `target/lib/*.jar`
