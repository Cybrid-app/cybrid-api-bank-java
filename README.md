...
- Build date: 2025-01-10T15:26:48.113730Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.135"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.135.jar`
- `target/lib/*.jar`
