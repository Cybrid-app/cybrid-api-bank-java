...
- Build date: 2023-11-10T13:11:18.434150Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.48"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.48.jar`
- `target/lib/*.jar`
