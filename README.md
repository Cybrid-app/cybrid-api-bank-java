...
- Build date: 2024-09-24T17:14:25.897652Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.137"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.137.jar`
- `target/lib/*.jar`
