...
- Build date: 2023-10-19T11:52:50.142270Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.3.jar`
- `target/lib/*.jar`
