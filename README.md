...
- Build date: 2024-10-12T22:23:39.506169Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.3.jar`
- `target/lib/*.jar`
