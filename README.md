...
- Build date: 2025-03-26T12:30:46.129602Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.327"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.327.jar`
- `target/lib/*.jar`
