...
- Build date: 2025-04-07T19:28:39.822240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.363"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.363.jar`
- `target/lib/*.jar`
