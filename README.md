...
- Build date: 2024-05-12T19:01:05.694490Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.150"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.150.jar`
- `target/lib/*.jar`
