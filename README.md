...
- Build date: 2023-12-04T23:34:47.647343Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.5.jar`
- `target/lib/*.jar`
