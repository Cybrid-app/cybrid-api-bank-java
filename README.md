...
- Build date: 2024-05-28T12:33:29.082391Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.18"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.18.jar`
- `target/lib/*.jar`
