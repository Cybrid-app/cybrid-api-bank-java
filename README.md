...
- Build date: 2023-08-03T14:27:42.159175Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.27"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.27.jar`
- `target/lib/*.jar`
