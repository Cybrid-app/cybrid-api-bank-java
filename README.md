...
- Build date: 2023-12-15T20:42:43.659965Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.10.jar`
- `target/lib/*.jar`
