...
- Build date: 2023-07-22T21:42:13.675638Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.14"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.14.jar`
- `target/lib/*.jar`
