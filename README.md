...
- Build date: 2024-02-12T17:20:18.619877Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.139"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.139.jar`
- `target/lib/*.jar`
