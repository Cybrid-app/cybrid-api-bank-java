...
- Build date: 2025-02-06T14:04:29.811677Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.214"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.214.jar`
- `target/lib/*.jar`
