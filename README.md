...
- Build date: 2023-07-31T13:21:19.667862Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.6.jar`
- `target/lib/*.jar`
