...
- Build date: 2024-12-20T14:46:19.733743Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.101"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.101.jar`
- `target/lib/*.jar`
