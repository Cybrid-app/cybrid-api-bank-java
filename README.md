...
- Build date: 2024-11-20T16:51:34.155423Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.11"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.11.jar`
- `target/lib/*.jar`
