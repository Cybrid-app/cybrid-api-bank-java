...
- Build date: 2025-05-26T10:11:44.110975Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.522"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.522.jar`
- `target/lib/*.jar`
