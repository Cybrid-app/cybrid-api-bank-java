...
- Build date: 2022-06-14T14:52:25.719857Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.25.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.25.3.jar`
- `target/lib/*.jar`
