...
- Build date: 2023-07-04T15:42:06.871980Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.75.0"
  }
```
...
- `target/cybrid-api-bank-java-v0.75.0.jar`
- `target/lib/*.jar`
