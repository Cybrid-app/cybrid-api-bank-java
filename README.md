...
- Build date: 2024-09-26T15:39:39.554032Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.143"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.143.jar`
- `target/lib/*.jar`
