...
- Build date: 2025-06-02T18:31:01.531007Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.543"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.543.jar`
- `target/lib/*.jar`
