...
- Build date: 2023-05-08T20:14:46.449987Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.1.jar`
- `target/lib/*.jar`
