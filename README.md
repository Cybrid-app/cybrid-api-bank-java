...
- Build date: 2025-06-02T17:41:35.225532Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.542"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.542.jar`
- `target/lib/*.jar`
