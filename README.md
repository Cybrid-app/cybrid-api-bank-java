...
- Build date: 2025-03-30T13:19:34.525977Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.341"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.341.jar`
- `target/lib/*.jar`
