...
- Build date: 2024-06-12T19:08:24.407525Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.21"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.21.jar`
- `target/lib/*.jar`
