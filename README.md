...
- Build date: 2025-05-05T14:12:27.775264Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.447"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.447.jar`
- `target/lib/*.jar`
