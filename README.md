...
- Build date: 2025-06-18T23:48:11.631545Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.602"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.602.jar`
- `target/lib/*.jar`
