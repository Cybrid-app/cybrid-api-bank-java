...
- Build date: 2024-12-05T01:37:47.452690Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.58"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.58.jar`
- `target/lib/*.jar`
