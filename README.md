...
- Build date: 2022-05-04T13:56:50.434883Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.28.jar`
- `target/lib/*.jar`
