...
- Build date: 2024-08-23T14:51:40.506375Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.43"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.43.jar`
- `target/lib/*.jar`
