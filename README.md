...
- Build date: 2023-07-12T19:51:20.270237Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.6.jar`
- `target/lib/*.jar`
