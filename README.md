...
- Build date: 2023-08-10T11:56:15.927502Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.83.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.83.3.jar`
- `target/lib/*.jar`
