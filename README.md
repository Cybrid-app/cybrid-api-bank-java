...
- Build date: 2025-04-02T22:08:09.071096Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.353"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.353.jar`
- `target/lib/*.jar`
