...
- Build date: 2025-05-15T14:06:16.150037Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.484"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.484.jar`
- `target/lib/*.jar`
