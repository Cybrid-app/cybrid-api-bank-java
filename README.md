...
- Build date: 2023-08-13T11:15:51.854080Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.84.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.84.1.jar`
- `target/lib/*.jar`
