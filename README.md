...
- Build date: 2024-08-19T19:27:19.391770Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.32.jar`
- `target/lib/*.jar`
