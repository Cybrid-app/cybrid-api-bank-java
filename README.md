...
- Build date: 2023-09-07T18:34:59.579050Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.13.jar`
- `target/lib/*.jar`
