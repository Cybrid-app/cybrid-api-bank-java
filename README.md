...
- Build date: 2024-10-28T13:01:57.287224Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.48"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.48.jar`
- `target/lib/*.jar`
