...
- Build date: 2023-05-25T12:48:02.791640Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.39"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.39.jar`
- `target/lib/*.jar`
