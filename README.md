...
- Build date: 2024-07-28T18:19:51.085293Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.106"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.106.jar`
- `target/lib/*.jar`
