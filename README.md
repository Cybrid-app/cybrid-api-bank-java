...
- Build date: 2024-09-12T19:57:28.676951Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.92"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.92.jar`
- `target/lib/*.jar`
