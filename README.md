...
- Build date: 2024-07-25T16:55:23.682333Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.95"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.95.jar`
- `target/lib/*.jar`
