...
- Build date: 2023-09-01T17:31:20.479290Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.90.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.90.6.jar`
- `target/lib/*.jar`
