...
- Build date: 2024-11-08T15:30:29.246729Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.44"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.44.jar`
- `target/lib/*.jar`
