...
- Build date: 2023-05-09T14:34:55.490119Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.3.jar`
- `target/lib/*.jar`
