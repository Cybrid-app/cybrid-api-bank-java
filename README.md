...
- Build date: 2024-08-27T17:43:54.073509Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.47.jar`
- `target/lib/*.jar`
