...
- Build date: 2025-05-02T21:48:53.278143Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.445"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.445.jar`
- `target/lib/*.jar`
