...
- Build date: 2024-01-18T19:30:48.143254Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.71"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.71.jar`
- `target/lib/*.jar`
