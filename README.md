...
- Build date: 2024-12-23T18:04:04.595047Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.105"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.105.jar`
- `target/lib/*.jar`
