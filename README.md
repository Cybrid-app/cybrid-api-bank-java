...
- Build date: 2022-05-04T00:34:34.185776Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.3.23"
  }
```
...
- `target/cybrid-api-bank-java-v0.3.23.jar`
- `target/lib/*.jar`
