...
- Build date: 2024-03-06T21:34:15.749875Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.44"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.44.jar`
- `target/lib/*.jar`
