...
- Build date: 2023-09-21T21:49:29.481340Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.26"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.26.jar`
- `target/lib/*.jar`
