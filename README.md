...
- Build date: 2023-10-16T14:38:15.477016Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.106.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.106.7.jar`
- `target/lib/*.jar`
