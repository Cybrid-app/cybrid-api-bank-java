...
- Build date: 2024-09-12T19:17:58.939912Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.91"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.91.jar`
- `target/lib/*.jar`
