...
- Build date: 2024-05-08T15:43:57.497318Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.144"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.144.jar`
- `target/lib/*.jar`
