...
- Build date: 2023-09-13T21:38:38.149770Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.5.jar`
- `target/lib/*.jar`
