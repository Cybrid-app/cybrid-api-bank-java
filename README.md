...
- Build date: 2022-05-27T18:54:16.705389Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.15.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.15.6.jar`
- `target/lib/*.jar`
