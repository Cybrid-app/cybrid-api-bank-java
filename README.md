...
- Build date: 2023-10-12T21:49:46.644175Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.106.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.106.1.jar`
- `target/lib/*.jar`
