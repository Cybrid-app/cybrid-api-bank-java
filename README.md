...
- Build date: 2023-12-11T20:56:23.083125Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.32.jar`
- `target/lib/*.jar`
