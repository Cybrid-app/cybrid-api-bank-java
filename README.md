...
- Build date: 2024-03-15T14:49:36.918095Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.16.jar`
- `target/lib/*.jar`
