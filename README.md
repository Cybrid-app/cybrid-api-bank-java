...
- Build date: 2024-12-10T17:16:42.464249Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.71"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.71.jar`
- `target/lib/*.jar`
