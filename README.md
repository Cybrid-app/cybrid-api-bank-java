...
- Build date: 2024-08-22T15:00:40.997146Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.41"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.41.jar`
- `target/lib/*.jar`
