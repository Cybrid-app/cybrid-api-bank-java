...
- Build date: 2024-02-06T15:56:53.035287Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.121"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.121.jar`
- `target/lib/*.jar`
