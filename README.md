...
- Build date: 2023-06-14T11:38:46.969483Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.9.jar`
- `target/lib/*.jar`
