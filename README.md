...
- Build date: 2024-02-22T16:12:24.893986Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.10.jar`
- `target/lib/*.jar`
