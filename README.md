...
- Build date: 2025-06-02T15:30:29.788653Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.540"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.540.jar`
- `target/lib/*.jar`
