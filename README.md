...
- Build date: 2024-05-08T14:51:23.656907Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.143"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.143.jar`
- `target/lib/*.jar`
