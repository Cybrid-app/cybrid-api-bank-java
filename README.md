...
- Build date: 2023-08-25T15:18:45.560551Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.88.8"
  }
```
...
- `target/cybrid-api-bank-java-v0.88.8.jar`
- `target/lib/*.jar`
