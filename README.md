...
- Build date: 2023-07-31T23:03:46.333357Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.81.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.81.13.jar`
- `target/lib/*.jar`
