...
- Build date: 2024-07-08T17:48:57.566671Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.70"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.70.jar`
- `target/lib/*.jar`
