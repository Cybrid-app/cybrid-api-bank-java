...
- Build date: 2024-08-01T17:08:04.315991Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.117"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.117.jar`
- `target/lib/*.jar`
