...
- Build date: 2025-06-13T19:54:19.300651Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.585"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.585.jar`
- `target/lib/*.jar`
