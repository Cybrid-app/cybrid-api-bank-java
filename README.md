...
- Build date: 2024-01-25T14:59:42.998841Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.96"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.96.jar`
- `target/lib/*.jar`
