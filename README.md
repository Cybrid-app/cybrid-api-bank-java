...
- Build date: 2025-03-28T15:07:32.016194Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.337"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.337.jar`
- `target/lib/*.jar`
