...
- Build date: 2023-12-01T14:23:15.543040Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.111.20"
  }
```
...
- `target/cybrid-api-bank-java-v0.111.20.jar`
- `target/lib/*.jar`
