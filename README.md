...
- Build date: 2025-06-10T21:22:07.488769Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.571"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.571.jar`
- `target/lib/*.jar`
