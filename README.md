...
- Build date: 2024-12-31T14:53:44.532772Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.115"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.115.jar`
- `target/lib/*.jar`
