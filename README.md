...
- Build date: 2024-03-04T13:49:06.801316Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.35"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.35.jar`
- `target/lib/*.jar`
