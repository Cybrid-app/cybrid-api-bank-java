...
- Build date: 2025-02-11T14:23:35.477881Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.226"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.226.jar`
- `target/lib/*.jar`
