...
- Build date: 2025-05-21T15:13:29.872324Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.508"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.508.jar`
- `target/lib/*.jar`
