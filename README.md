...
- Build date: 2023-12-21T19:01:39.903212Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.31"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.31.jar`
- `target/lib/*.jar`
