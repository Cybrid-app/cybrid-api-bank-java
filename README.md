...
- Build date: 2025-06-19T13:14:21.834455Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.604"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.604.jar`
- `target/lib/*.jar`
