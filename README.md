...
- Build date: 2025-06-13T16:48:27.729457Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.582"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.582.jar`
- `target/lib/*.jar`
