...
- Build date: 2025-01-02T19:28:55.234662Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.118"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.118.jar`
- `target/lib/*.jar`
