...
- Build date: 2024-03-25T22:32:08.537013Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.37"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.37.jar`
- `target/lib/*.jar`
