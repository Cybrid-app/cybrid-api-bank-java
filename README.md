...
- Build date: 2024-09-19T21:27:21.974102Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.120"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.120.jar`
- `target/lib/*.jar`
