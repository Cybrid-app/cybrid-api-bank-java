...
- Build date: 2024-09-26T15:04:49.258844Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.142"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.142.jar`
- `target/lib/*.jar`
