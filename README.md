...
- Build date: 2023-09-18T17:49:59.587943Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.17"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.17.jar`
- `target/lib/*.jar`
