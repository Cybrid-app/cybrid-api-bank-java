...
- Build date: 2023-04-11T13:06:09.213223Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.32"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.32.jar`
- `target/lib/*.jar`
