...
- Build date: 2024-08-27T21:00:02.450827Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.49"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.49.jar`
- `target/lib/*.jar`
