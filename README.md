...
- Build date: 2023-09-26T12:33:10.675017Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.94.36"
  }
```
...
- `target/cybrid-api-bank-java-v0.94.36.jar`
- `target/lib/*.jar`
