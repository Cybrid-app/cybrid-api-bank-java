...
- Build date: 2023-06-22T17:41:56.274474Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.1.jar`
- `target/lib/*.jar`
