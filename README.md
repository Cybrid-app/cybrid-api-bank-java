...
- Build date: 2024-04-01T23:53:10.804917Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.54"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.54.jar`
- `target/lib/*.jar`
