...
- Build date: 2024-02-14T15:50:34.072128Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.144"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.144.jar`
- `target/lib/*.jar`
