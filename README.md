...
- Build date: 2023-11-21T16:33:10.774471Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.110.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.110.15.jar`
- `target/lib/*.jar`
