...
- Build date: 2025-06-26T18:58:26.492899Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.647"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.647.jar`
- `target/lib/*.jar`
