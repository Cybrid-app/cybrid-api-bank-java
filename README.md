...
- Build date: 2024-08-22T15:46:28.703069Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.42"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.42.jar`
- `target/lib/*.jar`
