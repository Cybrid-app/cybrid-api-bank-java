...
- Build date: 2025-05-27T17:06:11.320661Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.530"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.530.jar`
- `target/lib/*.jar`
