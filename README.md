...
- Build date: 2024-02-09T14:52:34.200605Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.129"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.129.jar`
- `target/lib/*.jar`
