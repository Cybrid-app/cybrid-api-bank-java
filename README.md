...
- Build date: 2024-01-03T22:04:18.187919Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.46"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.46.jar`
- `target/lib/*.jar`
