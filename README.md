...
- Build date: 2024-04-08T18:48:21.560222Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.67"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.67.jar`
- `target/lib/*.jar`
