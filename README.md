...
- Build date: 2024-09-12T17:30:19.433611Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.89"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.89.jar`
- `target/lib/*.jar`
