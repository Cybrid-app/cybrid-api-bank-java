...
- Build date: 2024-08-21T14:20:40.229851Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.37"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.37.jar`
- `target/lib/*.jar`
