...
- Build date: 2024-01-19T20:34:37.107745Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.78"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.78.jar`
- `target/lib/*.jar`
