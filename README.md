...
- Build date: 2023-09-06T16:28:48.527990Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.7.jar`
- `target/lib/*.jar`
