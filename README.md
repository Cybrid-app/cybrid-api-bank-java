...
- Build date: 2024-02-14T20:24:22.567889Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.146"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.146.jar`
- `target/lib/*.jar`
