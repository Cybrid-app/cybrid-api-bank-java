...
- Build date: 2024-01-25T18:38:30.099649Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.98"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.98.jar`
- `target/lib/*.jar`
