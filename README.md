...
- Build date: 2023-09-06T16:07:17.631118Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.91.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.91.6.jar`
- `target/lib/*.jar`
