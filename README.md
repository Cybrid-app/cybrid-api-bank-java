...
- Build date: 2024-08-07T00:50:41.334774Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.7.jar`
- `target/lib/*.jar`
