...
- Build date: 2025-04-25T19:14:58.945644Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.429"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.429.jar`
- `target/lib/*.jar`
