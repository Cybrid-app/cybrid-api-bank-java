...
- Build date: 2024-12-12T20:23:44.492163Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.82"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.82.jar`
- `target/lib/*.jar`
