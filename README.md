...
- Build date: 2025-02-18T16:20:44.637733Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.236"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.236.jar`
- `target/lib/*.jar`
