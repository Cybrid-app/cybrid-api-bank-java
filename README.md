...
- Build date: 2024-03-06T14:04:48.760437Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.42"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.42.jar`
- `target/lib/*.jar`
