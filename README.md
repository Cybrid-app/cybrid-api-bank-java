...
- Build date: 2023-12-12T14:38:28.413029Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.112.35"
  }
```
...
- `target/cybrid-api-bank-java-v0.112.35.jar`
- `target/lib/*.jar`
