...
- Build date: 2024-11-07T20:51:28.025169Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.38"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.38.jar`
- `target/lib/*.jar`
