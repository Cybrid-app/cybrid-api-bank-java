...
- Build date: 2025-06-05T14:22:25.929837Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.554"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.554.jar`
- `target/lib/*.jar`
