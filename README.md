...
- Build date: 2023-06-19T17:58:30.926451Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.28.jar`
- `target/lib/*.jar`
