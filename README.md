...
- Build date: 2024-12-10T16:14:08.472858Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.70"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.70.jar`
- `target/lib/*.jar`
