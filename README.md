...
- Build date: 2025-04-14T13:31:37.841801Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.383"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.383.jar`
- `target/lib/*.jar`
