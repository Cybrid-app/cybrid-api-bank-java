...
- Build date: 2025-02-05T22:17:03.726631Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.213"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.213.jar`
- `target/lib/*.jar`
