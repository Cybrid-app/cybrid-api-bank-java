...
- Build date: 2024-02-28T03:37:00.381964Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.24"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.24.jar`
- `target/lib/*.jar`
