...
- Build date: 2023-05-19T11:36:10.977396Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.28"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.28.jar`
- `target/lib/*.jar`
