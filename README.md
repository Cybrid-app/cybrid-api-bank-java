...
- Build date: 2024-11-08T18:34:44.311924Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.47"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.47.jar`
- `target/lib/*.jar`
