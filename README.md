...
- Build date: 2025-02-21T19:11:15.180796Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.246"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.246.jar`
- `target/lib/*.jar`
