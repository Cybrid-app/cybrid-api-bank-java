...
- Build date: 2024-07-04T17:11:46.634468Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.65"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.65.jar`
- `target/lib/*.jar`
