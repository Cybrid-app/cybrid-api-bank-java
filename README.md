...
- Build date: 2024-06-26T17:43:45.435275Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.48"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.48.jar`
- `target/lib/*.jar`
