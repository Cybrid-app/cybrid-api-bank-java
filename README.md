...
- Build date: 2024-05-21T22:26:51.626539Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.2.jar`
- `target/lib/*.jar`
