...
- Build date: 2023-07-19T14:26:36.770736Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.79.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.79.3.jar`
- `target/lib/*.jar`
