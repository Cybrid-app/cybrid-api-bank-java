...
- Build date: 2025-03-18T15:01:29.065648Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.306"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.306.jar`
- `target/lib/*.jar`
