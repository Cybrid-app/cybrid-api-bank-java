...
- Build date: 2025-06-19T20:27:25.670163Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.612"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.612.jar`
- `target/lib/*.jar`
