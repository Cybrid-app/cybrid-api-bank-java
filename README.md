...
- Build date: 2024-01-05T20:28:02.110270Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.53"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.53.jar`
- `target/lib/*.jar`
