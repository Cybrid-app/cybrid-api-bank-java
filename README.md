...
- Build date: 2023-06-09T12:22:12.509580Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.73.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.73.6.jar`
- `target/lib/*.jar`
