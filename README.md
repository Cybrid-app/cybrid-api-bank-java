...
- Build date: 2024-08-19T13:39:50.510113Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.30.jar`
- `target/lib/*.jar`
