...
- Build date: 2024-04-08T12:47:47.590715Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.65"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.65.jar`
- `target/lib/*.jar`
