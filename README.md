...
- Build date: 2022-06-08T16:15:59.418182Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.23.1"
  }
```
...
- `target/cybrid-api-bank-java-v0.23.1.jar`
- `target/lib/*.jar`
