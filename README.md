...
- Build date: 2024-05-27T13:19:16.308194Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.15"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.15.jar`
- `target/lib/*.jar`
