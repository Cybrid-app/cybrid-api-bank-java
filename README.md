...
- Build date: 2025-05-08T22:27:00.929812Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.468"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.468.jar`
- `target/lib/*.jar`
