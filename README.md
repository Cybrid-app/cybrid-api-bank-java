...
- Build date: 2024-01-12T14:32:44.615160Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.113.62"
  }
```
...
- `target/cybrid-api-bank-java-v0.113.62.jar`
- `target/lib/*.jar`
