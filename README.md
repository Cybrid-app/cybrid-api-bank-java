...
- Build date: 2024-08-02T19:38:26.161872Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.120"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.120.jar`
- `target/lib/*.jar`
