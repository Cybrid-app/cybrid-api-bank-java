...
- Build date: 2024-05-09T21:53:59.110742Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.147"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.147.jar`
- `target/lib/*.jar`
