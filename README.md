...
- Build date: 2023-10-12T12:31:43.502149Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.104.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.104.2.jar`
- `target/lib/*.jar`
