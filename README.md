...
- Build date: 2024-07-18T15:05:25.862816Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.85"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.85.jar`
- `target/lib/*.jar`
