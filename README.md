...
- Build date: 2024-10-30T13:07:43.923487Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.2.jar`
- `target/lib/*.jar`
