...
- Build date: 2024-05-21T14:24:24.449237Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.116.9"
  }
```
...
- `target/cybrid-api-bank-java-v0.116.9.jar`
- `target/lib/*.jar`
