...
- Build date: 2024-03-03T23:05:50.718323Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.114.34"
  }
```
...
- `target/cybrid-api-bank-java-v0.114.34.jar`
- `target/lib/*.jar`
