...
- Build date: 2025-06-09T15:42:07.446276Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.563"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.563.jar`
- `target/lib/*.jar`
