...
- Build date: 2025-04-11T21:59:31.868838Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.381"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.381.jar`
- `target/lib/*.jar`
