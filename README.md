...
- Build date: 2025-03-03T16:38:47.490054Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.268"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.268.jar`
- `target/lib/*.jar`
