...
- Build date: 2022-05-10T12:56:51.193910Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.6.12"
  }
```
...
- `target/cybrid-api-bank-java-v0.6.12.jar`
- `target/lib/*.jar`
