...
- Build date: 2023-08-21T19:18:24.897355Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.85.5"
  }
```
...
- `target/cybrid-api-bank-java-v0.85.5.jar`
- `target/lib/*.jar`
