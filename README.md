...
- Build date: 2025-03-26T19:37:50.858262Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.330"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.330.jar`
- `target/lib/*.jar`
