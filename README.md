...
- Build date: 2022-05-25T10:30:14.498022Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.14.10"
  }
```
...
- `target/cybrid-api-bank-java-v0.14.10.jar`
- `target/lib/*.jar`
