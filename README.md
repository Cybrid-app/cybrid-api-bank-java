...
- Build date: 2025-04-23T10:38:00.466353Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.413"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.413.jar`
- `target/lib/*.jar`
