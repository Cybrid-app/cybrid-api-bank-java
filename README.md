...
- Build date: 2025-02-21T22:50:23.002795Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.247"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.247.jar`
- `target/lib/*.jar`
