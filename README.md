...
- Build date: 2023-05-23T21:39:21.729161Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.71.35"
  }
```
...
- `target/cybrid-api-bank-java-v0.71.35.jar`
- `target/lib/*.jar`
