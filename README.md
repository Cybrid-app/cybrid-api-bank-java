...
- Build date: 2024-09-26T17:32:25.328606Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.144"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.144.jar`
- `target/lib/*.jar`
