...
- Build date: 2024-09-20T14:19:43.799593Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.123"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.123.jar`
- `target/lib/*.jar`
