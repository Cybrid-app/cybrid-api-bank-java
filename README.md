...
- Build date: 2023-10-26T19:51:42.850263Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.109.23"
  }
```
...
- `target/cybrid-api-bank-java-v0.109.23.jar`
- `target/lib/*.jar`
