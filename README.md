...
- Build date: 2024-09-27T18:00:27.017125Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.146"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.146.jar`
- `target/lib/*.jar`
