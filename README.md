...
- Build date: 2025-03-06T16:09:31.940336Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.275"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.275.jar`
- `target/lib/*.jar`
