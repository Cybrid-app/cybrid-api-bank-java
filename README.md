...
- Build date: 2025-05-12T13:59:07.695083Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.475"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.475.jar`
- `target/lib/*.jar`
