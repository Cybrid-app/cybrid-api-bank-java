...
- Build date: 2024-10-08T23:38:11.902490Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.120.13"
  }
```
...
- `target/cybrid-api-bank-java-v0.120.13.jar`
- `target/lib/*.jar`
