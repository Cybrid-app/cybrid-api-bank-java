...
- Build date: 2023-08-23T20:03:01.093240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.86.6"
  }
```
...
- `target/cybrid-api-bank-java-v0.86.6.jar`
- `target/lib/*.jar`
