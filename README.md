...
- Build date: 2024-05-31T13:40:40.441760Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.117.22"
  }
```
...
- `target/cybrid-api-bank-java-v0.117.22.jar`
- `target/lib/*.jar`
