...
- Build date: 2024-04-09T12:24:50.980872Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.69"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.69.jar`
- `target/lib/*.jar`
