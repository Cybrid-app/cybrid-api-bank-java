...
- Build date: 2024-11-08T23:05:21.414626Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.51"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.51.jar`
- `target/lib/*.jar`
