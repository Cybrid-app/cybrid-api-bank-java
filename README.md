...
- Build date: 2024-09-09T17:44:25.963905Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.76"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.76.jar`
- `target/lib/*.jar`
