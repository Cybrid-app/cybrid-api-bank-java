...
- Build date: 2024-09-13T14:54:18.344331Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.94"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.94.jar`
- `target/lib/*.jar`
