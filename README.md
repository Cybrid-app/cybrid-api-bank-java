...
- Build date: 2024-12-13T15:47:37.802513Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.86"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.86.jar`
- `target/lib/*.jar`
