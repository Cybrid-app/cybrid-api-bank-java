...
- Build date: 2024-07-02T17:37:02.533048Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.56"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.56.jar`
- `target/lib/*.jar`
