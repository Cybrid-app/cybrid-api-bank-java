...
- Build date: 2023-07-12T12:43:25.330514Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.78.3"
  }
```
...
- `target/cybrid-api-bank-java-v0.78.3.jar`
- `target/lib/*.jar`
