...
- Build date: 2024-09-12T13:46:02.937051Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.86"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.86.jar`
- `target/lib/*.jar`
