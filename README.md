...
- Build date: 2024-06-11T18:43:05.352561Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.16"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.16.jar`
- `target/lib/*.jar`
