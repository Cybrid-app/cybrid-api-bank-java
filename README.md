...
- Build date: 2023-06-27T14:34:19.082754Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.74.14"
  }
```
...
- `target/cybrid-api-bank-java-v0.74.14.jar`
- `target/lib/*.jar`
