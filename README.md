...
- Build date: 2024-05-20T14:30:48.566218Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.116.7"
  }
```
...
- `target/cybrid-api-bank-java-v0.116.7.jar`
- `target/lib/*.jar`
