...
- Build date: 2024-10-21T15:34:59.042736Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.121.30"
  }
```
...
- `target/cybrid-api-bank-java-v0.121.30.jar`
- `target/lib/*.jar`
