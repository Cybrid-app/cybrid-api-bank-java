...
- Build date: 2024-04-10T13:01:00.840913Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.115.75"
  }
```
...
- `target/cybrid-api-bank-java-v0.115.75.jar`
- `target/lib/*.jar`
