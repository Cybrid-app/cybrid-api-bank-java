...
- Build date: 2025-02-26T01:44:38.033368Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.258"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.258.jar`
- `target/lib/*.jar`
