...
- Build date: 2024-09-06T17:01:33.891878Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.71"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.71.jar`
- `target/lib/*.jar`
