...
- Build date: 2024-10-04T15:38:28.092971Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.119.171"
  }
```
...
- `target/cybrid-api-bank-java-v0.119.171.jar`
- `target/lib/*.jar`
