...
- Build date: 2024-12-10T20:49:07.766254Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.74"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.74.jar`
- `target/lib/*.jar`
