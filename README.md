...
- Build date: 2023-04-13T16:29:26.523254Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.68.43"
  }
```
...
- `target/cybrid-api-bank-java-v0.68.43.jar`
- `target/lib/*.jar`
