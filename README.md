...
- Build date: 2024-07-04T19:54:08.703247Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.118.66"
  }
```
...
- `target/cybrid-api-bank-java-v0.118.66.jar`
- `target/lib/*.jar`
