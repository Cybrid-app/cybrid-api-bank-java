...
- Build date: 2022-06-14T14:26:00.575536Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.25.2"
  }
```
...
- `target/cybrid-api-bank-java-v0.25.2.jar`
- `target/lib/*.jar`
