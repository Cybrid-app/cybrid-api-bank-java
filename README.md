...
- Build date: 2025-03-28T12:11:13.637892Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.123.335"
  }
```
...
- `target/cybrid-api-bank-java-v0.123.335.jar`
- `target/lib/*.jar`
