...
- Build date: 2024-11-11T15:44:57.973963Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-bank-java:v0.122.54"
  }
```
...
- `target/cybrid-api-bank-java-v0.122.54.jar`
- `target/lib/*.jar`
