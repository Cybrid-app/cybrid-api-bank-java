...
> ExternalBankAccountListBankModel listExternalBankAccounts(page, perPage, guid, bankGuid, customerGuid)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ExternalBankAccountListBankModel result = apiInstance.listExternalBankAccounts(page, perPage, guid, bankGuid, customerGuid);
            System.out.println(result);
        } catch (ApiException e) {
