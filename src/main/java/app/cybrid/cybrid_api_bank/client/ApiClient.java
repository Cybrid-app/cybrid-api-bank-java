...
import app.cybrid.cybrid_api_bank.client.auth.Authentication;
import app.cybrid.cybrid_api_bank.client.auth.HttpBasicAuth;
import app.cybrid.cybrid_api_bank.client.auth.HttpBearerAuth;
import app.cybrid.cybrid_api_bank.client.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://bank.sandbox.cybrid.app";
