...
public class CounterpartiesBankApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec listCounterpartiesRequestCreation(java.math.BigInteger page, java.math.BigInteger perPage, String bankGuid, String customerGuid, String guid, String label) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<CounterpartyListBankModel> listCounterparties(java.math.BigInteger page, java.math.BigInteger perPage, String bankGuid, String customerGuid, String guid, String label) throws WebClientResponseException {
        ParameterizedTypeReference<CounterpartyListBankModel> localVarReturnType = new ParameterizedTypeReference<CounterpartyListBankModel>() {};
        return listCounterpartiesRequestCreation(page, perPage, bankGuid, customerGuid, guid, label).bodyToMono(localVarReturnType);
    }

    public Mono<ResponseEntity<CounterpartyListBankModel>> listCounterpartiesWithHttpInfo(java.math.BigInteger page, java.math.BigInteger perPage, String bankGuid, String customerGuid, String guid, String label) throws WebClientResponseException {
        ParameterizedTypeReference<CounterpartyListBankModel> localVarReturnType = new ParameterizedTypeReference<CounterpartyListBankModel>() {};
        return listCounterpartiesRequestCreation(page, perPage, bankGuid, customerGuid, guid, label).toEntity(localVarReturnType);
    }
}
