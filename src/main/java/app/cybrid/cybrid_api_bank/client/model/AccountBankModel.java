...
@JsonPropertyOrder({
  ...
  AccountBankModel.JSON_PROPERTY_UPDATED_AT,
  ...
  AccountBankModel.JSON_PROPERTY_STATE,
  AccountBankModel.JSON_PROPERTY_LABELS
})
...
public class AccountBankModel {
  ...
  public AccountBankModel type(String type) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The account type; one of trading, fee, fiat, gas, reserve, invoice_operations, or storage.")
  ...
  **/
  ...
  public AccountBankModel updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public AccountBankModel state(String state) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The state of the account; one of storing or created.")
  ...
  public AccountBankModel labels(List<String> labels) {
    this.labels = JsonNullable.<List<String>>of(labels);
    
    return this;
  }

  public AccountBankModel addLabelsItem(String labelsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, account.type) &&
        ...
        equalsNullable(this.labels, account.labels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, guid, createdAt, updatedAt, asset, name, bankGuid, customerGuid, platformBalance, platformAvailable, state, hashCodeNullable(labels));
  }
