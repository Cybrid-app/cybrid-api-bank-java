 ...
 */
@JsonPropertyOrder({
  ActivityLimitBankModel.JSON_PROPERTY_TYPE,
  ActivityLimitBankModel.JSON_PROPERTY_NAME,
  ActivityLimitBankModel.JSON_PROPERTY_ASSET,
  ActivityLimitBankModel.JSON_PROPERTY_AMOUNT,
  ActivityLimitBankModel.JSON_PROPERTY_INTERVAL,
  ActivityLimitBankModel.JSON_PROPERTY_ACTIVITIES,
  ActivityLimitBankModel.JSON_PROPERTY_SIDES
})
...
public class ActivityLimitBankModel {
  ...
  private JsonNullable<java.math.BigInteger> interval = JsonNullable.<java.math.BigInteger>undefined();
  ...
  **/
  ...
  public ActivityLimitBankModel amount(java.math.BigInteger amount) {
  ...
  **/
  ...
  public ActivityLimitBankModel interval(java.math.BigInteger interval) {
    this.interval = JsonNullable.<java.math.BigInteger>of(interval);
  ...
  **/
  ...
  public JsonNullable<java.math.BigInteger> getInterval_JsonNullable() {
    return interval;
  }
  
  @JsonProperty(JSON_PROPERTY_INTERVAL)
  public void setInterval_JsonNullable(JsonNullable<java.math.BigInteger> interval) {
    this.interval = interval;
  }

  public void setInterval(java.math.BigInteger interval) {
    this.interval = JsonNullable.<java.math.BigInteger>of(interval);
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, activityLimit.type) &&
        Objects.equals(this.name, activityLimit.name) &&
        Objects.equals(this.asset, activityLimit.asset) &&
        Objects.equals(this.amount, activityLimit.amount) &&
        equalsNullable(this.interval, activityLimit.interval) &&
        Objects.equals(this.activities, activityLimit.activities) &&
        Objects.equals(this.sides, activityLimit.sides);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, asset, amount, hashCodeNullable(interval), activities, sides);
  }
