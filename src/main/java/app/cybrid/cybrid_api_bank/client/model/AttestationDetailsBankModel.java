 ...
 */
@JsonPropertyOrder({
  AttestationDetailsBankModel.JSON_PROPERTY_STATE,
  AttestationDetailsBankModel.JSON_PROPERTY_FAILURE_CODE
})
@JsonTypeName("AttestationDetails")
...
public class AttestationDetailsBankModel {
  ...
  public AttestationDetailsBankModel() { 
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.state, attestationDetails.state) &&
        Objects.equals(this.failureCode, attestationDetails.failureCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(state, failureCode);
  }
