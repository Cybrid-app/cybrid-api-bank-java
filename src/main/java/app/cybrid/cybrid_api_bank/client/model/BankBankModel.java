...
@JsonPropertyOrder({
  ...
  BankBankModel.JSON_PROPERTY_ROUTABLE_ACCOUNTS,
...
public class BankBankModel {
  ...
  private String routableAccounts;
  ...
  **/
  ...
  public BankBankModel routableAccounts(String routableAccounts) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Configuration for supporting creating routable bank accounts: one of unsupported, bank, or customer.")
  @JsonProperty(JSON_PROPERTY_ROUTABLE_ACCOUNTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getRoutableAccounts() {
    return routableAccounts;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROUTABLE_ACCOUNTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRoutableAccounts(String routableAccounts) {
    this.routableAccounts = routableAccounts;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, bank.guid) &&
        ...
        Objects.equals(this.routableAccounts, bank.routableAccounts) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, organizationGuid, name, type, supportedTradingSymbols, supportedFiatAccountAssets, supportedCountryCodes, features, routableAccounts, createdAt, updatedAt);
  }
