...
public class BankBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, organizationGuid, name, type, supportedTradingSymbols, supportedFiatAccountAssets, supportedCountryCodes, features, routableAccounts, createdAt);
  }
