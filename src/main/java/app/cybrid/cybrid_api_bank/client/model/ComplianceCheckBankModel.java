 ...
 */
@JsonPropertyOrder({
  ComplianceCheckBankModel.JSON_PROPERTY_TYPE,
  ComplianceCheckBankModel.JSON_PROPERTY_OUTCOME,
  ComplianceCheckBankModel.JSON_PROPERTY_FAILURE_CODES
})
...
public class ComplianceCheckBankModel {
  ...
  **/
  ...
  @ApiModelProperty(value = "The outcome of the compliance check; one of passed, failed, or inconclusive.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, complianceCheck.type) &&
        Objects.equals(this.outcome, complianceCheck.outcome) &&
        Objects.equals(this.failureCodes, complianceCheck.failureCodes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, outcome, failureCodes);
  }
