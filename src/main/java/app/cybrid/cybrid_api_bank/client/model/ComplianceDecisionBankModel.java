 ...
 */
@JsonPropertyOrder({
  ComplianceDecisionBankModel.JSON_PROPERTY_TYPE,
  ComplianceDecisionBankModel.JSON_PROPERTY_STATE,
  ComplianceDecisionBankModel.JSON_PROPERTY_FAILURE_CODES
})
@JsonTypeName("ComplianceDecision")
...
public class ComplianceDecisionBankModel {
  ...
  public ComplianceDecisionBankModel() { 
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ComplianceDecisionBankModel complianceDecision = (ComplianceDecisionBankModel) o;
    return Objects.equals(this.type, complianceDecision.type) &&
        Objects.equals(this.state, complianceDecision.state) &&
        equalsNullable(this.failureCodes, complianceDecision.failureCodes);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, state, hashCodeNullable(failureCodes));
  }
  ...
  public String toString() {
    ...
    sb.append("class ComplianceDecisionBankModel {\n");
