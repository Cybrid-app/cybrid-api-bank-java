...
public class CounterpartyAddressBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.street, counterpartyAddress.street) &&
        equalsNullable(this.street2, counterpartyAddress.street2) &&
        equalsNullable(this.city, counterpartyAddress.city) &&
        equalsNullable(this.subdivision, counterpartyAddress.subdivision) &&
        equalsNullable(this.postalCode, counterpartyAddress.postalCode) &&
