...
public class CounterpartyAliasesInnerBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.first, counterpartyAliasesInner.first) &&
        equalsNullable(this.middle, counterpartyAliasesInner.middle) &&
        equalsNullable(this.last, counterpartyAliasesInner.last) &&
        equalsNullable(this.full, counterpartyAliasesInner.full);
  }
