...
@JsonPropertyOrder({
  ...
  CounterpartyBankModel.JSON_PROPERTY_VERIFICATION_CHECKS
})
...
public class CounterpartyBankModel {
  ...
  **/
  ...
  public CounterpartyBankModel verificationChecks(List<VerificationCheckBankModel> verificationChecks) {
    
    this.verificationChecks = verificationChecks;
    return this;
  }

  public CounterpartyBankModel addVerificationChecksItem(VerificationCheckBankModel verificationChecksItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The verification checks associated with the customer.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, counterparty.guid) &&
        ...
        Objects.equals(this.customerGuid, counterparty.customerGuid) &&
        ...
        Objects.equals(this.address, counterparty.address) &&
        Objects.equals(this.aliases, counterparty.aliases) &&
        Objects.equals(this.dateOfBirth, counterparty.dateOfBirth) &&
        Objects.equals(this.labels, counterparty.labels) &&
        Objects.equals(this.verificationChecks, counterparty.verificationChecks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(guid, type, bankGuid, customerGuid, createdAt, updatedAt, state, name, address, aliases, dateOfBirth, labels, verificationChecks);
  }
