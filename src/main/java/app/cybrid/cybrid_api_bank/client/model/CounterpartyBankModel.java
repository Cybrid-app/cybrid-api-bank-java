...
public class CounterpartyBankModel {
  ...
  **/
  ...
  public CounterpartyBankModel verificationChecks(List<ComplianceDecisionBankModel> verificationChecks) {
    
    this.verificationChecks = verificationChecks;
    return this;
  }

  public CounterpartyBankModel addVerificationChecksItem(ComplianceDecisionBankModel verificationChecksItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, type, bankGuid, customerGuid, createdAt, updatedAt, state, name, address, aliases, dateOfBirth, labels, complianceDecisions, verificationChecks);
  }
