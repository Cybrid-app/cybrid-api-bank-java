...
public class CounterpartyNameBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.first, counterpartyName.first) &&
        equalsNullable(this.middle, counterpartyName.middle) &&
        equalsNullable(this.last, counterpartyName.last) &&
        equalsNullable(this.full, counterpartyName.full);
  }
