 ...
 */
@ApiModel(description = "The customer's address. Only available for GET operations when 'include_pii' is set.")
@JsonPropertyOrder({
...
public class CustomerAddressBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.street, customerAddress.street) &&
        equalsNullable(this.street2, customerAddress.street2) &&
        equalsNullable(this.city, customerAddress.city) &&
        equalsNullable(this.subdivision, customerAddress.subdivision) &&
        equalsNullable(this.postalCode, customerAddress.postalCode) &&
        equalsNullable(this.countryCode, customerAddress.countryCode);
  }
