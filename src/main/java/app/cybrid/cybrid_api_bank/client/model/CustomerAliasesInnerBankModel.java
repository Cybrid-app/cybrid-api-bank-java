...
public class CustomerAliasesInnerBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.first, customerAliasesInner.first) &&
        equalsNullable(this.middle, customerAliasesInner.middle) &&
        equalsNullable(this.last, customerAliasesInner.last) &&
        equalsNullable(this.full, customerAliasesInner.full);
  }
