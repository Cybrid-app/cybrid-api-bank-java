...
@JsonPropertyOrder({
  ...
  CustomerBankModel.JSON_PROPERTY_VERIFICATION_CHECKS
})
...
public class CustomerBankModel {
  ...
  **/
  ...
  public CustomerBankModel type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The customer's type.")
  ...
  **/
  ...
  public CustomerBankModel state(StateEnum state) {
  ...
  **/
  ...
  public CustomerBankModel verificationChecks(List<VerificationCheckBankModel> verificationChecks) {
    
    this.verificationChecks = verificationChecks;
    return this;
  }

  public CustomerBankModel addVerificationChecksItem(VerificationCheckBankModel verificationChecksItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, customer.guid) &&
        ...
        Objects.equals(this.labels, customer.labels) &&
        Objects.equals(this.verificationChecks, customer.verificationChecks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(guid, bankGuid, type, createdAt, updatedAt, state, name, address, dateOfBirth, phoneNumber, emailAddress, labels, verificationChecks);
  }
