...
@JsonPropertyOrder({
  ...
  CustomerBankModel.JSON_PROPERTY_CUSTOMER_TYPE,
...
public class CustomerBankModel {
  ...
  **/
  ...
  public CustomerBankModel customerType(CustomerTypeEnum customerType) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, customerType, createdAt);
  }
