...
public class CustomerBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, bankGuid, type, createdAt, updatedAt, state, name, address, aliases, website, dateOfBirth, phoneNumber, emailAddress, labels, complianceDecisions);
  }
