 ...
 */
@ApiModel(description = "The customer's name. Only available for GET operations when 'include_pii' is set.")
@JsonPropertyOrder({
  ...
  CustomerNameBankModel.JSON_PROPERTY_FULL
})
...
public class CustomerNameBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.first, customerName.first) &&
        equalsNullable(this.middle, customerName.middle) &&
        equalsNullable(this.last, customerName.last) &&
        equalsNullable(this.full, customerName.full);
  }
