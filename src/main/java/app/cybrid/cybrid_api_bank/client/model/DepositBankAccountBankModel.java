...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-12-13T22:21:23.274970Z[Etc/UTC]")
public class DepositBankAccountBankModel {
  ...
  **/
  ...
  public DepositBankAccountBankModel state(StateEnum state) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The state of the address.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, bankGuid, customerGuid, accountGuid, createdAt, updatedAt, asset, state, uniqueMemoId, counterpartyName, counterpartyAddress, accountDetails, routingDetails, labels);
  }
