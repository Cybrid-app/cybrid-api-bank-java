...
import app.cybrid.cybrid_api_bank.client.model.DepositBankAccountAccountDetailsInnerBankModel;
import app.cybrid.cybrid_api_bank.client.model.DepositBankAccountCounterpartyAddressBankModel;
import app.cybrid.cybrid_api_bank.client.model.DepositBankAccountRoutingDetailsInnerBankModel;
 ...
 */
@JsonPropertyOrder({
  DepositBankAccountBankModel.JSON_PROPERTY_GUID,
  DepositBankAccountBankModel.JSON_PROPERTY_TYPE,
  DepositBankAccountBankModel.JSON_PROPERTY_BANK_GUID,
  DepositBankAccountBankModel.JSON_PROPERTY_CUSTOMER_GUID,
  DepositBankAccountBankModel.JSON_PROPERTY_ACCOUNT_GUID,
  DepositBankAccountBankModel.JSON_PROPERTY_CREATED_AT,
  DepositBankAccountBankModel.JSON_PROPERTY_UPDATED_AT,
  DepositBankAccountBankModel.JSON_PROPERTY_ASSET,
  DepositBankAccountBankModel.JSON_PROPERTY_STATE,
  DepositBankAccountBankModel.JSON_PROPERTY_UNIQUE_MEMO_ID,
  DepositBankAccountBankModel.JSON_PROPERTY_COUNTERPARTY_NAME,
  DepositBankAccountBankModel.JSON_PROPERTY_COUNTERPARTY_ADDRESS,
  DepositBankAccountBankModel.JSON_PROPERTY_ACCOUNT_DETAILS,
  DepositBankAccountBankModel.JSON_PROPERTY_ROUTING_DETAILS,
  DepositBankAccountBankModel.JSON_PROPERTY_PARENT_DEPOSIT_BANK_ACCOUNT_GUID,
  DepositBankAccountBankModel.JSON_PROPERTY_LABELS
})
@JsonTypeName("DepositBankAccount")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-05-20T16:27:29.030026Z[Etc/UTC]")
public class DepositBankAccountBankModel {
  ...
  public static final String JSON_PROPERTY_UNIQUE_MEMO_ID = "unique_memo_id";
  private String uniqueMemoId;

  public static final String JSON_PROPERTY_COUNTERPARTY_NAME = "counterparty_name";
  private JsonNullable<String> counterpartyName = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_COUNTERPARTY_ADDRESS = "counterparty_address";
  private JsonNullable<DepositBankAccountCounterpartyAddressBankModel> counterpartyAddress = JsonNullable.<DepositBankAccountCounterpartyAddressBankModel>undefined();

  public static final String JSON_PROPERTY_ACCOUNT_DETAILS = "account_details";
  private JsonNullable<List<DepositBankAccountAccountDetailsInnerBankModel>> accountDetails = JsonNullable.<List<DepositBankAccountAccountDetailsInnerBankModel>>undefined();

  public static final String JSON_PROPERTY_ROUTING_DETAILS = "routing_details";
  private JsonNullable<List<DepositBankAccountRoutingDetailsInnerBankModel>> routingDetails = JsonNullable.<List<DepositBankAccountRoutingDetailsInnerBankModel>>undefined();

  public static final String JSON_PROPERTY_PARENT_DEPOSIT_BANK_ACCOUNT_GUID = "parent_deposit_bank_account_guid";
  private JsonNullable<String> parentDepositBankAccountGuid = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_LABELS = "labels";
  private JsonNullable<List<String>> labels = JsonNullable.<List<String>>undefined();

  public DepositBankAccountBankModel() { 
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account type; one of main or sub_account.")
  ...
  **/
  ...
  public DepositBankAccountBankModel uniqueMemoId(String uniqueMemoId) {
    ...
    this.uniqueMemoId = uniqueMemoId;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique memo identifier for the address. This is used to identify the recipient when sending funds to the account. This value MUST be included in all wire transfers to this account.")
  @JsonProperty(JSON_PROPERTY_UNIQUE_MEMO_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getUniqueMemoId() {
    return uniqueMemoId;
  }
  ...
  public DepositBankAccountBankModel counterpartyName(String counterpartyName) {
    this.counterpartyName = JsonNullable.<String>of(counterpartyName);
  ...
  **/
  ...
  public JsonNullable<String> getCounterpartyName_JsonNullable() {
    return counterpartyName;
  }
  
  @JsonProperty(JSON_PROPERTY_COUNTERPARTY_NAME)
  public void setCounterpartyName_JsonNullable(JsonNullable<String> counterpartyName) {
  ...
  public DepositBankAccountBankModel counterpartyAddress(DepositBankAccountCounterpartyAddressBankModel counterpartyAddress) {
    this.counterpartyAddress = JsonNullable.<DepositBankAccountCounterpartyAddressBankModel>of(counterpartyAddress);
  ...
  **/
  ...
  public DepositBankAccountCounterpartyAddressBankModel getCounterpartyAddress() {
  ...
  public JsonNullable<DepositBankAccountCounterpartyAddressBankModel> getCounterpartyAddress_JsonNullable() {
    return counterpartyAddress;
  }
  
  @JsonProperty(JSON_PROPERTY_COUNTERPARTY_ADDRESS)
  public void setCounterpartyAddress_JsonNullable(JsonNullable<DepositBankAccountCounterpartyAddressBankModel> counterpartyAddress) {
  ...
  public DepositBankAccountBankModel accountDetails(List<DepositBankAccountAccountDetailsInnerBankModel> accountDetails) {
    this.accountDetails = JsonNullable.<List<DepositBankAccountAccountDetailsInnerBankModel>>of(accountDetails);
  ...
  public DepositBankAccountBankModel addAccountDetailsItem(DepositBankAccountAccountDetailsInnerBankModel accountDetailsItem) {
    if (this.accountDetails == null || !this.accountDetails.isPresent()) {
      this.accountDetails = JsonNullable.<List<DepositBankAccountAccountDetailsInnerBankModel>>of(new ArrayList<>());
    }
    try {
      this.accountDetails.get().add(accountDetailsItem);
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account details for the bank account.")
  @JsonIgnore

  public List<DepositBankAccountAccountDetailsInnerBankModel> getAccountDetails() {
  ...
  public JsonNullable<List<DepositBankAccountAccountDetailsInnerBankModel>> getAccountDetails_JsonNullable() {
    return accountDetails;
  }
  
  @JsonProperty(JSON_PROPERTY_ACCOUNT_DETAILS)
  public void setAccountDetails_JsonNullable(JsonNullable<List<DepositBankAccountAccountDetailsInnerBankModel>> accountDetails) {
  ...
  public DepositBankAccountBankModel routingDetails(List<DepositBankAccountRoutingDetailsInnerBankModel> routingDetails) {
    this.routingDetails = JsonNullable.<List<DepositBankAccountRoutingDetailsInnerBankModel>>of(routingDetails);
  ...
  public DepositBankAccountBankModel addRoutingDetailsItem(DepositBankAccountRoutingDetailsInnerBankModel routingDetailsItem) {
    if (this.routingDetails == null || !this.routingDetails.isPresent()) {
      this.routingDetails = JsonNullable.<List<DepositBankAccountRoutingDetailsInnerBankModel>>of(new ArrayList<>());
    }
    try {
      this.routingDetails.get().add(routingDetailsItem);
    } catch (java.util.NoSuchElementException e) {
      // this can never happen, as we make sure above that the value is present
    }
    return this;
  ...
  **/
  ...
  public List<DepositBankAccountRoutingDetailsInnerBankModel> getRoutingDetails() {
        return routingDetails.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_ROUTING_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<List<DepositBankAccountRoutingDetailsInnerBankModel>> getRoutingDetails_JsonNullable() {
    return routingDetails;
  }
  
  @JsonProperty(JSON_PROPERTY_ROUTING_DETAILS)
  public void setRoutingDetails_JsonNullable(JsonNullable<List<DepositBankAccountRoutingDetailsInnerBankModel>> routingDetails) {
  ...
  public DepositBankAccountBankModel parentDepositBankAccountGuid(String parentDepositBankAccountGuid) {
    this.parentDepositBankAccountGuid = JsonNullable.<String>of(parentDepositBankAccountGuid);
   ...
   * @return parentDepositBankAccountGuid
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique identifier for the bank-level deposit bank account. This is only set for sub-accounts.")
  @JsonIgnore

  public String getParentDepositBankAccountGuid() {
        return parentDepositBankAccountGuid.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_PARENT_DEPOSIT_BANK_ACCOUNT_GUID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DepositBankAccountBankModel depositBankAccount = (DepositBankAccountBankModel) o;
    return Objects.equals(this.guid, depositBankAccount.guid) &&
        Objects.equals(this.type, depositBankAccount.type) &&
        Objects.equals(this.bankGuid, depositBankAccount.bankGuid) &&
        equalsNullable(this.customerGuid, depositBankAccount.customerGuid) &&
        Objects.equals(this.accountGuid, depositBankAccount.accountGuid) &&
        Objects.equals(this.createdAt, depositBankAccount.createdAt) &&
        Objects.equals(this.updatedAt, depositBankAccount.updatedAt) &&
        Objects.equals(this.asset, depositBankAccount.asset) &&
        Objects.equals(this.state, depositBankAccount.state) &&
        Objects.equals(this.uniqueMemoId, depositBankAccount.uniqueMemoId) &&
        equalsNullable(this.counterpartyName, depositBankAccount.counterpartyName) &&
        equalsNullable(this.counterpartyAddress, depositBankAccount.counterpartyAddress) &&
        equalsNullable(this.accountDetails, depositBankAccount.accountDetails) &&
        equalsNullable(this.routingDetails, depositBankAccount.routingDetails) &&
        equalsNullable(this.parentDepositBankAccountGuid, depositBankAccount.parentDepositBankAccountGuid) &&
        equalsNullable(this.labels, depositBankAccount.labels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, type, bankGuid, hashCodeNullable(customerGuid), accountGuid, createdAt, updatedAt, asset, state, uniqueMemoId, hashCodeNullable(counterpartyName), hashCodeNullable(counterpartyAddress), hashCodeNullable(accountDetails), hashCodeNullable(routingDetails), hashCodeNullable(parentDepositBankAccountGuid), hashCodeNullable(labels));
  }
  ...
  public String toString() {
    ...
    sb.append("class DepositBankAccountBankModel {\n");
    ...
    sb.append("    uniqueMemoId: ").append(toIndentedString(uniqueMemoId)).append("\n");
    ...
    sb.append("    parentDepositBankAccountGuid: ").append(toIndentedString(parentDepositBankAccountGuid)).append("\n");
