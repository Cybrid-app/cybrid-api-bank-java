...
public class DepositBankAccountRoutingDetailsInnerBankModel {
  ...
  public DepositBankAccountRoutingDetailsInnerBankModel routingNumberType(String routingNumberType) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The type of routing number; one of CPA, ABA, or SWIFT.")
