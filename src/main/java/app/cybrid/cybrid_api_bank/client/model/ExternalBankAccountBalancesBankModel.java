...
@JsonPropertyOrder({
  ExternalBankAccountBalancesBankModel.JSON_PROPERTY_AVAILABLE_BALANCE,
  ExternalBankAccountBalancesBankModel.JSON_PROPERTY_CURRENT_BALANCE
})
...
public class ExternalBankAccountBalancesBankModel {
  ...
  private java.math.BigInteger availableBalance;

  public static final String JSON_PROPERTY_CURRENT_BALANCE = "current_balance";
  private java.math.BigInteger currentBalance;

  public ExternalBankAccountBalancesBankModel() { 
  }

  public ExternalBankAccountBalancesBankModel availableBalance(java.math.BigInteger availableBalance) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AVAILABLE_BALANCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAvailableBalance(java.math.BigInteger availableBalance) {
    this.availableBalance = availableBalance;
  }


  public ExternalBankAccountBalancesBankModel currentBalance(java.math.BigInteger currentBalance) {
  ...
  **/
  ...
  public java.math.BigInteger getCurrentBalance() {
    return currentBalance;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CURRENT_BALANCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCurrentBalance(java.math.BigInteger currentBalance) {
    this.currentBalance = currentBalance;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availableBalance, externalBankAccountBalances.availableBalance) &&
        Objects.equals(this.currentBalance, externalBankAccountBalances.currentBalance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(availableBalance, currentBalance);
  }
