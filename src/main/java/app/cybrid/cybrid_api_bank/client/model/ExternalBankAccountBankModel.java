...
public class ExternalBankAccountBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, name, asset, accountKind, environment, bankGuid, customerGuid, createdAt, plaidInstitutionId, plaidAccountMask, plaidAccountName, state, failureCode);
  }
