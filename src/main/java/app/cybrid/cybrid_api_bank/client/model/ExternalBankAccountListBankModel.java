 ...
 */
@JsonPropertyOrder({
  ExternalBankAccountListBankModel.JSON_PROPERTY_TOTAL,
  ExternalBankAccountListBankModel.JSON_PROPERTY_PAGE,
  ExternalBankAccountListBankModel.JSON_PROPERTY_PER_PAGE,
  ExternalBankAccountListBankModel.JSON_PROPERTY_OBJECTS
})
@JsonTypeName("ExternalBankAccountList")
...
public class ExternalBankAccountListBankModel {
  ...
  private List<ExternalBankAccountBankModel> objects = new ArrayList<>();

  public ExternalBankAccountListBankModel() { 
  }

  public ExternalBankAccountListBankModel total(java.math.BigInteger total) {
  ...
  **/
  ...
  public ExternalBankAccountListBankModel page(java.math.BigInteger page) {
  ...
  **/
  ...
  public ExternalBankAccountListBankModel perPage(java.math.BigInteger perPage) {
  ...
  **/
  ...
  public ExternalBankAccountListBankModel objects(List<ExternalBankAccountBankModel> objects) {
    
    this.objects = objects;
    return this;
  }

  public ExternalBankAccountListBankModel addObjectsItem(ExternalBankAccountBankModel objectsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Array of external bank account entities")
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<ExternalBankAccountBankModel> getObjects() {
    return objects;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObjects(List<ExternalBankAccountBankModel> objects) {
    this.objects = objects;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExternalBankAccountListBankModel externalBankAccountList = (ExternalBankAccountListBankModel) o;
    return Objects.equals(this.total, externalBankAccountList.total) &&
        Objects.equals(this.page, externalBankAccountList.page) &&
        Objects.equals(this.perPage, externalBankAccountList.perPage) &&
        Objects.equals(this.objects, externalBankAccountList.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalBankAccountListBankModel {\n");
