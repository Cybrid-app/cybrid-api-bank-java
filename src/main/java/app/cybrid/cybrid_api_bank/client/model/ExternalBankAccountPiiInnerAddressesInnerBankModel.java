...
public class ExternalBankAccountPiiInnerAddressesInnerBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.street, externalBankAccountPiiInnerAddressesInner.street) &&
        equalsNullable(this.street2, externalBankAccountPiiInnerAddressesInner.street2) &&
        equalsNullable(this.city, externalBankAccountPiiInnerAddressesInner.city) &&
        equalsNullable(this.subdivision, externalBankAccountPiiInnerAddressesInner.subdivision) &&
        equalsNullable(this.postalCode, externalBankAccountPiiInnerAddressesInner.postalCode) &&
        equalsNullable(this.countryCode, externalBankAccountPiiInnerAddressesInner.countryCode);
  }
