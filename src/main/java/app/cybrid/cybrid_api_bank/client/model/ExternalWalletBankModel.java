...
public class ExternalWalletBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, name, asset, environment, bankGuid, hashCodeNullable(customerGuid), address, hashCodeNullable(tag), createdAt, updatedAt, state, hashCodeNullable(failureCode));
  }
