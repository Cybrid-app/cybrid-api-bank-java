...
public class ExternalWalletBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The environment that the wallet is configured for.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ISO8601 datetime the wallet was created at.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, name, asset, environment, bankGuid, customerGuid, address, tag, createdAt, state, failureCode);
  }
