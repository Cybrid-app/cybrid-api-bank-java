...
@JsonPropertyOrder({
  ...
  ExternalWalletBankModel.JSON_PROPERTY_COUNTERPARTY_GUID,
...
public class ExternalWalletBankModel {
  ...
  **/
  ...
  public ExternalWalletBankModel counterpartyGuid(String counterpartyGuid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, externalWallet.guid) &&
        ...
        equalsNullable(this.customerGuid, externalWallet.customerGuid) &&
        equalsNullable(this.counterpartyGuid, externalWallet.counterpartyGuid) &&
        Objects.equals(this.address, externalWallet.address) &&
        equalsNullable(this.tag, externalWallet.tag) &&
        ...
        equalsNullable(this.failureCode, externalWallet.failureCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, name, asset, environment, bankGuid, hashCodeNullable(customerGuid), hashCodeNullable(counterpartyGuid), address, hashCodeNullable(tag), createdAt, updatedAt, state, hashCodeNullable(failureCode));
  }
