...
public class IdentificationNumberBankModel {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The source of the identification number; one of drivers_license, passport, passport_card, residence_card, social_security_number, tax_identification_number, or identification_card.")
