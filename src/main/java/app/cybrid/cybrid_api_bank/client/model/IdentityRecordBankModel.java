...
@JsonPropertyOrder({
  ...
  IdentityRecordBankModel.JSON_PROPERTY_EXPIRED_AT
})
...
public class IdentityRecordBankModel {
  ...
  **/
  ...
  public IdentityRecordBankModel expiredAt(OffsetDateTime expiredAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ISO8601 datetime the record is expired at.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, identityRecord.guid) &&
        ...
        Objects.equals(this.expiredAt, identityRecord.expiredAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(guid, customerGuid, type, attestationDetails, createdAt, expiredAt);
  }
