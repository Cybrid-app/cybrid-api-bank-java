 ...
 *
 * The version of the OpenAPI document: v0.74.23
...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-06-29T17:37:34.357456Z[Etc/UTC]")
public class IdentityVerificationBankModel {
  ...
  **/
  ...
  public IdentityVerificationBankModel failureCodes(List<FailureCodesEnum> failureCodes) {
    
    this.failureCodes = failureCodes;
    return this;
  }

  public IdentityVerificationBankModel addFailureCodesItem(FailureCodesEnum failureCodesItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, customerGuid, type, method, createdAt, state, outcome, failureCodes);
  }
