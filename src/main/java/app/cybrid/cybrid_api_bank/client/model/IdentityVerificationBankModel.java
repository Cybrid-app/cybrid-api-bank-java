...
public class IdentityVerificationBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The identity verification method; one of business_registration, id_and_selfie, tax_id_and_selfie, attested, attested_ownership, plaid_identity_match, or document_submission.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, customerGuid, type, method, createdAt, updatedAt, state, outcome, failureCodes, complianceDecisions, verificationChecks);
  }
