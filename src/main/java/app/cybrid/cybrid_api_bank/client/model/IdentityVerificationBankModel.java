...
public class IdentityVerificationBankModel {
  ...
  **/
  ...
  public IdentityVerificationBankModel method(String method) {
   ...
   /**
   * The identity verification method; one of attested, document_submission, id_and_selfie, tax_id_and_selfie, business_registration, attested_ownership, account_ownership, or watchlists.
   * @return method
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The identity verification method; one of attested, document_submission, id_and_selfie, tax_id_and_selfie, business_registration, attested_ownership, account_ownership, or watchlists.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, identityVerification.guid) &&
        ...
        equalsNullable(this.customerGuid, identityVerification.customerGuid) &&
        equalsNullable(this.counterpartyGuid, identityVerification.counterpartyGuid) &&
        equalsNullable(this.externalBankAccountGuid, identityVerification.externalBankAccountGuid) &&
        Objects.equals(this.state, identityVerification.state) &&
        equalsNullable(this.outcome, identityVerification.outcome) &&
        equalsNullable(this.failureCodes, identityVerification.failureCodes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, type, method, createdAt, updatedAt, hashCodeNullable(customerGuid), hashCodeNullable(counterpartyGuid), hashCodeNullable(externalBankAccountGuid), state, hashCodeNullable(outcome), hashCodeNullable(failureCodes), complianceDecisions);
  }
