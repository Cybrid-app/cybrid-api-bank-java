...
public class IdentityVerificationBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, type, method, createdAt, updatedAt, customerGuid, counterpartyGuid, externalBankAccountGuid, state, outcome, failureCodes, complianceDecisions);
  }
