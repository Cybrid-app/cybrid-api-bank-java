...
import app.cybrid.cybrid_api_bank.client.model.VerificationCheckBankModel;
...
public class IdentityVerificationBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The checks associated with the identity verification.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, customerGuid, type, method, createdAt, updatedAt, state, outcome, failureCodes, verificationChecks);
  }
