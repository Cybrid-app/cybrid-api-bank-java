...
public class IdentityVerificationDocumentFileBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The file type; one of drivers_license_front, drivers_license_back, passport, identification_card, residence_card, selfie, selfie_video, selfie_left, selfie_right, proof_of_address, or incorporation_certificate.")
