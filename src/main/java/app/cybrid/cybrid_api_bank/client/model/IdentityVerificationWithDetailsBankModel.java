...
public class IdentityVerificationWithDetailsBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, type, method, createdAt, updatedAt, hashCodeNullable(customerGuid), hashCodeNullable(counterpartyGuid), hashCodeNullable(externalBankAccountGuid), state, hashCodeNullable(outcome), hashCodeNullable(failureCodes), complianceChecks, complianceDecisions, hashCodeNullable(personaInquiryId), hashCodeNullable(personaState), hashCodeNullable(pii), documents, supportingFiles);
  }
