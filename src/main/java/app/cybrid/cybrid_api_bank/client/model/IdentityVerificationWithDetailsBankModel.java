...
import app.cybrid.cybrid_api_bank.client.model.IdentityVerificationBusinessAssociateBankModel;
import app.cybrid.cybrid_api_bank.client.model.IdentityVerificationDocumentBankModel;
...
@JsonPropertyOrder({
  ...
  IdentityVerificationWithDetailsBankModel.JSON_PROPERTY_BUSINESS_ASSOCIATES,
  IdentityVerificationWithDetailsBankModel.JSON_PROPERTY_PII,
  IdentityVerificationWithDetailsBankModel.JSON_PROPERTY_DOCUMENTS,
  IdentityVerificationWithDetailsBankModel.JSON_PROPERTY_SUPPORTING_FILES
})
...
public class IdentityVerificationWithDetailsBankModel {
  ...
  public static final String JSON_PROPERTY_BUSINESS_ASSOCIATES = "business_associates";
  private List<IdentityVerificationBusinessAssociateBankModel> businessAssociates = null;
  ...
  private List<IdentityVerificationDocumentBankModel> documents = null;

  public static final String JSON_PROPERTY_SUPPORTING_FILES = "supporting_files";
  private List<IdentityVerificationDocumentBankModel> supportingFiles = null;
  ...
  **/
  ...
  public IdentityVerificationWithDetailsBankModel businessAssociates(List<IdentityVerificationBusinessAssociateBankModel> businessAssociates) {
    
    this.businessAssociates = businessAssociates;
    return this;
  }

  public IdentityVerificationWithDetailsBankModel addBusinessAssociatesItem(IdentityVerificationBusinessAssociateBankModel businessAssociatesItem) {
    if (this.businessAssociates == null) {
      this.businessAssociates = new ArrayList<>();
    }
    this.businessAssociates.add(businessAssociatesItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of associates declared for the business customer.")
  @JsonProperty(JSON_PROPERTY_BUSINESS_ASSOCIATES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<IdentityVerificationBusinessAssociateBankModel> getBusinessAssociates() {
    return businessAssociates;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BUSINESS_ASSOCIATES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBusinessAssociates(List<IdentityVerificationBusinessAssociateBankModel> businessAssociates) {
    this.businessAssociates = businessAssociates;
  }
  ...
  **/
  ...
  public IdentityVerificationWithDetailsBankModel documents(List<IdentityVerificationDocumentBankModel> documents) {
    
    this.documents = documents;
    return this;
  }

  public IdentityVerificationWithDetailsBankModel addDocumentsItem(IdentityVerificationDocumentBankModel documentsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The documents associated with the identity verification.")
  @JsonProperty(JSON_PROPERTY_DOCUMENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<IdentityVerificationDocumentBankModel> getDocuments() {
    return documents;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DOCUMENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDocuments(List<IdentityVerificationDocumentBankModel> documents) {
    this.documents = documents;
  }


  public IdentityVerificationWithDetailsBankModel supportingFiles(List<IdentityVerificationDocumentBankModel> supportingFiles) {
    
    this.supportingFiles = supportingFiles;
    return this;
  }

  public IdentityVerificationWithDetailsBankModel addSupportingFilesItem(IdentityVerificationDocumentBankModel supportingFilesItem) {
    if (this.supportingFiles == null) {
      this.supportingFiles = new ArrayList<>();
    }
    this.supportingFiles.add(supportingFilesItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The supporting documents associated with the attested identity verification.")
  @JsonProperty(JSON_PROPERTY_SUPPORTING_FILES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<IdentityVerificationDocumentBankModel> getSupportingFiles() {
    return supportingFiles;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUPPORTING_FILES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSupportingFiles(List<IdentityVerificationDocumentBankModel> supportingFiles) {
    this.supportingFiles = supportingFiles;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, identityVerificationWithDetails.guid) &&
        ...
        Objects.equals(this.businessAssociates, identityVerificationWithDetails.businessAssociates) &&
        equalsNullable(this.pii, identityVerificationWithDetails.pii) &&
        Objects.equals(this.documents, identityVerificationWithDetails.documents) &&
        Objects.equals(this.supportingFiles, identityVerificationWithDetails.supportingFiles);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, type, method, createdAt, updatedAt, hashCodeNullable(customerGuid), hashCodeNullable(counterpartyGuid), hashCodeNullable(externalBankAccountGuid), state, hashCodeNullable(outcome), hashCodeNullable(failureCodes), complianceChecks, complianceDecisions, hashCodeNullable(personaInquiryId), hashCodeNullable(personaState), businessAssociates, hashCodeNullable(pii), documents, supportingFiles);
  }
  ...
  public String toString() {
    ...
    sb.append("    businessAssociates: ").append(toIndentedString(businessAssociates)).append("\n");
    sb.append("    pii: ").append(toIndentedString(pii)).append("\n");
    sb.append("    documents: ").append(toIndentedString(documents)).append("\n");
    sb.append("    supportingFiles: ").append(toIndentedString(supportingFiles)).append("\n");
    sb.append("}");
    return sb.toString();
  }
