...
public class IdentityVerificationWithDetailsBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, customerGuid, type, method, createdAt, updatedAt, state, outcome, failureCodes, personaInquiryId, personaState, externalBankAccountGuid);
  }
