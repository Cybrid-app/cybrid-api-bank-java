...
public class IdentityVerificationWithDetailsBankModel {
  ...
  **/
  ...
  public IdentityVerificationWithDetailsBankModel verificationChecks(List<VerificationCheckBankModel> verificationChecks) {
    
    this.verificationChecks = verificationChecks;
    return this;
  }

  public IdentityVerificationWithDetailsBankModel addVerificationChecksItem(VerificationCheckBankModel verificationChecksItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, customerGuid, type, method, createdAt, updatedAt, state, outcome, failureCodes, verificationChecks, personaInquiryId, personaState, externalBankAccountGuid, pii);
  }
