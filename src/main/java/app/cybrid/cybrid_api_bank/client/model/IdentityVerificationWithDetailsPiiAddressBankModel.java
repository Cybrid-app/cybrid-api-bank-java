 ...
 */
@ApiModel(description = "The attested address.")
@JsonPropertyOrder({
  IdentityVerificationWithDetailsPiiAddressBankModel.JSON_PROPERTY_STREET,
  IdentityVerificationWithDetailsPiiAddressBankModel.JSON_PROPERTY_STREET2,
  IdentityVerificationWithDetailsPiiAddressBankModel.JSON_PROPERTY_CITY,
  IdentityVerificationWithDetailsPiiAddressBankModel.JSON_PROPERTY_SUBDIVISION,
  IdentityVerificationWithDetailsPiiAddressBankModel.JSON_PROPERTY_POSTAL_CODE,
  IdentityVerificationWithDetailsPiiAddressBankModel.JSON_PROPERTY_COUNTRY_CODE
})
@JsonTypeName("IdentityVerificationWithDetails_pii_address")
...
public class IdentityVerificationWithDetailsPiiAddressBankModel {
  ...
  public IdentityVerificationWithDetailsPiiAddressBankModel() { 
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IdentityVerificationWithDetailsPiiAddressBankModel identityVerificationWithDetailsPiiAddress = (IdentityVerificationWithDetailsPiiAddressBankModel) o;
    return Objects.equals(this.street, identityVerificationWithDetailsPiiAddress.street) &&
        equalsNullable(this.street2, identityVerificationWithDetailsPiiAddress.street2) &&
        Objects.equals(this.city, identityVerificationWithDetailsPiiAddress.city) &&
        equalsNullable(this.subdivision, identityVerificationWithDetailsPiiAddress.subdivision) &&
        equalsNullable(this.postalCode, identityVerificationWithDetailsPiiAddress.postalCode) &&
        Objects.equals(this.countryCode, identityVerificationWithDetailsPiiAddress.countryCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class IdentityVerificationWithDetailsPiiAddressBankModel {\n");
