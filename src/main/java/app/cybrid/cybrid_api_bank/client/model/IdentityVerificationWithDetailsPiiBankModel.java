...
public class IdentityVerificationWithDetailsPiiBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(name), hashCodeNullable(address), hashCodeNullable(dateOfBirth), hashCodeNullable(phoneNumber), hashCodeNullable(emailAddress));
  }
