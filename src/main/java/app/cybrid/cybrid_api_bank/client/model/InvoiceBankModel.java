 ...
 */
@JsonPropertyOrder({
  InvoiceBankModel.JSON_PROPERTY_GUID,
  InvoiceBankModel.JSON_PROPERTY_CUSTOMER_GUID,
  InvoiceBankModel.JSON_PROPERTY_ACCOUNT_GUID,
  InvoiceBankModel.JSON_PROPERTY_CREATED_AT,
  InvoiceBankModel.JSON_PROPERTY_UPDATED_AT,
  InvoiceBankModel.JSON_PROPERTY_TYPE,
  InvoiceBankModel.JSON_PROPERTY_ASSET,
  InvoiceBankModel.JSON_PROPERTY_RECEIVE_AMOUNT,
  InvoiceBankModel.JSON_PROPERTY_DELIVER_AMOUNT,
  InvoiceBankModel.JSON_PROPERTY_FEE,
  InvoiceBankModel.JSON_PROPERTY_STATE,
  InvoiceBankModel.JSON_PROPERTY_LABELS
})
...
public class InvoiceBankModel {
  ...
  private JsonNullable<java.math.BigInteger> fee = JsonNullable.<java.math.BigInteger>undefined();
  ...
  **/
  ...
  public InvoiceBankModel receiveAmount(java.math.BigInteger receiveAmount) {
  ...
  **/
  ...
  public InvoiceBankModel deliverAmount(java.math.BigInteger deliverAmount) {
  ...
  **/
  ...
  public InvoiceBankModel fee(java.math.BigInteger fee) {
    this.fee = JsonNullable.<java.math.BigInteger>of(fee);
  ...
  **/
  ...
  public JsonNullable<java.math.BigInteger> getFee_JsonNullable() {
    return fee;
  }
  
  @JsonProperty(JSON_PROPERTY_FEE)
  public void setFee_JsonNullable(JsonNullable<java.math.BigInteger> fee) {
    this.fee = fee;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, invoice.guid) &&
        equalsNullable(this.customerGuid, invoice.customerGuid) &&
        Objects.equals(this.accountGuid, invoice.accountGuid) &&
        ...
        Objects.equals(this.asset, invoice.asset) &&
        equalsNullable(this.receiveAmount, invoice.receiveAmount) &&
        equalsNullable(this.deliverAmount, invoice.deliverAmount) &&
        equalsNullable(this.fee, invoice.fee) &&
        Objects.equals(this.state, invoice.state) &&
        equalsNullable(this.labels, invoice.labels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, hashCodeNullable(customerGuid), accountGuid, createdAt, updatedAt, type, asset, hashCodeNullable(receiveAmount), hashCodeNullable(deliverAmount), hashCodeNullable(fee), state, hashCodeNullable(labels));
  }
