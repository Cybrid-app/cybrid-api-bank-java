...
@JsonPropertyOrder({
  ...
  InvoiceBankModel.JSON_PROPERTY_INVOICE_TYPE,
...
public class InvoiceBankModel {
  ...
  **/
  ...
  public InvoiceBankModel invoiceType(String invoiceType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, invoice.guid) &&
        Objects.equals(this.customerGuid, invoice.customerGuid) &&
        ...
        Objects.equals(this.receiveAmount, invoice.receiveAmount) &&
        Objects.equals(this.deliverAmount, invoice.deliverAmount) &&
        Objects.equals(this.fee, invoice.fee) &&
        Objects.equals(this.state, invoice.state) &&
        Objects.equals(this.labels, invoice.labels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(guid, customerGuid, accountGuid, createdAt, updatedAt, invoiceType, asset, receiveAmount, deliverAmount, fee, state, labels);
  }
