...
public class PatchBankBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, patchBank.name) &&
        Objects.equals(this.supportedTradingSymbols, patchBank.supportedTradingSymbols);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, supportedTradingSymbols);
  }
