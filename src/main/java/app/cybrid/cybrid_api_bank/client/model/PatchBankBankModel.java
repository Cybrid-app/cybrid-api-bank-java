...
@JsonPropertyOrder({
  PatchBankBankModel.JSON_PROPERTY_NAME,
  PatchBankBankModel.JSON_PROPERTY_SUPPORTED_TRADING_SYMBOLS,
  PatchBankBankModel.JSON_PROPERTY_SUPPORTED_PAYOUT_SYMBOLS,
  PatchBankBankModel.JSON_PROPERTY_CORS_ALLOWED_ORIGINS
})
...
public class PatchBankBankModel {
  ...
  private JsonNullable<List<String>> supportedTradingSymbols = JsonNullable.<List<String>>undefined();
  ...
  **/
  ...
  public PatchBankBankModel supportedTradingSymbols(List<String> supportedTradingSymbols) {
    this.supportedTradingSymbols = JsonNullable.<List<String>>of(supportedTradingSymbols);
  ...
  public PatchBankBankModel addSupportedTradingSymbolsItem(String supportedTradingSymbolsItem) {
    if (this.supportedTradingSymbols == null || !this.supportedTradingSymbols.isPresent()) {
      this.supportedTradingSymbols = JsonNullable.<List<String>>of(new ArrayList<>());
    }
    try {
      this.supportedTradingSymbols.get().add(supportedTradingSymbolsItem);
  ...
  **/
  ...
  public List<String> getSupportedTradingSymbols() {
        return supportedTradingSymbols.orElse(null);
  }
  ...
  public PatchBankBankModel supportedPayoutSymbols(List<PostSupportedPayoutSymbolsBankModel> supportedPayoutSymbols) {
    this.supportedPayoutSymbols = JsonNullable.<List<PostSupportedPayoutSymbolsBankModel>>of(supportedPayoutSymbols);
    
    return this;
  }

  public PatchBankBankModel addSupportedPayoutSymbolsItem(PostSupportedPayoutSymbolsBankModel supportedPayoutSymbolsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, patchBank.name) &&
        equalsNullable(this.supportedTradingSymbols, patchBank.supportedTradingSymbols) &&
        equalsNullable(this.supportedPayoutSymbols, patchBank.supportedPayoutSymbols) &&
        equalsNullable(this.corsAllowedOrigins, patchBank.corsAllowedOrigins);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(name), hashCodeNullable(supportedTradingSymbols), hashCodeNullable(supportedPayoutSymbols), hashCodeNullable(corsAllowedOrigins));
  }
