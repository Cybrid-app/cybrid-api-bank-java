 ...
 */
@ApiModel(description = "Request body for external bank account modification.")
@JsonPropertyOrder({
  PatchExternalBankAccountBankModel.JSON_PROPERTY_STATE
})
@JsonTypeName("PatchExternalBankAccount")
...
public class PatchExternalBankAccountBankModel {
  /**
  ...
  public PatchExternalBankAccountBankModel() { 
  }

  public PatchExternalBankAccountBankModel state(StateEnum state) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The state of the external bank account. If set to \"completed,\" the returned state of the external bank account will be either \"completed\", if the bank account has been verified, or \"unverified\" if the bank account has not been verified.")
  ...
  public boolean equals(Object o) {
    ...
    PatchExternalBankAccountBankModel patchExternalBankAccount = (PatchExternalBankAccountBankModel) o;
    return Objects.equals(this.state, patchExternalBankAccount.state);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchExternalBankAccountBankModel {\n");
