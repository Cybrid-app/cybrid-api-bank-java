...
import app.cybrid.cybrid_api_bank.client.model.PatchTransferParticipantBankModel;
...
@JsonPropertyOrder({
  PatchTransferBankModel.JSON_PROPERTY_SOURCE_PARTICIPANTS,
  PatchTransferBankModel.JSON_PROPERTY_DESTINATION_PARTICIPANTS
})
...
public class PatchTransferBankModel {
  ...
  private JsonNullable<List<PatchTransferParticipantBankModel>> sourceParticipants = JsonNullable.<List<PatchTransferParticipantBankModel>>undefined();

  public static final String JSON_PROPERTY_DESTINATION_PARTICIPANTS = "destination_participants";
  private JsonNullable<List<PatchTransferParticipantBankModel>> destinationParticipants = JsonNullable.<List<PatchTransferParticipantBankModel>>undefined();

  public PatchTransferBankModel() { 
  }

  public PatchTransferBankModel sourceParticipants(List<PatchTransferParticipantBankModel> sourceParticipants) {
    this.sourceParticipants = JsonNullable.<List<PatchTransferParticipantBankModel>>of(sourceParticipants);
  ...
  public PatchTransferBankModel addSourceParticipantsItem(PatchTransferParticipantBankModel sourceParticipantsItem) {
    if (this.sourceParticipants == null || !this.sourceParticipants.isPresent()) {
      this.sourceParticipants = JsonNullable.<List<PatchTransferParticipantBankModel>>of(new ArrayList<>());
    }
    try {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE_PARTICIPANTS)
  public void setSourceParticipants_JsonNullable(JsonNullable<List<PatchTransferParticipantBankModel>> sourceParticipants) {
  ...
  public PatchTransferBankModel destinationParticipants(List<PatchTransferParticipantBankModel> destinationParticipants) {
    this.destinationParticipants = JsonNullable.<List<PatchTransferParticipantBankModel>>of(destinationParticipants);
  ...
  public PatchTransferBankModel addDestinationParticipantsItem(PatchTransferParticipantBankModel destinationParticipantsItem) {
    if (this.destinationParticipants == null || !this.destinationParticipants.isPresent()) {
      this.destinationParticipants = JsonNullable.<List<PatchTransferParticipantBankModel>>of(new ArrayList<>());
    }
    try {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DESTINATION_PARTICIPANTS)
  public void setDestinationParticipants_JsonNullable(JsonNullable<List<PatchTransferParticipantBankModel>> destinationParticipants) {
  ...
  public boolean equals(Object o) {
    ...
    PatchTransferBankModel patchTransfer = (PatchTransferBankModel) o;
    return equalsNullable(this.sourceParticipants, patchTransfer.sourceParticipants) &&
        equalsNullable(this.destinationParticipants, patchTransfer.destinationParticipants);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(sourceParticipants), hashCodeNullable(destinationParticipants));
  }
