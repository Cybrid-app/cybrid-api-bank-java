 ...
 */
@JsonPropertyOrder({
  PersonaSessionBankModel.JSON_PROPERTY_IDENTITY_VERIFICATION_GUID,
  PersonaSessionBankModel.JSON_PROPERTY_PERSONA_INQUIRY_ID,
  PersonaSessionBankModel.JSON_PROPERTY_PERSONA_SESSION_TOKEN
})
@JsonTypeName("PersonaSession")
...
public class PersonaSessionBankModel {
  ...
  public static final String JSON_PROPERTY_PERSONA_SESSION_TOKEN = "persona_session_token";
  private String personaSessionToken;

  public PersonaSessionBankModel() { 
  }

  public PersonaSessionBankModel identityVerificationGuid(String identityVerificationGuid) {
    
    this.identityVerificationGuid = identityVerificationGuid;
    return this;
  }

   /**
   * The unique identifier for the identity verification.
   * @return identityVerificationGuid
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The unique identifier for the identity verification.")
  @JsonProperty(JSON_PROPERTY_IDENTITY_VERIFICATION_GUID)
  ...
  @JsonProperty(JSON_PROPERTY_IDENTITY_VERIFICATION_GUID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIdentityVerificationGuid(String identityVerificationGuid) {
    this.identityVerificationGuid = identityVerificationGuid;
  }


  public PersonaSessionBankModel personaInquiryId(String personaInquiryId) {
  ...
  **/
  ...
  public PersonaSessionBankModel personaSessionToken(String personaSessionToken) {
   ...
   * @return personaSessionToken
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The token to be used in the Persona session.")
  @JsonProperty(JSON_PROPERTY_PERSONA_SESSION_TOKEN)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public String getPersonaSessionToken() {
    return personaSessionToken;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PERSONA_SESSION_TOKEN)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPersonaSessionToken(String personaSessionToken) {
    this.personaSessionToken = personaSessionToken;
  }
  ...
  public boolean equals(Object o) {
    ...
    PersonaSessionBankModel personaSession = (PersonaSessionBankModel) o;
    return Objects.equals(this.identityVerificationGuid, personaSession.identityVerificationGuid) &&
        Objects.equals(this.personaInquiryId, personaSession.personaInquiryId) &&
        Objects.equals(this.personaSessionToken, personaSession.personaSessionToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identityVerificationGuid, personaInquiryId, personaSessionToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PersonaSessionBankModel {\n");
    sb.append("    identityVerificationGuid: ").append(toIndentedString(identityVerificationGuid)).append("\n");
    sb.append("    personaInquiryId: ").append(toIndentedString(personaInquiryId)).append("\n");
    sb.append("    personaSessionToken: ").append(toIndentedString(personaSessionToken)).append("\n");
    sb.append("}");
    return sb.toString();
  }
