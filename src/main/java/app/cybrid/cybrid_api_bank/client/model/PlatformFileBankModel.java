...
public class PlatformFileBankModel {
  ...
  **/
  ...
  public PlatformFileBankModel fileType(String fileType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The file type; one of drivers_license_front, drivers_license_back, passport, visa, identification_card, residence_card, selfie, selfie_video, selfie_left, selfie_right, utility_bill, bank_statement, property_tax, tax_document, ein_letter, incorporation_certificate, persona_inquiry_report, or persona_inquiry_export.")
