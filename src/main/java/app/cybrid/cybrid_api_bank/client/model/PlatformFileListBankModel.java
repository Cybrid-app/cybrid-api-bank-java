 ...
 */
@JsonPropertyOrder({
  PlatformFileListBankModel.JSON_PROPERTY_TOTAL,
  PlatformFileListBankModel.JSON_PROPERTY_PAGE,
  PlatformFileListBankModel.JSON_PROPERTY_PER_PAGE,
  PlatformFileListBankModel.JSON_PROPERTY_OBJECTS
})
@JsonTypeName("PlatformFileList")
...
public class PlatformFileListBankModel {
  ...
  private List<PlatformFileBankModel> objects = new ArrayList<>();

  public PlatformFileListBankModel() { 
  }

  public PlatformFileListBankModel total(java.math.BigInteger total) {
  ...
  **/
  ...
  public PlatformFileListBankModel page(java.math.BigInteger page) {
  ...
  **/
  ...
  public PlatformFileListBankModel perPage(java.math.BigInteger perPage) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Array of file entities")
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<PlatformFileBankModel> getObjects() {
    return objects;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlatformFileListBankModel platformFileList = (PlatformFileListBankModel) o;
    return Objects.equals(this.total, platformFileList.total) &&
        Objects.equals(this.page, platformFileList.page) &&
        Objects.equals(this.perPage, platformFileList.perPage) &&
        Objects.equals(this.objects, platformFileList.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlatformFileListBankModel {\n");
