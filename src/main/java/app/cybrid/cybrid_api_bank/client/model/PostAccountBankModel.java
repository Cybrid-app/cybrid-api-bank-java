 ...
 */
@ApiModel(description = "Request body for account creation.")
@JsonPropertyOrder({
  ...
  PostAccountBankModel.JSON_PROPERTY_LABELS
})
...
public class PostAccountBankModel {
  ...
  **/
  ...
  @ApiModelProperty(value = "TThe customer identifier associated with the account.")
  @JsonIgnore
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, postAccount.type) &&
        equalsNullable(this.customerGuid, postAccount.customerGuid) &&
        Objects.equals(this.asset, postAccount.asset) &&
        Objects.equals(this.name, postAccount.name) &&
        equalsNullable(this.labels, postAccount.labels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, hashCodeNullable(customerGuid), asset, name, hashCodeNullable(labels));
  }
