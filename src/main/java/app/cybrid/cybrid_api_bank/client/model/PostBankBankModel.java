...
@JsonPropertyOrder({
  ...
  PostBankBankModel.JSON_PROPERTY_SUPPORTED_FIAT_ASSETS,
...
public class PostBankBankModel {
  ...
  private List<String> supportedFiatAssets = new ArrayList<>();
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, postBank.name) &&
        ...
        Objects.equals(this.supportedFiatAssets, postBank.supportedFiatAssets) &&
        Objects.equals(this.features, postBank.features);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, supportedFiatAssets, features);
  }
