...
@JsonPropertyOrder({
  ...
  PostBankBankModel.JSON_PROPERTY_ROUTABLE_ACCOUNTS
})
...
public class PostBankBankModel {
   ...
   */
  public enum RoutableAccountsEnum {
    ...
    RoutableAccountsEnum(String value) {
      this.value = value;
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, postBank.name) &&
        Objects.equals(this.type, postBank.type) &&
        ...
        Objects.equals(this.routableAccounts, postBank.routableAccounts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, supportedTradingSymbols, features, supportedFiatAccountAssets, supportedCountryCodes, routableAccounts);
  }
  ...
  public String toString() {
    ...
    sb.append("    routableAccounts: ").append(toIndentedString(routableAccounts)).append("\n");
    sb.append("}");
    return sb.toString();
  }
