...
import app.cybrid.cybrid_api_bank.client.model.PostSupportedPayoutSymbolsBankModel;
...
@JsonPropertyOrder({
  PostBankBankModel.JSON_PROPERTY_TYPE,
  PostBankBankModel.JSON_PROPERTY_NAME,
  PostBankBankModel.JSON_PROPERTY_SUPPORTED_TRADING_SYMBOLS,
  PostBankBankModel.JSON_PROPERTY_SUPPORTED_PAYOUT_SYMBOLS,
  PostBankBankModel.JSON_PROPERTY_SUPPORTED_FIAT_ACCOUNT_ASSETS,
  PostBankBankModel.JSON_PROPERTY_SUPPORTED_COUNTRY_CODES,
  PostBankBankModel.JSON_PROPERTY_FEATURES,
  PostBankBankModel.JSON_PROPERTY_CORS_ALLOWED_ORIGINS
})
...
public class PostBankBankModel {
  ...
  private JsonNullable<List<PostSupportedPayoutSymbolsBankModel>> supportedPayoutSymbols = JsonNullable.<List<PostSupportedPayoutSymbolsBankModel>>undefined();
  ...
  private JsonNullable<List<String>> corsAllowedOrigins = JsonNullable.<List<String>>undefined();

  public PostBankBankModel() { 
  }
  ...
  **/
  ...
  public PostBankBankModel supportedPayoutSymbols(List<PostSupportedPayoutSymbolsBankModel> supportedPayoutSymbols) {
    this.supportedPayoutSymbols = JsonNullable.<List<PostSupportedPayoutSymbolsBankModel>>of(supportedPayoutSymbols);
  ...
  public PostBankBankModel addSupportedPayoutSymbolsItem(PostSupportedPayoutSymbolsBankModel supportedPayoutSymbolsItem) {
    if (this.supportedPayoutSymbols == null || !this.supportedPayoutSymbols.isPresent()) {
      this.supportedPayoutSymbols = JsonNullable.<List<PostSupportedPayoutSymbolsBankModel>>of(new ArrayList<>());
    }
    try {
      this.supportedPayoutSymbols.get().add(supportedPayoutSymbolsItem);
  ...
  **/
  ...
  public List<PostSupportedPayoutSymbolsBankModel> getSupportedPayoutSymbols() {
        return supportedPayoutSymbols.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_SUPPORTED_PAYOUT_SYMBOLS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<List<PostSupportedPayoutSymbolsBankModel>> getSupportedPayoutSymbols_JsonNullable() {
    return supportedPayoutSymbols;
  }
  
  @JsonProperty(JSON_PROPERTY_SUPPORTED_PAYOUT_SYMBOLS)
  public void setSupportedPayoutSymbols_JsonNullable(JsonNullable<List<PostSupportedPayoutSymbolsBankModel>> supportedPayoutSymbols) {
  ...
  **/
  ...
  public PostBankBankModel corsAllowedOrigins(List<String> corsAllowedOrigins) {
    this.corsAllowedOrigins = JsonNullable.<List<String>>of(corsAllowedOrigins);
  ...
  public PostBankBankModel addCorsAllowedOriginsItem(String corsAllowedOriginsItem) {
    if (this.corsAllowedOrigins == null || !this.corsAllowedOrigins.isPresent()) {
      this.corsAllowedOrigins = JsonNullable.<List<String>>of(new ArrayList<>());
    }
    try {
      this.corsAllowedOrigins.get().add(corsAllowedOriginsItem);
    } catch (java.util.NoSuchElementException e) {
      // this can never happen, as we make sure above that the value is present
    }
    return this;
  ...
  **/
  ...
  public List<String> getCorsAllowedOrigins() {
        return corsAllowedOrigins.orElse(null);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, postBank.type) &&
        Objects.equals(this.name, postBank.name) &&
        Objects.equals(this.supportedTradingSymbols, postBank.supportedTradingSymbols) &&
        equalsNullable(this.supportedPayoutSymbols, postBank.supportedPayoutSymbols) &&
        Objects.equals(this.supportedFiatAccountAssets, postBank.supportedFiatAccountAssets) &&
        Objects.equals(this.supportedCountryCodes, postBank.supportedCountryCodes) &&
        Objects.equals(this.features, postBank.features) &&
        equalsNullable(this.corsAllowedOrigins, postBank.corsAllowedOrigins);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, supportedTradingSymbols, hashCodeNullable(supportedPayoutSymbols), supportedFiatAccountAssets, supportedCountryCodes, features, hashCodeNullable(corsAllowedOrigins));
  }
  ...
  public String toString() {
    ...
    sb.append("    supportedPayoutSymbols: ").append(toIndentedString(supportedPayoutSymbols)).append("\n");
