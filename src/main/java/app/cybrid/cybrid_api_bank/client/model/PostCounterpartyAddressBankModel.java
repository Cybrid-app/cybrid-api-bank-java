...
@JsonPropertyOrder({
  PostCounterpartyAddressBankModel.JSON_PROPERTY_STREET,
  PostCounterpartyAddressBankModel.JSON_PROPERTY_STREET2,
  PostCounterpartyAddressBankModel.JSON_PROPERTY_CITY,
  PostCounterpartyAddressBankModel.JSON_PROPERTY_SUBDIVISION,
  PostCounterpartyAddressBankModel.JSON_PROPERTY_POSTAL_CODE,
  PostCounterpartyAddressBankModel.JSON_PROPERTY_COUNTRY_CODE
})
@JsonTypeName("PostCounterparty_address")
...
public class PostCounterpartyAddressBankModel {
  ...
  public PostCounterpartyAddressBankModel() { 
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.street, postCounterpartyAddress.street) &&
        equalsNullable(this.street2, postCounterpartyAddress.street2) &&
        Objects.equals(this.city, postCounterpartyAddress.city) &&
        equalsNullable(this.subdivision, postCounterpartyAddress.subdivision) &&
        equalsNullable(this.postalCode, postCounterpartyAddress.postalCode) &&
        Objects.equals(this.countryCode, postCounterpartyAddress.countryCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(street, hashCodeNullable(street2), city, hashCodeNullable(subdivision), hashCodeNullable(postalCode), countryCode);
  }
