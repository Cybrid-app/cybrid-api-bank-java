...
public class PostCounterpartyBankModel {
  ...
  private List<PostCounterpartyAliasesInnerBankModel> aliases = null;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The counterparty's date of birth; optional for individual counterparties..")
