 ...
 */
@ApiModel(description = "The customer's address.")
@JsonPropertyOrder({
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.street, postCustomerAddress.street) &&
        equalsNullable(this.street2, postCustomerAddress.street2) &&
        Objects.equals(this.city, postCustomerAddress.city) &&
        equalsNullable(this.subdivision, postCustomerAddress.subdivision) &&
        equalsNullable(this.postalCode, postCustomerAddress.postalCode) &&
