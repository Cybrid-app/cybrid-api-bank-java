...
public class PostCustomerBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, hashCodeNullable(name), hashCodeNullable(address), hashCodeNullable(dateOfBirth), hashCodeNullable(phoneNumber), hashCodeNullable(emailAddress), hashCodeNullable(identificationNumbers), hashCodeNullable(labels));
  }
