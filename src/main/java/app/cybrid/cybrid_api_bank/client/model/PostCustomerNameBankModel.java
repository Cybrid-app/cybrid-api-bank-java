 ...
 */
@ApiModel(description = "The customer's name. Optional when type is individual.")
@JsonPropertyOrder({
...
public class PostCustomerNameBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(first), hashCodeNullable(middle), hashCodeNullable(last));
  }
