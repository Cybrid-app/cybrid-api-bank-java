...
@JsonPropertyOrder({
  PostDepositAddressBankModel.JSON_PROPERTY_ACCOUNT_GUID,
  PostDepositAddressBankModel.JSON_PROPERTY_LABELS
})
@JsonTypeName("PostDepositAddress")
...
public class PostDepositAddressBankModel {
  ...
  public PostDepositAddressBankModel() { 
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountGuid, postDepositAddress.accountGuid) &&
        equalsNullable(this.labels, postDepositAddress.labels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountGuid, hashCodeNullable(labels));
  }
