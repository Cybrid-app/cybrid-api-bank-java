 ...
 */
@JsonPropertyOrder({
  PostDepositBankAccountBankModel.JSON_PROPERTY_TYPE,
  PostDepositBankAccountBankModel.JSON_PROPERTY_ACCOUNT_GUID,
  PostDepositBankAccountBankModel.JSON_PROPERTY_CUSTOMER_GUID,
  PostDepositBankAccountBankModel.JSON_PROPERTY_PARENT_DEPOSIT_BANK_ACCOUNT_GUID,
  PostDepositBankAccountBankModel.JSON_PROPERTY_LABELS
})
@JsonTypeName("PostDepositBankAccount")
...
public class PostDepositBankAccountBankModel {
  ...
  **/
  ...
  @ApiModelProperty(value = "The account type. To generate deposit bank accounts with their own unique account number set this to \"main\". To generate deposit bank accounts with the same account number as the parent deposit bank account set this to \"sub_account\". This setting will only generate a unique identifier for the deposit bank and will not result in a unique account number being generated. \"sub_account\" is only  available for customer-level deposit bank accounts.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, postDepositBankAccount.type) &&
        Objects.equals(this.accountGuid, postDepositBankAccount.accountGuid) &&
        Objects.equals(this.customerGuid, postDepositBankAccount.customerGuid) &&
        Objects.equals(this.parentDepositBankAccountGuid, postDepositBankAccount.parentDepositBankAccountGuid) &&
        Objects.equals(this.labels, postDepositBankAccount.labels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, accountGuid, customerGuid, parentDepositBankAccountGuid, labels);
  }
