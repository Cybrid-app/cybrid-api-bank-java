 ...
 */
@ApiModel(description = "The counterparty's name on their checking account.")
@JsonPropertyOrder({
...
public class PostExternalBankAccountCounterpartyNameBankModel {
  ...
  **/
  ...
  @ApiModelProperty(value = "The customer's first name. Used for individual accounts.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The customer's middle name. Used for individual accounts.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The customer's last name. Used for individual accounts.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The customers's full name on the account. Used for business accounts.")
