 ...
 */
@ApiModel(description = "Request body for external wallet creation.")
@JsonPropertyOrder({
  PostExternalWalletBankModel.JSON_PROPERTY_NAME,
  PostExternalWalletBankModel.JSON_PROPERTY_CUSTOMER_GUID,
  PostExternalWalletBankModel.JSON_PROPERTY_COUNTERPARTY_GUID,
  PostExternalWalletBankModel.JSON_PROPERTY_ASSET,
  PostExternalWalletBankModel.JSON_PROPERTY_ADDRESS,
  PostExternalWalletBankModel.JSON_PROPERTY_TAG
})
...
public class PostExternalWalletBankModel {
  ...
  public PostExternalWalletBankModel() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the external wallet.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The counterparty identifier.")
  @JsonIgnore
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PostExternalWalletBankModel postExternalWallet = (PostExternalWalletBankModel) o;
    return Objects.equals(this.name, postExternalWallet.name) &&
        equalsNullable(this.customerGuid, postExternalWallet.customerGuid) &&
        equalsNullable(this.counterpartyGuid, postExternalWallet.counterpartyGuid) &&
        Objects.equals(this.asset, postExternalWallet.asset) &&
        Objects.equals(this.address, postExternalWallet.address) &&
        equalsNullable(this.tag, postExternalWallet.tag);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, hashCodeNullable(customerGuid), hashCodeNullable(counterpartyGuid), asset, address, hashCodeNullable(tag));
  }
