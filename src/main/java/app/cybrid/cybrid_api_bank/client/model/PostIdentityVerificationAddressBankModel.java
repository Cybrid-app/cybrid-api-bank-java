 ...
 */
@ApiModel(description = "The customer's address. Required when type is kyc and method is attested, type is kyc and method is attested_business_registration, or type is kyc and method is attested_id_and_selfie. Optional when type is bank_account and method is attested_ownership.")
@JsonPropertyOrder({
  PostIdentityVerificationAddressBankModel.JSON_PROPERTY_STREET,
  PostIdentityVerificationAddressBankModel.JSON_PROPERTY_STREET2,
  PostIdentityVerificationAddressBankModel.JSON_PROPERTY_CITY,
  PostIdentityVerificationAddressBankModel.JSON_PROPERTY_SUBDIVISION,
  PostIdentityVerificationAddressBankModel.JSON_PROPERTY_POSTAL_CODE,
  PostIdentityVerificationAddressBankModel.JSON_PROPERTY_COUNTRY_CODE
})
@JsonTypeName("PostIdentityVerification_address")
...
public class PostIdentityVerificationAddressBankModel {
  ...
  public PostIdentityVerificationAddressBankModel street(String street) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The first line of the address. Required when type is kyc and method is attested, type is kyc and method is attested_business_registration, type is kyc and method is attested_id_and_selfie, or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  public PostIdentityVerificationAddressBankModel street2(String street2) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The optional second line of the address. Optional when type is kyc and method is attested, type is kyc and method is attested_business_registration, type is kyc and method is attested_id_and_selfie, or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  public PostIdentityVerificationAddressBankModel city(String city) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The city of the address. Required when type is kyc and method is attested, type is kyc and method is attested_business_registration, type is kyc and method is attested_id_and_selfie, or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  public PostIdentityVerificationAddressBankModel subdivision(String subdivision) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ISO 3166-2 subdivision code of the address. Applicable only for countries that use subnational states, provinces, lands, oblasts or regions. Optional when type is kyc and method is attested, type is kyc and method is attested_business_registration, type is kyc and method is attested_id_and_selfie, or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  public PostIdentityVerificationAddressBankModel postalCode(String postalCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The postal, zip or post code of the address. Applicable only for countries that use postal, zip or post codes. Optional when type is kyc and method is attested, type is kyc and method is attested_business_registration, type is kyc and method is attested_id_and_selfie, or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  public PostIdentityVerificationAddressBankModel countryCode(String countryCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ISO 3166 country 2-Alpha country code of the address. Required when type is kyc and method is attested, type is kyc and method is attested_business_registration, type is kyc and method is attested_id_and_selfie, or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    PostIdentityVerificationAddressBankModel postIdentityVerificationAddress = (PostIdentityVerificationAddressBankModel) o;
    return equalsNullable(this.street, postIdentityVerificationAddress.street) &&
        equalsNullable(this.street2, postIdentityVerificationAddress.street2) &&
        equalsNullable(this.city, postIdentityVerificationAddress.city) &&
        equalsNullable(this.subdivision, postIdentityVerificationAddress.subdivision) &&
        equalsNullable(this.postalCode, postIdentityVerificationAddress.postalCode) &&
        equalsNullable(this.countryCode, postIdentityVerificationAddress.countryCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostIdentityVerificationAddressBankModel {\n");
