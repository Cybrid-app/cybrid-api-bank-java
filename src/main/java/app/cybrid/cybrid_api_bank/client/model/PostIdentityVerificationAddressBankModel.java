 ...
 */
@ApiModel(description = "The customer's address. Required when type is kyc and method is attested. Optional when type is bank_account and method is attested_ownership.")
@JsonPropertyOrder({
...
public class PostIdentityVerificationAddressBankModel {
  ...
  **/
  ...
  @ApiModelProperty(value = "The first line of the address. Required when type is kyc and method is attested or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The optional second line of the address. Optional when type is kyc and method is attested or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The city of the address. Required when type is kyc and method is attested or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ISO 3166-2 subdivision code of the address. Applicable only for countries that use subnational states, provinces, lands, oblasts or regions. Optional when type is kyc and method is attested or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The postal, zip or post code of the address. Applicable only for countries that use postal, zip or post codes. Optional when type is kyc and method is attested or type is bank_account and method is attested_ownership.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ISO 3166 country 2-Alpha country code of the address. Required when type is kyc and method is attested or type is bank_account and method is attested_ownership.")
  @JsonIgnore
