...
public class PostIdentityVerificationBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, method, customerGuid, counterpartyGuid, countryCode, name, address, dateOfBirth, phoneNumber, emailAddress, identificationNumbers, externalBankAccountGuid, expectedBehaviours);
  }
