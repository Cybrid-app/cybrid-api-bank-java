...
public class PostIdentityVerificationBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The customer's date of birth; required when method is set to 'attested'.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The customer's identification numbers; required when method is set to 'attested'.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, method, customerGuid, countryCode, name, address, dateOfBirth, phoneNumber, emailAddress, identificationNumbers, externalBankAccountGuid, expectedBehaviours);
  }
