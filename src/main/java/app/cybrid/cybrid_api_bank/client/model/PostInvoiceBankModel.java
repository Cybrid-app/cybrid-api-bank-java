...
@JsonPropertyOrder({
  PostInvoiceBankModel.JSON_PROPERTY_ASSET,
  PostInvoiceBankModel.JSON_PROPERTY_CUSTOMER_GUID,
  PostInvoiceBankModel.JSON_PROPERTY_RECEIVE_AMOUNT,
  PostInvoiceBankModel.JSON_PROPERTY_DELIVER_AMOUNT,
  PostInvoiceBankModel.JSON_PROPERTY_ACCOUNT_GUID,
  PostInvoiceBankModel.JSON_PROPERTY_LABELS
})
...
public class PostInvoiceBankModel {
  ...
  private JsonNullable<String> accountGuid = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public PostInvoiceBankModel receiveAmount(java.math.BigInteger receiveAmount) {
  ...
  **/
  ...
  public PostInvoiceBankModel deliverAmount(java.math.BigInteger deliverAmount) {
  ...
  **/
  ...
  public PostInvoiceBankModel accountGuid(String accountGuid) {
    this.accountGuid = JsonNullable.<String>of(accountGuid);
  ...
  **/
  ...
  public String getAccountGuid() {
        return accountGuid.orElse(null);
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.asset, postInvoice.asset) &&
        equalsNullable(this.customerGuid, postInvoice.customerGuid) &&
        equalsNullable(this.receiveAmount, postInvoice.receiveAmount) &&
        equalsNullable(this.deliverAmount, postInvoice.deliverAmount) &&
        equalsNullable(this.accountGuid, postInvoice.accountGuid) &&
        equalsNullable(this.labels, postInvoice.labels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(asset, hashCodeNullable(customerGuid), hashCodeNullable(receiveAmount), hashCodeNullable(deliverAmount), hashCodeNullable(accountGuid), hashCodeNullable(labels));
  }
