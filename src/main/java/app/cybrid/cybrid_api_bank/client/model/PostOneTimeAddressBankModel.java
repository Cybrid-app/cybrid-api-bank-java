 ...
 */
@JsonPropertyOrder({
  PostOneTimeAddressBankModel.JSON_PROPERTY_ADDRESS,
  PostOneTimeAddressBankModel.JSON_PROPERTY_TAG
})
...
public class PostOneTimeAddressBankModel {
  ...
  public PostOneTimeAddressBankModel() { 
  }

  public PostOneTimeAddressBankModel address(String address) {
  ...
  **/
  ...
  public PostOneTimeAddressBankModel tag(String tag) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The blockchain tag to use when transferring crypto.")
  ...
  public boolean equals(Object o) {
    ...
    PostOneTimeAddressBankModel postOneTimeAddress = (PostOneTimeAddressBankModel) o;
    return Objects.equals(this.address, postOneTimeAddress.address) &&
        Objects.equals(this.tag, postOneTimeAddress.tag);
  }
