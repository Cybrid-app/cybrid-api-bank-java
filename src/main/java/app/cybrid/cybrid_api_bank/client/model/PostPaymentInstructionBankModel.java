...
@JsonPropertyOrder({
  PostPaymentInstructionBankModel.JSON_PROPERTY_INVOICE_GUID,
  PostPaymentInstructionBankModel.JSON_PROPERTY_EXPECTED_BEHAVIOUR
})
...
public class PostPaymentInstructionBankModel {
  ...
  public enum ExpectedBehaviourEnum {
    ...
    ExpectedBehaviourEnum(String value) {
      this.value = value;
    }
  ...
  private JsonNullable<ExpectedBehaviourEnum> expectedBehaviour = JsonNullable.<ExpectedBehaviourEnum>undefined();

  public PostPaymentInstructionBankModel() { 
  }
  ...
  **/
  ...
  public PostPaymentInstructionBankModel expectedBehaviour(ExpectedBehaviourEnum expectedBehaviour) {
    this.expectedBehaviour = JsonNullable.<ExpectedBehaviourEnum>of(expectedBehaviour);
  ...
  **/
  ...
  public ExpectedBehaviourEnum getExpectedBehaviour() {
        return expectedBehaviour.orElse(null);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.invoiceGuid, postPaymentInstruction.invoiceGuid) &&
        equalsNullable(this.expectedBehaviour, postPaymentInstruction.expectedBehaviour);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(invoiceGuid, hashCodeNullable(expectedBehaviour));
  }
  ...
  public String toString() {
    ...
    sb.append("    expectedBehaviour: ").append(toIndentedString(expectedBehaviour)).append("\n");
    sb.append("}");
    return sb.toString();
  }
