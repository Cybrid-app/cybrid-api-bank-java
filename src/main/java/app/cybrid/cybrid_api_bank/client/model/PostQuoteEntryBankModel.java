...
@JsonPropertyOrder({
  PostQuoteEntryBankModel.JSON_PROPERTY_TYPE,
  PostQuoteEntryBankModel.JSON_PROPERTY_GUID,
  PostQuoteEntryBankModel.JSON_PROPERTY_RECEIVE_AMOUNT,
  PostQuoteEntryBankModel.JSON_PROPERTY_DELIVER_AMOUNT
})
@JsonTypeName("PostQuoteEntry")
...
public class PostQuoteEntryBankModel {
  ...
  public PostQuoteEntryBankModel() { 
  }
  ...
  **/
  ...
  public PostQuoteEntryBankModel receiveAmount(java.math.BigInteger receiveAmount) {
  ...
  **/
  ...
  public PostQuoteEntryBankModel deliverAmount(java.math.BigInteger deliverAmount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, postQuoteEntry.type) &&
        Objects.equals(this.guid, postQuoteEntry.guid) &&
        equalsNullable(this.receiveAmount, postQuoteEntry.receiveAmount) &&
        equalsNullable(this.deliverAmount, postQuoteEntry.deliverAmount);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, guid, hashCodeNullable(receiveAmount), hashCodeNullable(deliverAmount));
  }
