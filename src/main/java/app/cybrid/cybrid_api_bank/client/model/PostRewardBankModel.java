 ...
 */
@JsonPropertyOrder({
  PostRewardBankModel.JSON_PROPERTY_CUSTOMER_GUID,
  PostRewardBankModel.JSON_PROPERTY_SYMBOL,
  PostRewardBankModel.JSON_PROPERTY_RECEIVE_AMOUNT,
  PostRewardBankModel.JSON_PROPERTY_DELIVER_AMOUNT
})
@JsonTypeName("PostReward")
...
public class PostRewardBankModel {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Symbol the quote is being requested for. Format is \"asset-counter_asset\" in uppercase. See the Symbols API for a complete list of cryptocurrencies supported.")
  ...
  public PostRewardBankModel receiveAmount(java.math.BigInteger receiveAmount) {
  ...
  **/
  ...
  public PostRewardBankModel deliverAmount(java.math.BigInteger deliverAmount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PostRewardBankModel postReward = (PostRewardBankModel) o;
    return Objects.equals(this.customerGuid, postReward.customerGuid) &&
        Objects.equals(this.symbol, postReward.symbol) &&
        Objects.equals(this.receiveAmount, postReward.receiveAmount) &&
        Objects.equals(this.deliverAmount, postReward.deliverAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customerGuid, symbol, receiveAmount, deliverAmount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostRewardBankModel {\n");
