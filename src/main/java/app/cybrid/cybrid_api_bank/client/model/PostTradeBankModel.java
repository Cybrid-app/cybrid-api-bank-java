...
@JsonPropertyOrder({
  PostTradeBankModel.JSON_PROPERTY_TRADE_TYPE,
  PostTradeBankModel.JSON_PROPERTY_QUOTE_GUID,
  PostTradeBankModel.JSON_PROPERTY_FIAT_ACCOUNT_GUID,
  PostTradeBankModel.JSON_PROPERTY_EXPECTED_ERROR,
  PostTradeBankModel.JSON_PROPERTY_LABELS
})
...
public class PostTradeBankModel {
  ...
  private JsonNullable<TradeTypeEnum> tradeType = JsonNullable.<TradeTypeEnum>of(TradeTypeEnum.PLATFORM);
  ...
  private JsonNullable<String> fiatAccountGuid = JsonNullable.<String>undefined();
  ...
  public enum ExpectedErrorEnum {
    ...
    ExpectedErrorEnum(String value) {
      this.value = value;
    }
  ...
  private JsonNullable<ExpectedErrorEnum> expectedError = JsonNullable.<ExpectedErrorEnum>undefined();

  public static final String JSON_PROPERTY_LABELS = "labels";
  private JsonNullable<List<String>> labels = JsonNullable.<List<String>>undefined();

  public PostTradeBankModel() { 
  }

  public PostTradeBankModel tradeType(TradeTypeEnum tradeType) {
    this.tradeType = JsonNullable.<TradeTypeEnum>of(tradeType);
  ...
  **/
  ...
  public PostTradeBankModel fiatAccountGuid(String fiatAccountGuid) {
    this.fiatAccountGuid = JsonNullable.<String>of(fiatAccountGuid);
  ...
  **/
  ...
  public String getFiatAccountGuid() {
        return fiatAccountGuid.orElse(null);
  }
  ...
  public PostTradeBankModel expectedError(ExpectedErrorEnum expectedError) {
    this.expectedError = JsonNullable.<ExpectedErrorEnum>of(expectedError);
  ...
  **/
  ...
  public ExpectedErrorEnum getExpectedError() {
        return expectedError.orElse(null);
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.tradeType, postTrade.tradeType) &&
        Objects.equals(this.quoteGuid, postTrade.quoteGuid) &&
        equalsNullable(this.fiatAccountGuid, postTrade.fiatAccountGuid) &&
        equalsNullable(this.expectedError, postTrade.expectedError) &&
        equalsNullable(this.labels, postTrade.labels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(tradeType), quoteGuid, hashCodeNullable(fiatAccountGuid), hashCodeNullable(expectedError), hashCodeNullable(labels));
  }
  ...
  public String toString() {
    ...
    sb.append("    expectedError: ").append(toIndentedString(expectedError)).append("\n");
