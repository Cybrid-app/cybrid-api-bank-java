...
public class PostTransferBankModel {
  ...
  private JsonNullable<String> sendAsDepositBankAccountGuid = JsonNullable.<String>undefined();
  ...
  private JsonNullable<PaymentRailEnum> paymentRail = JsonNullable.<PaymentRailEnum>undefined();

  public static final String JSON_PROPERTY_BENEFICIARY_MEMO = "beneficiary_memo";
  private JsonNullable<String> beneficiaryMemo = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_SOURCE_PARTICIPANTS = "source_participants";
  private JsonNullable<List<PostTransferParticipantBankModel>> sourceParticipants = JsonNullable.<List<PostTransferParticipantBankModel>>undefined();

  public static final String JSON_PROPERTY_DESTINATION_PARTICIPANTS = "destination_participants";
  private JsonNullable<List<PostTransferParticipantBankModel>> destinationParticipants = JsonNullable.<List<PostTransferParticipantBankModel>>undefined();

  public static final String JSON_PROPERTY_BANK_FIAT_ACCOUNT_GUID = "bank_fiat_account_guid";
  private JsonNullable<String> bankFiatAccountGuid = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_CUSTOMER_FIAT_ACCOUNT_GUID = "customer_fiat_account_guid";
  private JsonNullable<String> customerFiatAccountGuid = JsonNullable.<String>undefined();
  ...
  private JsonNullable<String> externalWalletGuid = JsonNullable.<String>undefined();
  ...
  private JsonNullable<String> networkFeeAccountGuid = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public PostTransferBankModel sendAsDepositBankAccountGuid(String sendAsDepositBankAccountGuid) {
    this.sendAsDepositBankAccountGuid = JsonNullable.<String>of(sendAsDepositBankAccountGuid);
  ...
  **/
  ...
  public String getSendAsDepositBankAccountGuid() {
        return sendAsDepositBankAccountGuid.orElse(null);
  }
  ...
  public PostTransferBankModel paymentRail(PaymentRailEnum paymentRail) {
    this.paymentRail = JsonNullable.<PaymentRailEnum>of(paymentRail);
  ...
  **/
  ...
  public PostTransferBankModel beneficiaryMemo(String beneficiaryMemo) {
    this.beneficiaryMemo = JsonNullable.<String>of(beneficiaryMemo);
  ...
  **/
  ...
  public String getBeneficiaryMemo() {
        return beneficiaryMemo.orElse(null);
  }
  ...
  public PostTransferBankModel sourceParticipants(List<PostTransferParticipantBankModel> sourceParticipants) {
    this.sourceParticipants = JsonNullable.<List<PostTransferParticipantBankModel>>of(sourceParticipants);
  ...
  public PostTransferBankModel addSourceParticipantsItem(PostTransferParticipantBankModel sourceParticipantsItem) {
    if (this.sourceParticipants == null || !this.sourceParticipants.isPresent()) {
      this.sourceParticipants = JsonNullable.<List<PostTransferParticipantBankModel>>of(new ArrayList<>());
    }
    try {
  ...
  **/
  ...
  public PostTransferBankModel destinationParticipants(List<PostTransferParticipantBankModel> destinationParticipants) {
    this.destinationParticipants = JsonNullable.<List<PostTransferParticipantBankModel>>of(destinationParticipants);
  ...
  public PostTransferBankModel addDestinationParticipantsItem(PostTransferParticipantBankModel destinationParticipantsItem) {
    if (this.destinationParticipants == null || !this.destinationParticipants.isPresent()) {
      this.destinationParticipants = JsonNullable.<List<PostTransferParticipantBankModel>>of(new ArrayList<>());
    }
    try {
  ...
  **/
  ...
  public PostTransferBankModel bankFiatAccountGuid(String bankFiatAccountGuid) {
    this.bankFiatAccountGuid = JsonNullable.<String>of(bankFiatAccountGuid);
  ...
  **/
  ...
  public String getBankFiatAccountGuid() {
        return bankFiatAccountGuid.orElse(null);
  }
  ...
  public PostTransferBankModel customerFiatAccountGuid(String customerFiatAccountGuid) {
    this.customerFiatAccountGuid = JsonNullable.<String>of(customerFiatAccountGuid);
  ...
  **/
  ...
  public String getCustomerFiatAccountGuid() {
        return customerFiatAccountGuid.orElse(null);
  }
  ...
  **/
  ...
  public PostTransferBankModel externalWalletGuid(String externalWalletGuid) {
    this.externalWalletGuid = JsonNullable.<String>of(externalWalletGuid);
  ...
  **/
  ...
  public String getExternalWalletGuid() {
        return externalWalletGuid.orElse(null);
  }
  ...
  **/
  ...
  public PostTransferBankModel networkFeeAccountGuid(String networkFeeAccountGuid) {
    this.networkFeeAccountGuid = JsonNullable.<String>of(networkFeeAccountGuid);
  ...
  **/
  ...
  public String getNetworkFeeAccountGuid() {
        return networkFeeAccountGuid.orElse(null);
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.quoteGuid, postTransfer.quoteGuid) &&
        ...
        equalsNullable(this.externalBankAccountGuid, postTransfer.externalBankAccountGuid) &&
        equalsNullable(this.fiatAccountGuid, postTransfer.fiatAccountGuid) &&
        equalsNullable(this.sendAsDepositBankAccountGuid, postTransfer.sendAsDepositBankAccountGuid) &&
        equalsNullable(this.paymentRail, postTransfer.paymentRail) &&
        equalsNullable(this.beneficiaryMemo, postTransfer.beneficiaryMemo) &&
        equalsNullable(this.sourceParticipants, postTransfer.sourceParticipants) &&
        equalsNullable(this.destinationParticipants, postTransfer.destinationParticipants) &&
        equalsNullable(this.bankFiatAccountGuid, postTransfer.bankFiatAccountGuid) &&
        equalsNullable(this.customerFiatAccountGuid, postTransfer.customerFiatAccountGuid) &&
        equalsNullable(this.sourceAccountGuid, postTransfer.sourceAccountGuid) &&
        equalsNullable(this.destinationAccountGuid, postTransfer.destinationAccountGuid) &&
        equalsNullable(this.externalWalletGuid, postTransfer.externalWalletGuid) &&
        equalsNullable(this.customerGuid, postTransfer.customerGuid) &&
        equalsNullable(this.networkFeeAccountGuid, postTransfer.networkFeeAccountGuid) &&
        equalsNullable(this.expectedBehaviours, postTransfer.expectedBehaviours) &&
        equalsNullable(this.labels, postTransfer.labels);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quoteGuid, transferType, hashCodeNullable(externalBankAccountGuid), hashCodeNullable(fiatAccountGuid), hashCodeNullable(sendAsDepositBankAccountGuid), hashCodeNullable(paymentRail), hashCodeNullable(beneficiaryMemo), hashCodeNullable(sourceParticipants), hashCodeNullable(destinationParticipants), hashCodeNullable(bankFiatAccountGuid), hashCodeNullable(customerFiatAccountGuid), hashCodeNullable(sourceAccountGuid), hashCodeNullable(destinationAccountGuid), hashCodeNullable(externalWalletGuid), hashCodeNullable(customerGuid), hashCodeNullable(networkFeeAccountGuid), hashCodeNullable(expectedBehaviours), hashCodeNullable(labels));
  }
