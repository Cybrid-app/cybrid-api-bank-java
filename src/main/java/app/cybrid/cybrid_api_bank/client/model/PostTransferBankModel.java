...
@JsonPropertyOrder({
  ...
  PostTransferBankModel.JSON_PROPERTY_EXPECTED_ERROR,
...
public class PostTransferBankModel {
  ...
  **/
  ...
  public PostTransferBankModel expectedError(String expectedError) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The optional expected error to simulate transfer failure. Optional when transfer_type is funding, transfer_type is instant_funding, transfer_type is book, transfer_type is crypto, transfer_type is inter_account, or transfer_type is lightning.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.quoteGuid, postTransfer.quoteGuid) &&
        ...
        Objects.equals(this.expectedError, postTransfer.expectedError) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quoteGuid, transferType, externalBankAccountGuid, fiatAccountGuid, sendAsDepositBankAccountGuid, paymentRail, beneficiaryMemo, sourceParticipants, destinationParticipants, expectedError, bankFiatAccountGuid, customerFiatAccountGuid, sourceAccountGuid, destinationAccountGuid, externalWalletGuid, customerGuid, networkFeeAccountGuid, labels);
  }
