...
public class PostTransferBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quoteGuid, transferType, customerGuid, sourceAccountGuid, destinationAccountGuid, externalWalletGuid, externalBankAccountGuid, networkFeeAccountGuid, paymentRail, beneficiaryMemo, labels);
  }
