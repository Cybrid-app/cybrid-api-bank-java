...
public class PostTransferBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quoteGuid, transferType, sourceAccountGuid, destinationAccountGuid, externalWalletGuid, externalBankAccountGuid, paymentRail, beneficiaryMemo, labels);
  }
