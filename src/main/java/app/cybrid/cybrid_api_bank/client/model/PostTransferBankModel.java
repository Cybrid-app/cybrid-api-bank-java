...
@JsonPropertyOrder({
  ...
  PostTransferBankModel.JSON_PROPERTY_ONE_TIME_ADDRESS,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.quoteGuid, postTransfer.quoteGuid) &&
        ...
        Objects.equals(this.oneTimeAddress, postTransfer.oneTimeAddress) &&
        Objects.equals(this.expectedError, postTransfer.expectedError);
  }

  @Override
  public int hashCode() {
    return Objects.hash(quoteGuid, transferType, externalWalletGuid, externalBankAccountGuid, oneTimeAddress, expectedError);
  }
