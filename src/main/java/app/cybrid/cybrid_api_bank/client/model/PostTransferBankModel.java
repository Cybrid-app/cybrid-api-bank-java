...
public class PostTransferBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The identifier for the fiat account to use for the transfer. Required if the customer or bank has multiple fiat accounts. Only valid for funding transfers.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The identifier for the fiat account to use for the transfer. Required if the customer has multiple fiat accounts. Only valid for instant funding and lightning transfers.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The identifier for the fiat account to use for the transfer. Required if the bank has multiple fiat accounts. Only valid for instant funding and lightning transfers.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The source participants for the transfer. Not supported for \"inter_account\" transfers.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The destination participants for the transfer. Not supported for \"inter_account\" transfers.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The network fee account's identifier. Required for network fee transfers. Must be the identifier for the customer's or bank's fiat account. For customer's to pay the network fees, include the customer's fiat account guid. For bank's to pay the network fees, include the bank's fiat account guid.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The deposit bank account's identifier. Optional for funding transfers. Only valid for withdrawals. The deposit bank account must be owned by the customer or bank initiating the transfer.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quoteGuid, transferType, customerGuid, fiatAccountGuid, customerFiatAccountGuid, bankFiatAccountGuid, sourceAccountGuid, sourceParticipants, destinationAccountGuid, destinationParticipants, externalWalletGuid, externalBankAccountGuid, networkFeeAccountGuid, paymentRail, beneficiaryMemo, sendAsDepositBankAccountGuid, labels);
  }
