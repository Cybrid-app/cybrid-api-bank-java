...
public class PostTransferBankModel {
  ...
  **/
  ...
  public PostTransferBankModel sourceParticipants(List<TransferParticipantBankModel> sourceParticipants) {
    
    this.sourceParticipants = sourceParticipants;
    return this;
  }

  public PostTransferBankModel addSourceParticipantsItem(TransferParticipantBankModel sourceParticipantsItem) {
  ...
  **/
  ...
  public PostTransferBankModel destinationParticipants(List<TransferParticipantBankModel> destinationParticipants) {
    
    this.destinationParticipants = destinationParticipants;
    return this;
  }

  public PostTransferBankModel addDestinationParticipantsItem(TransferParticipantBankModel destinationParticipantsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quoteGuid, transferType, customerGuid, sourceAccountGuid, sourceParticipants, destinationAccountGuid, destinationParticipants, externalWalletGuid, externalBankAccountGuid, networkFeeAccountGuid, paymentRail, beneficiaryMemo, labels);
  }
