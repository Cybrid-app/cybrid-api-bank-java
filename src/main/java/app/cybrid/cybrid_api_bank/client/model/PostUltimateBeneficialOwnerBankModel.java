...
@JsonPropertyOrder({
  PostUltimateBeneficialOwnerBankModel.JSON_PROPERTY_CUSTOMER_GUID,
  PostUltimateBeneficialOwnerBankModel.JSON_PROPERTY_OWNERSHIP_PERCENTAGE
})
@JsonTypeName("PostUltimateBeneficialOwner")
...
public class PostUltimateBeneficialOwnerBankModel {
  ...
  public PostUltimateBeneficialOwnerBankModel() { 
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The ownership percentage.")
  ...
  public boolean equals(Object o) {
    ...
    PostUltimateBeneficialOwnerBankModel postUltimateBeneficialOwner = (PostUltimateBeneficialOwnerBankModel) o;
    return Objects.equals(this.customerGuid, postUltimateBeneficialOwner.customerGuid) &&
        Objects.equals(this.ownershipPercentage, postUltimateBeneficialOwner.ownershipPercentage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customerGuid, ownershipPercentage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostUltimateBeneficialOwnerBankModel {\n");
