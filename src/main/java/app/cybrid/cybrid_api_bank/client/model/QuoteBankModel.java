...
public class QuoteBankModel {
  ...
  private List<QuoteEntryBankModel> entries = null;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, quote.guid) &&
        ...
        Objects.equals(this.networkAddress, quote.networkAddress) &&
        Objects.equals(this.entries, quote.entries) &&
        Objects.equals(this.tradeGuid, quote.tradeGuid) &&
        Objects.equals(this.transferGuid, quote.transferGuid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(guid, productType, bankGuid, customerGuid, symbol, side, receiveAmount, deliverAmount, fee, createdAt, updatedAt, issuedAt, expiresAt, asset, networkFee, networkFeeAsset, networkAddress, entries, tradeGuid, transferGuid);
  }
