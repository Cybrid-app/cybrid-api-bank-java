...
public class QuoteBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, productType, bankGuid, customerGuid, symbol, side, receiveAmount, deliverAmount, fee, createdAt, updatedAt, issuedAt, expiresAt, asset, networkFee, networkFeeAsset, networkAddress, entries);
  }
