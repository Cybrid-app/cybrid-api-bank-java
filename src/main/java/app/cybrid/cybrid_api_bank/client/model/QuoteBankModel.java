...
public class QuoteBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of product the quote is for; one of trading, funding, book_transfer, crypto_transfer, inter_account, or lightning_transfer.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, productType, bankGuid, customerGuid, symbol, side, receiveAmount, deliverAmount, fee, createdAt, updatedAt, issuedAt, expiresAt, asset, networkFee, networkFeeAsset, networkAddress);
  }
