...
public class QuoteBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of product the quote is for; one of trading, funding, book_transfer, crypto_transfer, or inter_account.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, productType, bankGuid, customerGuid, symbol, side, receiveAmount, deliverAmount, fee, createdAt, updatedAt, issuedAt, expiresAt, asset, networkFee, networkFeeAsset);
  }
