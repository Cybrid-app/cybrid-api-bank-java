 ...
 */
@ApiModel(description = "The source account in the batch transfer entry.")
@JsonPropertyOrder({
  QuoteEntrySourceAccountBankModel.JSON_PROPERTY_GUID,
  QuoteEntrySourceAccountBankModel.JSON_PROPERTY_TYPE,
  QuoteEntrySourceAccountBankModel.JSON_PROPERTY_BANK_GUID,
  QuoteEntrySourceAccountBankModel.JSON_PROPERTY_CUSTOMER_GUID
})
@JsonTypeName("QuoteEntry_source_account")
...
public class QuoteEntrySourceAccountBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of transfer account; one of external_wallet.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    QuoteEntrySourceAccountBankModel quoteEntrySourceAccount = (QuoteEntrySourceAccountBankModel) o;
    return Objects.equals(this.guid, quoteEntrySourceAccount.guid) &&
        Objects.equals(this.type, quoteEntrySourceAccount.type) &&
        Objects.equals(this.bankGuid, quoteEntrySourceAccount.bankGuid) &&
        Objects.equals(this.customerGuid, quoteEntrySourceAccount.customerGuid);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuoteEntrySourceAccountBankModel {\n");
