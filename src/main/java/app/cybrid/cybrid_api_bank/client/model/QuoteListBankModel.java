 ...
 */
@JsonPropertyOrder({
  QuoteListBankModel.JSON_PROPERTY_TOTAL,
  QuoteListBankModel.JSON_PROPERTY_PAGE,
  QuoteListBankModel.JSON_PROPERTY_PER_PAGE,
  QuoteListBankModel.JSON_PROPERTY_OBJECTS
})
@JsonTypeName("QuoteList")
...
public class QuoteListBankModel {
  ...
  private List<QuoteBankModel> objects = new ArrayList<>();

  public QuoteListBankModel() { 
  }

  public QuoteListBankModel total(java.math.BigInteger total) {
  ...
  **/
  ...
  public QuoteListBankModel page(java.math.BigInteger page) {
  ...
  **/
  ...
  public QuoteListBankModel perPage(java.math.BigInteger perPage) {
  ...
  **/
  ...
  public QuoteListBankModel objects(List<QuoteBankModel> objects) {
    
    this.objects = objects;
    return this;
  }

  public QuoteListBankModel addObjectsItem(QuoteBankModel objectsItem) {
  ...
  **/
  ...
  public List<QuoteBankModel> getObjects() {
    return objects;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObjects(List<QuoteBankModel> objects) {
    this.objects = objects;
  }
  ...
  public boolean equals(Object o) {
    ...
    QuoteListBankModel quoteList = (QuoteListBankModel) o;
    return Objects.equals(this.total, quoteList.total) &&
        Objects.equals(this.page, quoteList.page) &&
        Objects.equals(this.perPage, quoteList.perPage) &&
        Objects.equals(this.objects, quoteList.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuoteListBankModel {\n");
