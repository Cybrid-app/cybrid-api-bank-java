 ...
 */
@JsonPropertyOrder({
  RewardListBankModel.JSON_PROPERTY_TOTAL,
  RewardListBankModel.JSON_PROPERTY_PAGE,
  RewardListBankModel.JSON_PROPERTY_PER_PAGE,
  RewardListBankModel.JSON_PROPERTY_OBJECTS
})
@JsonTypeName("RewardList")
...
public class RewardListBankModel {
  ...
  private List<RewardBankModel> objects = new ArrayList<>();

  public RewardListBankModel() { 
  }

  public RewardListBankModel total(java.math.BigInteger total) {
  ...
  **/
  ...
  public RewardListBankModel page(java.math.BigInteger page) {
  ...
  **/
  ...
  public RewardListBankModel perPage(java.math.BigInteger perPage) {
  ...
  **/
  ...
  public RewardListBankModel objects(List<RewardBankModel> objects) {
    
    this.objects = objects;
    return this;
  }

  public RewardListBankModel addObjectsItem(RewardBankModel objectsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Array of reward entities")
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<RewardBankModel> getObjects() {
    return objects;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObjects(List<RewardBankModel> objects) {
    this.objects = objects;
  }
  ...
  public boolean equals(Object o) {
    ...
    RewardListBankModel rewardList = (RewardListBankModel) o;
    return Objects.equals(this.total, rewardList.total) &&
        Objects.equals(this.page, rewardList.page) &&
        Objects.equals(this.perPage, rewardList.perPage) &&
        Objects.equals(this.objects, rewardList.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class RewardListBankModel {\n");
