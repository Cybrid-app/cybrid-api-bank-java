...
public class SymbolPriceBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(symbol, hashCodeNullable(buyPrice), hashCodeNullable(sellPrice), hashCodeNullable(buyPriceLastUpdatedAt), hashCodeNullable(sellPriceLastUpdatedAt));
  }
