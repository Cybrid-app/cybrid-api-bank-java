...
public class TradeBankModel {
  ...
  **/
  ...
  public TradeBankModel tradeType(TradeTypeEnum tradeType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ISO8601 datetime the trade was created at.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ISO8601 datetime the trade was last updated at.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, tradeType, customerGuid, quoteGuid, symbol, side, state, failureCode, receiveAmount, deliverAmount, fee, createdAt, updatedAt);
  }
