 ...
 */
@JsonPropertyOrder({
  TradeListBankModel.JSON_PROPERTY_TOTAL,
  TradeListBankModel.JSON_PROPERTY_PAGE,
  TradeListBankModel.JSON_PROPERTY_PER_PAGE,
  TradeListBankModel.JSON_PROPERTY_OBJECTS
})
@JsonTypeName("TradeList")
...
public class TradeListBankModel {
  ...
  private List<TradeBankModel> objects = new ArrayList<>();

  public TradeListBankModel() { 
  }

  public TradeListBankModel total(java.math.BigInteger total) {
  ...
  **/
  ...
  public TradeListBankModel page(java.math.BigInteger page) {
  ...
  **/
  ...
  public TradeListBankModel perPage(java.math.BigInteger perPage) {
  ...
  **/
  ...
  public TradeListBankModel objects(List<TradeBankModel> objects) {
    
    this.objects = objects;
    return this;
  }

  public TradeListBankModel addObjectsItem(TradeBankModel objectsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Array of trade entities")
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<TradeBankModel> getObjects() {
    return objects;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObjects(List<TradeBankModel> objects) {
    this.objects = objects;
  }
  ...
  public boolean equals(Object o) {
    ...
    TradeListBankModel tradeList = (TradeListBankModel) o;
    return Objects.equals(this.total, tradeList.total) &&
        Objects.equals(this.page, tradeList.page) &&
        Objects.equals(this.perPage, tradeList.perPage) &&
        Objects.equals(this.objects, tradeList.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class TradeListBankModel {\n");
