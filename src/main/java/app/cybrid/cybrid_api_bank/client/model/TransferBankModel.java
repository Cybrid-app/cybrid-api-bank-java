...
public class TransferBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The transfer's state")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ISO8601 datetime the transfer was last updated at.")
