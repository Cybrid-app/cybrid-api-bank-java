...
@JsonPropertyOrder({
  ...
  TransferBankModel.JSON_PROPERTY_HOLD_DETAILS,
...
public class TransferBankModel {
  ...
  public static final String JSON_PROPERTY_HOLD_DETAILS = "hold_details";
  private JsonNullable<TransferHoldDetailsBankModel> holdDetails = JsonNullable.<TransferHoldDetailsBankModel>undefined();
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The state of the transfer; one of storing, pending, holding, reviewing, completed, or failed.")
  ...
  **/
  ...
  public TransferBankModel holdDetails(TransferHoldDetailsBankModel holdDetails) {
    this.holdDetails = JsonNullable.<TransferHoldDetailsBankModel>of(holdDetails);
  ...
  **/
  ...
  public TransferHoldDetailsBankModel getHoldDetails() {
        return holdDetails.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_HOLD_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<TransferHoldDetailsBankModel> getHoldDetails_JsonNullable() {
    return holdDetails;
  }
  
  @JsonProperty(JSON_PROPERTY_HOLD_DETAILS)
  public void setHoldDetails_JsonNullable(JsonNullable<TransferHoldDetailsBankModel> holdDetails) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, transfer.guid) &&
        ...
        equalsNullable(this.holdDetails, transfer.holdDetails) &&
  ...
  public String toString() {
    ...
    sb.append("    holdDetails: ").append(toIndentedString(holdDetails)).append("\n");
