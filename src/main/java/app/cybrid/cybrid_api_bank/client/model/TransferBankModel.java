...
public class TransferBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, transferType, customerGuid, quoteGuid, asset, side, state, amount, fee, estimatedNetworkFee, networkFee, networkFeeAsset, networkFeeLiabilityAmount, networkFeeLiabilityAmountAsset, createdAt);
  }
