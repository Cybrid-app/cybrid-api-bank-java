...
public class TransferBankModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, transferType, customerGuid, quoteGuid, externalBankAccountGuid, asset, side, state, amount, estimatedAmount, fee, estimatedNetworkFee, networkFee, networkFeeAsset, networkFeeLiabilityAmount, networkFeeLiabilityAmountAsset, createdAt);
  }
