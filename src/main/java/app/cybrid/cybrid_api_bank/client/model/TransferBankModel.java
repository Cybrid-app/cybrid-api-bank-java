...
public class TransferBankModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The network fee in base units of network_fee_asset. Only present on `crypto` transfers.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, transferType, customerGuid, quoteGuid, asset, side, state, amount, fee, networkFee, networkFeeAsset, createdAt);
  }
