...
@JsonPropertyOrder({
  TransferHoldDetailsBankModel.JSON_PROPERTY_APPLICABLE_TYPES,
  TransferHoldDetailsBankModel.JSON_PROPERTY_DURATION,
  TransferHoldDetailsBankModel.JSON_PROPERTY_STARTED_AT
})
@JsonTypeName("Transfer_hold_details")
...
public class TransferHoldDetailsBankModel {
  ...
  private JsonNullable<List<String>> applicableTypes = JsonNullable.<List<String>>undefined();

  public static final String JSON_PROPERTY_DURATION = "duration";
  private JsonNullable<java.math.BigInteger> duration = JsonNullable.<java.math.BigInteger>undefined();
  ...
  public TransferHoldDetailsBankModel applicableTypes(List<String> applicableTypes) {
    this.applicableTypes = JsonNullable.<List<String>>of(applicableTypes);
  ...
  public TransferHoldDetailsBankModel addApplicableTypesItem(String applicableTypesItem) {
    if (this.applicableTypes == null || !this.applicableTypes.isPresent()) {
      this.applicableTypes = JsonNullable.<List<String>>of(new ArrayList<>());
    }
    try {
      this.applicableTypes.get().add(applicableTypesItem);
  ...
  **/
  ...
  public List<String> getApplicableTypes() {
        return applicableTypes.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_APPLICABLE_TYPES)
  ...
  public TransferHoldDetailsBankModel duration(java.math.BigInteger duration) {
    this.duration = JsonNullable.<java.math.BigInteger>of(duration);
  ...
  **/
  ...
  public JsonNullable<java.math.BigInteger> getDuration_JsonNullable() {
    return duration;
  }
  
  @JsonProperty(JSON_PROPERTY_DURATION)
  public void setDuration_JsonNullable(JsonNullable<java.math.BigInteger> duration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.applicableTypes, transferHoldDetails.applicableTypes) &&
        equalsNullable(this.duration, transferHoldDetails.duration) &&
        equalsNullable(this.startedAt, transferHoldDetails.startedAt);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(applicableTypes), hashCodeNullable(duration), hashCodeNullable(startedAt));
  }
