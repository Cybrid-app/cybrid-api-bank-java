 ...
 */
@ApiModel(description = "The source account in the transfer. Can be omitted for crypto deposits.")
@JsonPropertyOrder({
  TransferSourceAccountBankModel.JSON_PROPERTY_GUID,
  TransferSourceAccountBankModel.JSON_PROPERTY_TYPE,
  TransferSourceAccountBankModel.JSON_PROPERTY_BANK_GUID,
  TransferSourceAccountBankModel.JSON_PROPERTY_CUSTOMER_GUID
})
@JsonTypeName("Transfer_source_account")
...
public class TransferSourceAccountBankModel {
  ...
  **/
  ...
  public TransferSourceAccountBankModel type(String type) {
   ...
   /**
   * The type of transfer account; one of trading, fiat, external_bank_account, external_wallet, one_time_address, reserve, or invoice_operations.
   * @return type
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of transfer account; one of trading, fiat, external_bank_account, external_wallet, one_time_address, reserve, or invoice_operations.")
  ...
  public TransferSourceAccountBankModel bankGuid(String bankGuid) {
  ...
  **/
  ...
  public TransferSourceAccountBankModel customerGuid(String customerGuid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TransferSourceAccountBankModel transferSourceAccount = (TransferSourceAccountBankModel) o;
    return Objects.equals(this.guid, transferSourceAccount.guid) &&
        Objects.equals(this.type, transferSourceAccount.type) &&
        Objects.equals(this.bankGuid, transferSourceAccount.bankGuid) &&
        Objects.equals(this.customerGuid, transferSourceAccount.customerGuid);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransferSourceAccountBankModel {\n");
