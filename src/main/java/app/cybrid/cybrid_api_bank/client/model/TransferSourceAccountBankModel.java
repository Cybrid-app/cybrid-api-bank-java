...
public class TransferSourceAccountBankModel {
  ...
  **/
  ...
  public TransferSourceAccountBankModel type(String type) {
   ...
   /**
   * The type of transfer account; one of trading, fiat, external_bank_account, external_wallet, one_time_address, or reserve.
   * @return type
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of transfer account; one of trading, fiat, external_bank_account, external_wallet, one_time_address, or reserve.")
