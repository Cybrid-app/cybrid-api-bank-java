...
@JsonPropertyOrder({
  ...
  VerificationKeyBankModel.JSON_PROPERTY_FAILURE_CODE,
...
public class VerificationKeyBankModel {
  ...
  **/
  ...
  public VerificationKeyBankModel failureCode(FailureCodeEnum failureCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The verification key's failure code (if any).")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, verificationKey.guid) &&
        ...
        Objects.equals(this.failureCode, verificationKey.failureCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, bankGuid, type, state, failureCode, algorithm, fingerprint, createdAt);
  }
