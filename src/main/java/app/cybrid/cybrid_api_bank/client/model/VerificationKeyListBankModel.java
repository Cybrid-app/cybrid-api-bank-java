 ...
 */
@JsonPropertyOrder({
  VerificationKeyListBankModel.JSON_PROPERTY_TOTAL,
  VerificationKeyListBankModel.JSON_PROPERTY_PAGE,
  VerificationKeyListBankModel.JSON_PROPERTY_PER_PAGE,
  VerificationKeyListBankModel.JSON_PROPERTY_OBJECTS
})
@JsonTypeName("VerificationKeyList")
...
public class VerificationKeyListBankModel {
  ...
  private List<VerificationKeyBankModel> objects = new ArrayList<>();

  public VerificationKeyListBankModel() { 
  }

  public VerificationKeyListBankModel total(java.math.BigInteger total) {
  ...
  **/
  ...
  public VerificationKeyListBankModel page(java.math.BigInteger page) {
  ...
  **/
  ...
  public VerificationKeyListBankModel perPage(java.math.BigInteger perPage) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Array of VerificationKey entities")
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<VerificationKeyBankModel> getObjects() {
    return objects;
  }
  ...
  public boolean equals(Object o) {
    ...
    VerificationKeyListBankModel verificationKeyList = (VerificationKeyListBankModel) o;
    return Objects.equals(this.total, verificationKeyList.total) &&
        Objects.equals(this.page, verificationKeyList.page) &&
        Objects.equals(this.perPage, verificationKeyList.perPage) &&
        Objects.equals(this.objects, verificationKeyList.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class VerificationKeyListBankModel {\n");
