...
public class WorkflowBankModel {
  ...
  **/
  ...
  public WorkflowBankModel type(TypeEnum type) {
  ...
  **/
  ...
  public WorkflowBankModel state(StateEnum state) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, customerGuid, type, state, failureCode, createdAt, updatedAt);
  }
