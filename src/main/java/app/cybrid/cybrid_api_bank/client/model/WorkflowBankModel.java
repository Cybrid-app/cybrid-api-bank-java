 ...
 */
@JsonPropertyOrder({
  WorkflowBankModel.JSON_PROPERTY_GUID,
  WorkflowBankModel.JSON_PROPERTY_BANK_GUID,
  WorkflowBankModel.JSON_PROPERTY_CUSTOMER_GUID,
  WorkflowBankModel.JSON_PROPERTY_TYPE,
  WorkflowBankModel.JSON_PROPERTY_STATE,
  WorkflowBankModel.JSON_PROPERTY_FAILURE_CODE,
  WorkflowBankModel.JSON_PROPERTY_CREATED_AT,
  WorkflowBankModel.JSON_PROPERTY_UPDATED_AT
})
...
public class WorkflowBankModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WorkflowBankModel workflow = (WorkflowBankModel) o;
    return Objects.equals(this.guid, workflow.guid) &&
        equalsNullable(this.bankGuid, workflow.bankGuid) &&
        equalsNullable(this.customerGuid, workflow.customerGuid) &&
        Objects.equals(this.type, workflow.type) &&
        Objects.equals(this.state, workflow.state) &&
        equalsNullable(this.failureCode, workflow.failureCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, hashCodeNullable(bankGuid), hashCodeNullable(customerGuid), type, state, hashCodeNullable(failureCode), createdAt, updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkflowBankModel {\n");
