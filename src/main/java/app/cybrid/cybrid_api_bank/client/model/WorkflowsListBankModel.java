 ...
 */
@JsonPropertyOrder({
  WorkflowsListBankModel.JSON_PROPERTY_TOTAL,
  WorkflowsListBankModel.JSON_PROPERTY_PAGE,
  WorkflowsListBankModel.JSON_PROPERTY_PER_PAGE,
  WorkflowsListBankModel.JSON_PROPERTY_OBJECTS
})
@JsonTypeName("WorkflowsList")
...
public class WorkflowsListBankModel {
  ...
  private List<WorkflowBankModel> objects = new ArrayList<>();

  public WorkflowsListBankModel() { 
  }

  public WorkflowsListBankModel total(java.math.BigInteger total) {
  ...
  **/
  ...
  public WorkflowsListBankModel page(java.math.BigInteger page) {
  ...
  **/
  ...
  public WorkflowsListBankModel perPage(java.math.BigInteger perPage) {
  ...
  **/
  ...
  public WorkflowsListBankModel objects(List<WorkflowBankModel> objects) {
    
    this.objects = objects;
    return this;
  }

  public WorkflowsListBankModel addObjectsItem(WorkflowBankModel objectsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Array of workflow entities")
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<WorkflowBankModel> getObjects() {
    return objects;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObjects(List<WorkflowBankModel> objects) {
    this.objects = objects;
  }
  ...
  public boolean equals(Object o) {
    ...
    WorkflowsListBankModel workflowsList = (WorkflowsListBankModel) o;
    return Objects.equals(this.total, workflowsList.total) &&
        Objects.equals(this.page, workflowsList.page) &&
        Objects.equals(this.perPage, workflowsList.perPage) &&
        Objects.equals(this.objects, workflowsList.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkflowsListBankModel {\n");
