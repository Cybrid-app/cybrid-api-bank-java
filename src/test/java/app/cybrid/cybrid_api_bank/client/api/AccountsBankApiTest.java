...
/**
 * API tests for AccountsBankApi
 */
@Ignore
public class AccountsBankApiTest {

    private final AccountsBankApi api = new AccountsBankApi();
    ...
    public void createAccountTest()  {
        PostAccountBankModel postAccountBankModel = null;
        AccountBankModel response = api.createAccount(postAccountBankModel).block();
    ...
    public void getAccountTest()  {
        ...
        AccountBankModel response = api.getAccount(accountGuid).block();
    ...
    public void listAccountsTest()  {
        ...
        AccountListBankModel response = api.listAccounts(page, perPage, guid, bankGuid, customerGuid).block();
