...
/**
 * API tests for AssetsBankApi
 */
@Ignore
public class AssetsBankApiTest {

    private final AssetsBankApi api = new AssetsBankApi();
    ...
    public void listAssetsTest()  {
        ...
        AssetListBankModel response = api.listAssets(page, perPage).block();
