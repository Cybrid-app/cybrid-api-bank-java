...
public class CustomersBankApiTest {
    ...
    public void getCustomerTest()  {
        ...
        CustomerBankModel response = api.getCustomer(customerGuid, bankGuid).block();
    ...
    public void listCustomersTest()  {
        ...
        String bankGuid = null;
        String guid = null;
        CustomerListBankModel response = api.listCustomers(page, perPage, bankGuid, guid).block();
