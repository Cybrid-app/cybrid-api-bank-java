...
/**
 * API tests for CustomersBankApi
 */
@Ignore
public class CustomersBankApiTest {

    private final CustomersBankApi api = new CustomersBankApi();
    ...
    public void createCustomerTest()  {
        PostCustomerBankModel postCustomerBankModel = null;
        CustomerBankModel response = api.createCustomer(postCustomerBankModel).block();
    ...
    public void getCustomerTest()  {
        ...
        Boolean includePii = null;
        CustomerBankModel response = api.getCustomer(customerGuid, includePii).block();
    ...
    public void listCustomersTest()  {
        ...
        String guid = null;
        String label = null;
        CustomerListBankModel response = api.listCustomers(page, perPage, bankGuid, guid, label).block();
    ...
    public void updateCustomerTest()  {
        String customerGuid = null;
        PatchCustomerBankModel patchCustomerBankModel = null;
        CustomerBankModel response = api.updateCustomer(customerGuid, patchCustomerBankModel).block();
