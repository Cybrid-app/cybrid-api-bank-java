...
/**
 * API tests for ExternalBankAccountsBankApi
 */
@Ignore
public class ExternalBankAccountsBankApiTest {

    private final ExternalBankAccountsBankApi api = new ExternalBankAccountsBankApi();
    ...
    public void createExternalBankAccountTest()  {
        PostExternalBankAccountBankModel postExternalBankAccountBankModel = null;
        ExternalBankAccountBankModel response = api.createExternalBankAccount(postExternalBankAccountBankModel).block();
     ...
     */
    @Test
    public void deleteExternalBankAccountTest()  {
        String externalBankAccountGuid = null;
        ExternalBankAccountBankModel response = api.deleteExternalBankAccount(externalBankAccountGuid).block();
     ...
     */
    @Test
    public void getExternalBankAccountTest()  {
        String externalBankAccountGuid = null;
        Boolean forceBalanceRefresh = null;
        Boolean includeBalances = null;
        Boolean includePii = null;
        ExternalBankAccountBankModel response = api.getExternalBankAccount(externalBankAccountGuid, forceBalanceRefresh, includeBalances, includePii).block();
     ...
     */
    @Test
    public void listExternalBankAccountsTest()  {
        ...
        String asset = null;
        String state = null;
        ExternalBankAccountListBankModel response = api.listExternalBankAccounts(page, perPage, guid, bankGuid, customerGuid, asset, state).block();
     ...
     */
    @Test
    public void patchExternalBankAccountTest()  {
        String externalBankAccountGuid = null;
        PatchExternalBankAccountBankModel patchExternalBankAccountBankModel = null;
        ExternalBankAccountBankModel response = api.patchExternalBankAccount(externalBankAccountGuid, patchExternalBankAccountBankModel).block();
