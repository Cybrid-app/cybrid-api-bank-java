...
/**
 * API tests for ExternalWalletsBankApi
 */
@Ignore
public class ExternalWalletsBankApiTest {

    private final ExternalWalletsBankApi api = new ExternalWalletsBankApi();
    ...
    public void createExternalWalletTest()  {
        PostExternalWalletBankModel postExternalWalletBankModel = null;
        ExternalWalletBankModel response = api.createExternalWallet(postExternalWalletBankModel).block();
    ...
    public void deleteExternalWalletTest()  {
        String externalWalletGuid = null;
        ExternalWalletBankModel response = api.deleteExternalWallet(externalWalletGuid).block();
    ...
    public void getExternalWalletTest()  {
        String externalWalletGuid = null;
        ExternalWalletBankModel response = api.getExternalWallet(externalWalletGuid).block();
     ...
     */
    @Test
    public void listExternalWalletsTest()  {
        ...
        String state = null;
        ExternalWalletListBankModel response = api.listExternalWallets(page, perPage, guid, bankGuid, customerGuid, state).block();
