...
/**
 * API tests for PricesBankApi
 */
@Ignore
public class PricesBankApiTest {

    private final PricesBankApi api = new PricesBankApi();
    ...
    public void listPricesTest()  {
        String symbol = null;
        List<SymbolPriceBankModel> response = api.listPrices(symbol).collectList().block();
