...
/**
 * API tests for QuotesBankApi
 */
@Ignore
public class QuotesBankApiTest {

    private final QuotesBankApi api = new QuotesBankApi();
    ...
    public void createQuoteTest()  {
        PostQuoteBankModel postQuoteBankModel = null;
        QuoteBankModel response = api.createQuote(postQuoteBankModel).block();
    ...
    public void getQuoteTest()  {
        ...
        QuoteBankModel response = api.getQuote(quoteGuid).block();
     ...
     */
    @Test
    public void listQuotesTest()  {
        java.math.BigInteger page = null;
        java.math.BigInteger perPage = null;
        String guid = null;
        String bankGuid = null;
        String customerGuid = null;
        QuoteListBankModel response = api.listQuotes(page, perPage, guid, bankGuid, customerGuid).block();
