...
/**
 * API tests for TradesBankApi
 */
@Ignore
public class TradesBankApiTest {

    private final TradesBankApi api = new TradesBankApi();
    ...
    public void createTradeTest()  {
        PostTradeBankModel postTradeBankModel = null;
        TradeBankModel response = api.createTrade(postTradeBankModel).block();
    ...
    public void getTradeTest()  {
        ...
        TradeBankModel response = api.getTrade(tradeGuid).block();
    ...
    public void listTradesTest()  {
        ...
        TradeListBankModel response = api.listTrades(page, perPage, guid, bankGuid, customerGuid, accountGuid).block();
