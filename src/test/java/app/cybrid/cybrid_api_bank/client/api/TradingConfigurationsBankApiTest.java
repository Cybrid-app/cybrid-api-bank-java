...
/**
 * API tests for TradingConfigurationsBankApi
 */
@Ignore
public class TradingConfigurationsBankApiTest {

    private final TradingConfigurationsBankApi api = new TradingConfigurationsBankApi();
     ...
     */
    @Test
    public void createTradingConfigurationTest()  {
        PostTradingConfigurationBankModel postTradingConfigurationBankModel = null;
        TradingConfigurationBankModel response = api.createTradingConfiguration(postTradingConfigurationBankModel).block();
     ...
     */
    @Test
    public void getTradingConfigurationTest()  {
        String tradingConfigurationGuid = null;
        TradingConfigurationBankModel response = api.getTradingConfiguration(tradingConfigurationGuid).block();
     ...
     */
    @Test
    public void listTradingConfigurationsTest()  {
        java.math.BigInteger page = null;
        java.math.BigInteger perPage = null;
        TradingConfigurationListBankModel response = api.listTradingConfigurations(page, perPage).block();
