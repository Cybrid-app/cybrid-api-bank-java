...
public class VerificationKeysBankApiTest {
    ...
    public void createVerificationKeyTest()  {
        ...
        VerificationKeyBankModel response = api.createVerificationKey(bankGuid, postVerificationKeyBankModel).block();
    ...
    public void getVerificationKeyTest()  {
        ...
        VerificationKeyBankModel response = api.getVerificationKey(bankGuid, verificationKeyGuid).block();
    ...
    public void listVerificationKeysTest()  {
        ...
        VerificationKeyListBankModel response = api.listVerificationKeys(bankGuid, page, perPage).block();
